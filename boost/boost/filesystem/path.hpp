...
# endif
    ...
    path(Source const& source,
      typename hexerboost::enable_if<path_traits::is_pathable<
        typename hexerboost::decay<Source>::type> >::type* =0)
    {
    ...
    template <class Source>
      typename hexerboost::enable_if<path_traits::is_pathable<
        typename hexerboost::decay<Source>::type>, path&>::type
    ...
    template <class CharT>
      typename hexerboost::enable_if<is_integral<CharT>, path&>::type
    operator+=(CharT c)
    {
      CharT tmp[2];
      tmp[0] = c;
...
# endif
  ...
  private:
    ...
    friend class hexerboost::filesystem::path;
...
# endif
  ...
  //    use hexerboost::io::quoted() to handle spaces in paths
  ...
  {
    return os
      << hexerboost::io::quoted(p.template string<std::basic_string<Char> >(), static_cast<Char>('&'));
  }
  ...
  operator>>(std::basic_istream<Char, Traits>& is, path& p)
  {
    ...
    is >> hexerboost::io::quoted(str, static_cast<Char>('&'));
    p = str;
    return is;
  }
