...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace filesystem {
...
namespace path_traits {
  ...
  template <class Container> inline
    ...
    typename hexerboost::disable_if<hexerboost::is_array<Container>, bool>::type
  ...
  template <class Container, class U> inline
    ...
    typename hexerboost::disable_if<hexerboost::is_array<Container>, void>::type
