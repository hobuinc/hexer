...
#define BOOST_PRIVATE_GCD_UF( Ut )                  \
    ...
    BOOST_PRIVATE_GCD_UF( hexerboost::ulong_long_type );
...
#ifdef BOOST_HAS_LONG_LONG
    BOOST_PRIVATE_GCD_SF( hexerboost::long_long_type, hexerboost::ulong_long_type );
#elif defined(BOOST_HAS_MS_INT64)
