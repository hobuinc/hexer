...
#include <boost/cstdint.hpp> // for hexerboost::uintmax_t
...
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(t)         hexerboost::type<t>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(t)    hexerboost::type<t>*
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE(t, v)  hexerboost::non_type<t, v>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)  hexerboost::non_type<t, v>*
...
#define BOOST_MATH_STD_USING \
   ...
   using std::log10;\
   using std::sqrt;\
   using hexerboost::math::round;\
   using hexerboost::math::iround;\
   using hexerboost::math::lround;\
   using hexerboost::math::trunc;\
   using hexerboost::math::itrunc;\
   using hexerboost::math::ltrunc;\
   using hexerboost::math::modf;
...
}} // namespace hexerboost namespace math
...
#    define BOOST_FPU_EXCEPTION_GUARD hexerboost::math::detail::fpu_guard local_guard_object;
