...
//
// This must not be located in any namespace under hexerboost::math
...
template <class T>
inline bool is_nan_helper(T t, const hexerboost::true_type&)
{
#ifdef isnan
   return isnan(t);
...
template <class T>
inline bool is_nan_helper(T, const hexerboost::false_type&)
{
   return false;
}
...
inline int fpclassify_imp BOOST_NO_MACRO_EXPAND(T t, const generic_tag<true>&)
{
   ...
   if(::hexerboost::math_detail::is_nan_helper(t, ::hexerboost::is_floating_point<T>()))
      return FP_NAN;
#elif defined(isnan)
   if(hexerboost::math_detail::is_nan_helper(t, ::hexerboost::is_floating_point<T>()))
      return FP_NAN;
#elif defined(_MSC_VER) || defined(__BORLANDC__)
   if(::_isnan(hexerboost::math::tools::real_cast<double>(t)))
      return FP_NAN;
#endif
...
{
   return hexerboost::math::detail::fpclassify_imp(t, generic_tag<true>());
}
#endif
...
{
   return hexerboost::math::detail::isfinite_impl(t, generic_tag<true>());
}
#endif
...
{ //!< \brief return true if floating-point type t is finite.
   typedef typename detail::fp_traits<T>::type traits;
   typedef typename traits::method method;
   typedef typename hexerboost::is_floating_point<T>::type fp_tag;
   typedef typename tools::promote_args<T>::type value_type;
...
{ //!< \brief return true if floating-point type t is finite.
   typedef detail::fp_traits<long double>::type traits;
   typedef traits::method method;
   typedef hexerboost::is_floating_point<long double>::type fp_tag;
   typedef long double value_type;
   return detail::isfinite_impl(static_cast<value_type>(x), method());
}
#endif
...
{
   return hexerboost::math::detail::isnormal_impl(t, generic_tag<true>());
}
#endif
...
{
   return hexerboost::math::detail::isinf_impl(t, generic_tag<true>());
}
#endif
...
#ifdef isnan
template <> inline bool isnan BOOST_NO_MACRO_EXPAND<float>(float t){ return ::hexerboost::math_detail::is_nan_helper(t, hexerboost::true_type()); }
template <> inline bool isnan BOOST_NO_MACRO_EXPAND<double>(double t){ return ::hexerboost::math_detail::is_nan_helper(t, hexerboost::true_type()); }
template <> inline bool isnan BOOST_NO_MACRO_EXPAND<long double>(long double t){ return ::hexerboost::math_detail::is_nan_helper(t, hexerboost::true_type()); }
