...
public:
  ...
  typedef typename
    hexerboost::reverse_iterator<iterator>                reverse_iterator;
  typedef typename
    hexerboost::reverse_iterator<const_iterator>          const_reverse_iterator;
...
BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS:
  ...
  /* This forwarding function eases things for the hexerboost::mem_fn construct
...
private:
  ...
  {
    lm.load(
      ::hexerboost::bind(&ordered_index::rearranger,this,_1,_2),
      ar,version);
    super::load_(ar,version,lm);
  }
...
template<
  ...
  typename SuperMeta,typename TagList,typename Category
>
inline hexerboost::mpl::true_* boost_foreach_is_noncopyable(
  hexerboost::multi_index::detail::ordered_index<
    KeyFromValue,Compare,SuperMeta,TagList,Category>*&,
  hexerboost::foreach::tag)
{
  return 0;
}
