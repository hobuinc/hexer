...
class flat_set
{
   ...
   flat_set(BOOST_RV_REF(flat_set) mx)
      : m_flat_tree(hexerboost::move(mx.m_flat_tree))
   {}
   ...
   flat_set(BOOST_RV_REF(flat_set) mx, const allocator_type &a)
      : m_flat_tree(hexerboost::move(mx.m_flat_tree), a)
   {}
   ...
   {  return m_flat_tree.emplace_unique(hexerboost::forward<Args>(args)...); }
   ...
   {  return m_flat_tree.emplace_hint_unique(hint, hexerboost::forward<Args>(args)...); }
   ...
   {  return m_flat_tree.insert_unique(::hexerboost::forward<KeyType>(x));  }

   template<class KeyType>
   iterator priv_insert(const_iterator p, BOOST_FWD_REF(KeyType) x)
   {  return m_flat_tree.insert_unique(p, ::hexerboost::forward<KeyType>(x)); }
   /// @endcond
};
...
struct has_trivial_destructor_after_move<hexerboost::container::flat_set<Key, C, Allocator> >
{
...
class flat_multiset
{
   ...
   {  return m_flat_tree.emplace_equal(hexerboost::forward<Args>(args)...); }
   ...
   template <class... Args>
   iterator emplace_hint(const_iterator hint, Args&&... args)
   {  return m_flat_tree.emplace_hint_equal(hint, hexerboost::forward<Args>(args)...); }
   ...
   {  return m_flat_tree.insert_equal(::hexerboost::forward<KeyType>(x));  }

   template <class KeyType>
   iterator priv_insert(const_iterator p, BOOST_FWD_REF(KeyType) x)
   {  return m_flat_tree.insert_equal(p, ::hexerboost::forward<KeyType>(x)); }
   /// @endcond
};
...
//!specialization for optimizations
template <class Key, class C, class Allocator>
struct has_trivial_destructor_after_move<hexerboost::container::flat_multiset<Key, C, Allocator> >
{
   static const bool value = has_trivial_destructor_after_move<Allocator>::value && has_trivial_destructor_after_move<C>::value;
};
