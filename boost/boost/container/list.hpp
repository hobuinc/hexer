   ...
   : public list_const_iterator<T, IIterator>
{
   ...
   { return ::hexerboost::intrusive::pointer_traits<pointer>::pointer_to(this->m_it->m_data); }
      ...
      <Allocator, typename container_detail::intrusive_list_type<Allocator>::type>
{
   ...
   {  this->emplace(this->cend(), hexerboost::forward<Args>(args)...); }
   ...
   {  this->emplace(this->cbegin(), hexerboost::forward<Args>(args)...);  }
   ...
   {
      NodePtr tmp = AllocHolder::create_node(hexerboost::move(x));
      return iterator(this->icont().insert(p.get(), *tmp));
   }
   ...
   {  this->insert(this->cend(), hexerboost::move(x));    }
...
template <class T, class Allocator>
struct has_trivial_destructor_after_move<hexerboost::container::list<T, Allocator> >
