...
class flat_map
{
   ...
   flat_map(BOOST_RV_REF(flat_map) x)
      : m_flat_tree(hexerboost::move(x.m_flat_tree))
   {}
   ...
   flat_map(BOOST_RV_REF(flat_map) x, const allocator_type &a)
      : m_flat_tree(hexerboost::move(x.m_flat_tree), a)
   {}
   ...
   {  m_flat_tree = hexerboost::move(mx.m_flat_tree);   return *this;  }
   ...
   {  return container_detail::force_copy< std::pair<iterator, bool> >(m_flat_tree.emplace_unique(hexerboost::forward<Args>(args)...)); }
   ...
   {  return container_detail::force_copy<std::pair<iterator,bool> >(
      m_flat_tree.insert_unique(hexerboost::move(container_detail::force<impl_value_type>(x)))); }
   ...
   {
      return container_detail::force_copy<std::pair<iterator,bool> >
      (m_flat_tree.insert_unique(hexerboost::move(x)));
   }
   ...
   iterator insert(const_iterator position, BOOST_RV_REF(value_type) x)
   {
      return container_detail::force_copy<iterator>
         (m_flat_tree.insert_unique( container_detail::force_copy<impl_const_iterator>(position)
                                   , hexerboost::move(container_detail::force<impl_value_type>(x))));
   }
   ...
   {
      return container_detail::force_copy<iterator>(
         m_flat_tree.insert_unique(container_detail::force_copy<impl_const_iterator>(position), hexerboost::move(x)));
   }
   ...
   mapped_type &priv_subscript(const key_type& k)
   {
      ...
      if (i == end() || key_comp()(k, (*i).first)){
         ...
         i = insert(i, impl_value_type(k, ::hexerboost::move(m.m_t)));
      }
      return (*i).second;
   }
   mapped_type &priv_subscript(BOOST_RV_REF(key_type) mk)
   {
      ...
      if (i == end() || key_comp()(k, (*i).first)){
         container_detail::value_init<mapped_type> m;
         i = insert(i, impl_value_type(hexerboost::move(k), ::hexerboost::move(m.m_t)));
      }
      return (*i).second;
   }
   /// @endcond
...
struct has_trivial_destructor_after_move<hexerboost::container::flat_map<K, T, C, Allocator> >
{
...
class flat_multimap
{
   ...
   {  return container_detail::force_copy<iterator>(m_flat_tree.emplace_equal(hexerboost::forward<Args>(args)...)); }
   ...
   iterator emplace_hint(const_iterator hint, Args&&... args)
   {
      return container_detail::force_copy<iterator>(m_flat_tree.emplace_hint_equal
         (container_detail::force_copy<impl_const_iterator>(hint), hexerboost::forward<Args>(args)...));
   }
   ...
   { return container_detail::force_copy<iterator>(m_flat_tree.insert_equal(hexerboost::move(x))); }
   ...
   {
      return container_detail::force_copy<iterator>(
         m_flat_tree.insert_equal(container_detail::force_copy<impl_const_iterator>(position), hexerboost::move(x)));
   }
...
//!specialization for optimizations
template <class K, class T, class C, class Allocator>
struct has_trivial_destructor_after_move< hexerboost::container::flat_multimap<K, T, C, Allocator> >
{
   static const bool value = has_trivial_destructor_after_move<Allocator>::value && has_trivial_destructor_after_move<C>::value;
};
