...
template<class Allocator, unsigned Version = hexerboost::container::container_detail::version<Allocator>::value>
...
struct allocator_version_traits<Allocator, 1>
{
   ...
   typedef typename hexerboost::container::allocator_traits<Allocator>::pointer    pointer;
   typedef typename hexerboost::container::allocator_traits<Allocator>::size_type  size_type;
   typedef typename hexerboost::container::allocator_traits<Allocator>::value_type value_type;

   typedef typename hexerboost::intrusive::pointer_traits<pointer>::
