...
class flat_tree
{
   typedef hexerboost::container::vector<Value, A>  vector_t;
 ...
 private:
      ...
      : public value_compare
   {
      ...
      Data(BOOST_RV_REF(Data) d)
         : value_compare(hexerboost::move(static_cast<value_compare&>(d))), m_vect(hexerboost::move(d.m_vect))
      {}
      ...
      Data(BOOST_RV_REF(Data) d, const A &a)
         : value_compare(hexerboost::move(static_cast<value_compare&>(d))), m_vect(hexerboost::move(d.m_vect), a)
      {}
      ...
      {
         this->value_compare::operator=(hexerboost::move(static_cast<value_compare &>(d)));
         m_vect = hexerboost::move(d.m_vect);
         return *this;
      }
   ...
   flat_tree(BOOST_RV_REF(flat_tree) x)
      :  m_data(hexerboost::move(x.m_data))
   { }
   ...
   flat_tree(BOOST_RV_REF(flat_tree) x, const allocator_type &a)
      :  m_data(hexerboost::move(x.m_data), a)
   { }
   ...
   {  m_data = hexerboost::move(mx.m_data); return *this;  }
   ...
   std::pair<iterator,bool> insert_unique(BOOST_RV_REF(value_type) val)
   {
      ...
      std::pair<iterator,bool> ret = this->priv_insert_unique_prepare(val, data);
      if(ret.second){
         ret.first = this->priv_insert_commit(data, hexerboost::move(val));
      }
      return ret;
   }
   ...
   iterator insert_equal(BOOST_RV_REF(value_type) mval)
   {
      ...
      i = this->m_data.m_vect.insert(i, hexerboost::move(mval));
      return i;
   }
   ...
   iterator insert_unique(const_iterator pos, BOOST_RV_REF(value_type) mval)
   {
      ...
      if(ret.second){
         ret.first = this->priv_insert_commit(data, hexerboost::move(mval));
      }
      return ret.first;
   }
   ...
   iterator insert_equal(const_iterator pos, BOOST_RV_REF(value_type) mval)
   {
      ...
      return this->priv_insert_commit(data, hexerboost::move(mval));
   }
   ...
   std::pair<iterator, bool> emplace_unique(Args&&... args)
   {
      ...
      stored_allocator_traits::construct(a, &val, ::hexerboost::forward<Args>(args)... );
   ...
   iterator emplace_equal(Args&&... args)
   {
      ...
      value_destructor<stored_allocator_type> d(a, val);
      iterator i = this->upper_bound(KeyOfValue()(val));
      i = this->m_data.m_vect.insert(i, hexerboost::move(val));
      return i;
   }
   ...
   iterator emplace_hint_equal(const_iterator hint, Args&&... args)
   {
      ...
      iterator i = this->priv_insert_commit(data, hexerboost::move(val));
      return i;
   }
      ...
      (insert_commit_data &commit_data, BOOST_FWD_REF(Convertible) convertible)
   {
      return this->m_data.m_vect.insert
         ...
         , hexerboost::forward<Convertible>(convertible));
   }
...
class C, class A>
struct has_trivial_destructor_after_move<hexerboost::container::container_detail::flat_tree<K, V, KOV, C, A> >
{
