...
struct pair
{
   ...
   pair(BOOST_RV_REF(pair) p)
      : first(::hexerboost::move(p.first)), second(::hexerboost::move(p.second))
   {}
   ...
   pair(BOOST_FWD_REF(U) u, BOOST_FWD_REF(V) v)
      : first(::hexerboost::forward<U>(u))
      , second(::hexerboost::forward<V>(v))
   {}
...
/*
   ...
   pair(U &&u, V &&v)
      : first(::hexerboost::forward<U>(u))
      , second(::hexerboost::forward<V>(v), ::hexerboost::forward<Args>(args)...)
   {}
...
*/
   ...
   {
      first  = ::hexerboost::move(p.first);
      second = ::hexerboost::move(p.second);
      return *this;
   }

   template <class D, class S>
   typename ::hexerboost::container::container_detail::enable_if_c
      < !(::hexerboost::container::container_detail::is_same<T1, D>::value &&
          ::hexerboost::container::container_detail::is_same<T2, S>::value)
      , pair &>::type
...
struct is_enum< ::hexerboost::container::container_detail::pair<T, U> >
{
   static const bool value = false;
};
...
template <class T1, class T2>
struct is_class< ::hexerboost::container::container_detail::pair<T1, T2> >
   : public ::hexerboost::true_type
{};

#ifdef BOOST_NO_CXX11_RVALUE_REFERENCES

template<class T1, class T2>
struct has_move_emulation_enabled< ::hexerboost::container::container_detail::pair<T1, T2> >
