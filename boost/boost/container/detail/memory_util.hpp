...
#define BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_BEGIN namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace container { namespace container_detail {
