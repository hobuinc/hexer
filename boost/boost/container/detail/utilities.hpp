...
{  return hexerboost::container::container_detail::to_raw_pointer(p.operator->());  }
...
//!      allocator_traits::construct(a, &*result, hexerboost::move(*first));
//!   \endcode
//!
//! <b>Returns</b>: result
template
...
F uninitialized_move_alloc(A &a, I f, I l, F r)
{
   ...
   BOOST_TRY{
      while (f != l) {
         allocator_traits<A>::construct(a, container_detail::to_raw_pointer(&*r), hexerboost::move(*f));
         ++f; ++r;
      }
   }
   BOOST_CATCH(...){
...
F uninitialized_copy_or_move_alloc
   (A &a, I f, I l, F r
   ,typename hexerboost::container::container_detail::enable_if
      < hexerboost::move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::hexerboost::container::uninitialized_move_alloc(a, f, l, r);
}
...
F uninitialized_copy_or_move_alloc
   (A &a, I f, I l, F r
   ,typename hexerboost::container::container_detail::disable_if
      < hexerboost::move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::hexerboost::container::uninitialized_copy_alloc(a, f, l, r);
}
...
F uninitialized_copy_or_move_alloc_n
   ...
   ,typename hexerboost::container::container_detail::enable_if
      < hexerboost::move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::hexerboost::container::uninitialized_move_alloc_n(a, f, n, r);
}
...
F uninitialized_copy_or_move_alloc_n
   ...
   ,typename hexerboost::container::container_detail::disable_if
      < hexerboost::move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::hexerboost::container::uninitialized_copy_alloc_n(a, f, n, r);
}
...
I uninitialized_copy_or_move_alloc_n_source
   ...
   ,typename hexerboost::container::container_detail::enable_if
      < hexerboost::move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::hexerboost::container::uninitialized_move_alloc_n_source(a, f, n, r);
}
...
I uninitialized_copy_or_move_alloc_n_source
   ...
   ,typename hexerboost::container::container_detail::disable_if
      < hexerboost::move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::hexerboost::container::uninitialized_copy_alloc_n_source(a, f, n, r);
}
