   ...
   :  public rbtree_hook<VoidPointer>::type
{
   ...
   {
      const_cast<A&>(m_data.first) = ::hexerboost::move(p.first);
      m_data.second = ::hexerboost::move(p.second);
   }
...
{
   typedef typename hexerboost::container::
      ...
      >
{
   ...
   class iterator : public const_iterator
   {
      ...
      pointer   operator->() const
         {  return hexerboost::intrusive::pointer_traits<pointer>::pointer_to(this->m_it->get_data());  }
   ...
   rbtree(BOOST_RV_REF(rbtree) x)
      :  AllocHolder(::hexerboost::move(static_cast<AllocHolder&>(x)), x.key_comp())
   {}
   ...
   rbtree& operator=(BOOST_COPY_ASSIGN_REF(rbtree) x)
   {
      if (&x != this){
         ...
         //automatically
         Icont other_tree(::hexerboost::move(this->icont()));
   ...
   {
      NodePtr tmp = AllocHolder::create_node(hexerboost::forward<MovableConvertible>(mv));
      iiterator it(this->icont().insert_unique_commit(*tmp, data));
      return iterator(it);
   }
   ...
   std::pair<iterator,bool> insert_unique(BOOST_FWD_REF(MovableConvertible) mv)
   {
      ...
      if(!ret.second)
         return ret;
      return std::pair<iterator,bool>
         (this->insert_unique_commit(hexerboost::forward<MovableConvertible>(mv), data), true);
   }
   ...
   {  return this->emplace_unique_impl(AllocHolder::create_node(hexerboost::forward<Args>(args)...));   }

   template <class... Args>
   iterator emplace_hint_unique(const_iterator hint, Args&&... args)
   {  return this->emplace_unique_hint_impl(hint, AllocHolder::create_node(hexerboost::forward<Args>(args)...));   }

   template <class... Args>
   iterator emplace_equal(Args&&... args)
   {
      NodePtr p(AllocHolder::create_node(hexerboost::forward<Args>(args)...));
   ...
   iterator insert_unique(const_iterator hint, BOOST_FWD_REF(MovableConvertible) mv)
   {
      ...
      if(!ret.second)
         return ret.first;
      return this->insert_unique_commit(hexerboost::forward<MovableConvertible>(mv), data);
   }
   ...
   {
      NodePtr p(AllocHolder::create_node(hexerboost::forward<MovableConvertible>(mv)));
      return iterator(this->icont().insert_equal(this->icont().end(), *p));
   }
...
struct has_trivial_destructor_after_move
   <hexerboost::container::container_detail::rbtree<K, V, KOV, C, A> >
{
