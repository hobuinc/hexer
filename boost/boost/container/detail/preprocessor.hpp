...
//!
   ...
   BOOST_PP_CAT(m_p, n) (::hexerboost::forward< BOOST_PP_CAT(P, n) >( BOOST_PP_CAT(p, n) ))           \
   //!
   ...
   //!
      ...
      namespace container_detail {
         ...
         struct ref_holder
         {
            ...
            {}
            T &t_;
            T && get() {  return ::hexerboost::move(t_);   }
         };
      ...
      #define BOOST_CONTAINER_PP_PARAM_DEFINE(z, n, data)  \
         ::hexerboost::container::container_detail::ref_holder<BOOST_PP_CAT(P, n)> BOOST_PP_CAT(m_p, n);  \
      //!
   ...
   ::hexerboost::forward< BOOST_PP_CAT(P, n) >( BOOST_PP_CAT(this->m_p, n) ) \
   //!
...
::hexerboost::forward< BOOST_PP_CAT(P, n) >( BOOST_PP_CAT(p, n) ) \
//!

#define BOOST_CONTAINER_PP_DECLVAL(z, n, data) \
::hexerboost::move_detail::declval< BOOST_PP_CAT(P, n) >() \
//!
...
#define BOOST_CONTAINER_PP_FWD_TYPE(z, n, data) \
   typename ::hexerboost::move_detail::forward_type< BOOST_PP_CAT(P, n) >::type \
//!
