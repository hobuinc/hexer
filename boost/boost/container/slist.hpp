...
struct intrusive_slist_type
{
   ...
   typedef typename hexerboost::intrusive::pointer_traits
                         ...
                         , typename iiterator_types<T, IIterator>::const_reference>
{
   ...
   { return ::hexerboost::intrusive::pointer_traits<const_pointer>::pointer_to(this->m_it->m_data); }
   ...
   : public slist_const_iterator<T, IIterator>
{
   ...
   { return ::hexerboost::intrusive::pointer_traits<pointer>::to_pointer(this->m_it->m_data); }
      ...
      <Allocator, typename container_detail::intrusive_slist_type<Allocator>::type>
{
   ...
   slist(BOOST_RV_REF(slist) x)
      : AllocHolder(hexerboost::move(static_cast<AllocHolder&>(x)))
   {}
   ...
   slist& operator= (BOOST_RV_REF(slist) x)
   {
      if (&x != this){
         ...
         if(this_alloc == x_alloc){
            ...
            this->clear();
            this->icont() = hexerboost::move(x.icont());
   ...
   {  this->emplace_after(this->cbefore_begin(), hexerboost::forward<Args>(args)...); }
   ...
   {
      NodePtr pnode(AllocHolder::create_node(hexerboost::forward<Args>(args)...));
   ...
   {  return this->emplace_after(this->previous(p), hexerboost::forward<Args>(args)...);  }
   ...
   {  this->insert(this->cbegin(), ::hexerboost::move(x));  }
   ...
   {  return this->insert_after(previous(p), ::hexerboost::forward<U>(x)); }

   template<class U>
   iterator priv_insert_after(const_iterator prev_pos, BOOST_FWD_REF(U) x)
   {  return iterator(this->icont().insert_after(prev_pos.get(), *this->create_node(::hexerboost::forward<U>(x)))); }
...
template <class T, class Allocator>
struct has_trivial_destructor_after_move<hexerboost::container::slist<T, Allocator> >
...
template <class T, class Allocator>
class insert_iterator<hexerboost::container::slist<T, Allocator> >
{
 protected:
   typedef hexerboost::container::slist<T, Allocator> Container;
   Container* container;
