...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace container {
...
struct uses_allocator
   : hexerboost::integral_constant<bool, container_detail::uses_allocator_imp<T, Alloc>::value>
{};
...
struct is_scoped_allocator
   : hexerboost::integral_constant<bool, container_detail::is_scoped_allocator_imp<Alloc>::value>
{};
...
// Check if we can detect is_convertible using advanced SFINAE expressions
   ...
   struct is_constructible_impl
   {
      ...
      template<class X>
      static yes_type test(dummy<sizeof(X(hexerboost::move_detail::declval<Args>()...))>*);
   ...
   struct is_constructible
      : hexerboost::integral_constant<bool, is_constructible_impl<T, Args...>::value>
   {};
...
inline void dispatch_allocator_prefix_suffix
   ( hexerboost::true_type  use_alloc_prefix, OutermostAlloc& outermost_alloc
   , InnerAlloc& inner_alloc, T* p, BOOST_FWD_REF(Args) ...args)
{
   (void)use_alloc_prefix;
   allocator_traits<OutermostAlloc>::construct
      ( outermost_alloc, p, allocator_arg, inner_alloc, ::hexerboost::forward<Args>(args)...);
}
...
template < typename OutermostAlloc
         ...
         >
inline void dispatch_allocator_prefix_suffix
   ( hexerboost::false_type use_alloc_prefix, OutermostAlloc& outermost_alloc
   , InnerAlloc &inner_alloc, T* p, BOOST_FWD_REF(Args)...args)
{
   (void)use_alloc_prefix;
   allocator_traits<OutermostAlloc>::construct
      (outermost_alloc, p, ::hexerboost::forward<Args>(args)..., inner_alloc);
}
...
inline void dispatch_uses_allocator
   ( hexerboost::true_type uses_allocator, OutermostAlloc& outermost_alloc
   , InnerAlloc& inner_alloc, T* p, BOOST_FWD_REF(Args)...args)
{
   (void)uses_allocator;
   ...
   dispatch_allocator_prefix_suffix
      ...
      , outermost_alloc, inner_alloc, p, ::hexerboost::forward<Args>(args)...);
}
...
template < typename OutermostAlloc
         ...
         >
inline void dispatch_uses_allocator
   ( hexerboost::false_type uses_allocator, OutermostAlloc & outermost_alloc
   , InnerAlloc & inner_alloc
   ,T* p, BOOST_FWD_REF(Args)...args)
{
   (void)uses_allocator; (void)inner_alloc;
   allocator_traits<OutermostAlloc>::construct
      (outermost_alloc, p, ::hexerboost::forward<Args>(args)...);
}
...
template < typename OutermostAlloc                                                           \
         ...
         >                                                                                   \
inline void dispatch_allocator_prefix_suffix(                                                \
                                       hexerboost::true_type  use_alloc_prefix,                   \
...
template < typename OutermostAlloc                                                           \
         ...
         >                                                                                   \
inline void dispatch_allocator_prefix_suffix(                                                \
                           hexerboost::false_type use_alloc_prefix,                               \
                           OutermostAlloc& outermost_alloc,                                  \
                           InnerAlloc&    inner_alloc,                                       \
...
template < typename OutermostAlloc                                                           \
         ...
         BOOST_PP_ENUM_TRAILING_PARAMS(n, class P)                                           \
         >                                                                                   \
inline void dispatch_uses_allocator(hexerboost::true_type uses_allocator,                         \
                        OutermostAlloc& outermost_alloc,                                     \
                        InnerAlloc&    inner_alloc,                                          \
                        T* p BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_LIST, _))    \
{                                                                                            \
...
template < typename OutermostAlloc                                                           \
         ...
         BOOST_PP_ENUM_TRAILING_PARAMS(n, class P)                                           \
         >                                                                                   \
inline void dispatch_uses_allocator(hexerboost::false_type uses_allocator                         \
                        ,OutermostAlloc &    outermost_alloc                                 \
                        ,InnerAlloc &    inner_alloc                                         \
                        ,T* p BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_LIST, _))   \
{                                                                                            \
   ...
   : public OuterAlloc
{
   ...
   typedef hexerboost::integral_constant<
      bool,
   ...
   scoped_allocator_adaptor_base(BOOST_FWD_REF(OuterA2) outerAlloc, const InnerAllocs &...args)
      : outer_allocator_type(::hexerboost::forward<OuterA2>(outerAlloc))
      , m_inner(args...)
      {}
   ...
   scoped_allocator_adaptor_base(BOOST_RV_REF(scoped_allocator_adaptor_base) other)
      : outer_allocator_type(::hexerboost::move(other.outer_allocator()))
      , m_inner(::hexerboost::move(other.inner_allocator()))
      {}
   ...
   {
      outer_allocator_type::operator=(hexerboost::move(other.outer_allocator()));
      m_inner = ::hexerboost::move(other.inner_allocator());
      return *this;
   }
         ...
         >
{
   ...
   scoped_allocator_adaptor(BOOST_RV_REF(scoped_allocator_adaptor) other)
      : base_type(::hexerboost::move(other.base()))
      {}
   ...
   //!
   //! <b>Effects</b>: initializes the OuterAlloc base class with hexerboost::forward<OuterA2>(outerAlloc) and inner
   ...
   scoped_allocator_adaptor(BOOST_FWD_REF(OuterA2) outerAlloc, const InnerAllocs & ...innerAllocs)
      : base_type(::hexerboost::forward<OuterA2>(outerAlloc), innerAllocs...)
      {}
   #else // #if !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES) || defined(BOOST_CONTAINER_DOXYGEN_INVOKED)
   ...
   scoped_allocator_adaptor(BOOST_FWD_REF(OuterA2) outerAlloc                                   \
                     BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_CONST_REF_PARAM_LIST_Q, _))   \
      : base_type(::hexerboost::forward<OuterA2>(outerAlloc)                                         \
                  BOOST_PP_ENUM_TRAILING_PARAMS(n, q)                                           \
                  )                                                                             \
      {}                                                                                        \
   //!
   ...
   {
      base_type::operator=(hexerboost::move(static_cast<scoped_allocator_adaptor&>(other)));
      return *this;
   }
   ...
   construct(T* p, BOOST_FWD_REF(Args)...args)
   {
      container_detail::dispatch_uses_allocator
         ...
         , p, ::hexerboost::forward<Args>(args)...);
   }
   ...
   {  this->construct_pair(p, ::hexerboost::forward<U>(x), ::hexerboost::forward<V>(y));   }
   ...
   {
      this->construct(container_detail::addressof(p->first), ::hexerboost::forward<U>(x));
      BOOST_TRY{
         this->construct(container_detail::addressof(p->second), ::hexerboost::forward<V>(y));
      }
      BOOST_CATCH(...){
         this->destroy(container_detail::addressof(p->first));
         BOOST_RETHROW
   ...
   {
      this->construct(container_detail::addressof(p->first), ::hexerboost::move(pr.first));
      BOOST_TRY{
         this->construct(container_detail::addressof(p->second), ::hexerboost::move(pr.second));
      }
      BOOST_CATCH(...){
         this->destroy(container_detail::addressof(p->first));
         BOOST_RETHROW
   ...
   scoped_allocator_adaptor(internal_type_t, BOOST_FWD_REF(OuterA2) outer, const inner_allocator_type& inner)
      : base_type(internal_type_t(), ::hexerboost::forward<OuterA2>(outer), inner)
   {}
   ...
   >& b)
{
   ...
   const bool has_zero_inner =
      hexerboost::container::container_detail::is_same
