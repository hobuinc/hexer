...
class basic_string_base
{
 ...
 public:
   ...
   typedef ::hexerboost::intrusive::pointer_traits<pointer> pointer_traits;
   ...
   basic_string_base(BOOST_RV_REF(basic_string_base) b)
      :  members_(hexerboost::move(b.alloc()))
   { 
      this->init();
      this->swap_data(b);
   }
   ...
   typedef typename hexerboost::aligned_storage< sizeof(long_t),
      ...
      :  public Allocator
   {
      ...
      explicit members_holder(BOOST_FWD_REF(AllocatorConvertible) a)
         :  Allocator(hexerboost::forward<AllocatorConvertible>(a))
      {}
   ...
   :  private container_detail::basic_string_base<Allocator>
{
   ...
   basic_string(BOOST_RV_REF(basic_string) s) BOOST_CONTAINER_NOEXCEPT
      : base_t(hexerboost::move((base_t&)s))
   {}
...
struct has_trivial_destructor_after_move<hexerboost::container::basic_string<C, T, Allocator> >
