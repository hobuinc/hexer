...
class vector_const_iterator
{
   ...
   typedef typename hexerboost::intrusive::pointer_traits<Pointer>::element_type         value_type;
   typedef typename hexerboost::intrusive::pointer_traits<Pointer>::difference_type      difference_type;
   typedef typename hexerboost::intrusive::pointer_traits<Pointer>::template
...
struct vector_value_traits
{
   ...
   static const bool trivial_dctr = hexerboost::has_trivial_destructor<value_type>::value;
   static const bool trivial_dctr_after_move = ::hexerboost::has_trivial_destructor_after_move<value_type>::value;
...
{
   typedef hexerboost::container::allocator_traits<Allocator> allocator_traits_type;
   ...
   vector_alloc_holder()
      BOOST_CONTAINER_NOEXCEPT_IF(::hexerboost::has_nothrow_default_constructor<Allocator>::value)
      : members_()
   {}
   ...
   explicit vector_alloc_holder(BOOST_FWD_REF(AllocConvertible) a) BOOST_CONTAINER_NOEXCEPT
      : members_(hexerboost::forward<AllocConvertible>(a))
   {}
   ...
   typedef container_detail::integral_constant<unsigned,
      hexerboost::container::container_detail::version<Allocator>::value> alloc_version;
      ...
      : public Allocator
   {
      ...
      explicit members_holder(BOOST_FWD_REF(Alloc) alloc)
         :  Allocator(hexerboost::forward<Alloc>(alloc)), m_start(0), m_size(0), m_capacity(0)
      {}
...
//! hexerboost::container::vector is similar to std::vector but it's compatible
...
class vector : private container_detail::vector_alloc_holder<Allocator>
{
   ...
   typedef T                                                                           value_type;
   typedef typename ::hexerboost::container::allocator_traits<Allocator>::pointer           pointer;
   typedef typename ::hexerboost::container::allocator_traits<Allocator>::const_pointer     const_pointer;
   typedef typename ::hexerboost::container::allocator_traits<Allocator>::reference         reference;
   typedef typename ::hexerboost::container::allocator_traits<Allocator>::const_reference   const_reference;
   typedef typename ::hexerboost::container::allocator_traits<Allocator>::size_type         size_type;
   typedef typename ::hexerboost::container::allocator_traits<Allocator>::difference_type   difference_type;
   typedef Allocator                                                                   allocator_type;
   ...
   vector(BOOST_RV_REF(vector) mx) BOOST_CONTAINER_NOEXCEPT
      :  base_t(hexerboost::move(mx.alloc()))
      ...
      BOOST_CONTAINER_NOEXCEPT
   {
      if (&x != this){
         ...
         //If unequal allocators, then do a one by one move
            ...
            this->assign( hexerboost::make_move_iterator(container_detail::to_raw_pointer(x.members_.m_start))
                        , hexerboost::make_move_iterator(container_detail::to_raw_pointer(x.members_.m_start + x.members_.m_size)));
         }
      }
      return *this;
   }
   ...
   void reserve(size_type new_cap)
   {
      if (this->capacity() < new_cap){
         ...
         //If there is no forward expansion, move objects
            ...
            container_detail::insert_range_proxy<Allocator, hexerboost::move_iterator<T*>, T*>
               proxy(this->alloc(), ::hexerboost::make_move_iterator((T *)0));
   ...
   void emplace_back(Args &&...args)
   {
      ...
      if (this->members_.m_size < this->members_.m_capacity){
         ...
         allocator_traits_type::construct(this->alloc(), back_pos, ::hexerboost::forward<Args>(args)...);
         ++this->members_.m_size;
      }
      else{
         typedef container_detail::insert_emplace_proxy<Allocator, T*, Args...> type;
         this->priv_forward_range_insert
            (back_pos, 1, type(this->alloc(), ::hexerboost::forward<Args>(args)...));
      }
   }
   ...
   iterator emplace(const_iterator position, Args && ...args)
   {
      ...
      return this->priv_forward_range_insert
         (position.get_ptr(), 1, type(this->alloc(), ::hexerboost::forward<Args>(args)...));
   }
   ...
   iterator erase(const_iterator position)
   {
      ...
      ::hexerboost::move(pos + 1, beg + this->members_.m_size, pos);
      --this->members_.m_size;
      //Destroy last element
   ...
   iterator erase(const_iterator first, const_iterator last)
   {
      if (first != last){
         ...
         T* ptr = container_detail::to_raw_pointer(hexerboost::move
   ...
   {
      return this->priv_forward_range_insert
         (p.get_ptr(), 1, container_detail::get_insert_value_proxy<T*>(this->alloc(), ::hexerboost::forward<U>(x)));
   }
   ...
   void priv_push_back(BOOST_FWD_REF(U) x)
   {
      if (this->members_.m_size < this->members_.m_capacity){
         ...
         allocator_traits_type::construct
            ...
            , ::hexerboost::forward<U>(x) );
         ++this->members_.m_size;
      }
      else{
         this->priv_insert(this->cend(), ::hexerboost::forward<U>(x));
      }
   }
      ...
      (size_type first_pos, size_type last_pos, size_type limit_pos, size_type shift_count)
   {
      ...
      if((last_pos + shift_count) <= limit_pos){
         //All move assigned
         hexerboost::move_backward(first_ptr, last_ptr, last_ptr + shift_count);
      }
      //Case B:
      else if((first_pos + shift_count) >= limit_pos){
         //All uninitialized_moved
         ::hexerboost::container::uninitialized_move_alloc(this->alloc(), first_ptr, last_ptr, first_ptr + shift_count);
      ...
      //Case C:
         ...
         ::hexerboost::container::uninitialized_move_alloc(this->alloc(), boundary_ptr, last_ptr, limit_ptr);
         //The rest is move assigned
         hexerboost::move_backward(first_ptr, boundary_ptr, limit_ptr);
      }
      return hole_size;
   }
   ...
   void priv_range_insert_expand_forward(T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if (!elems_after){
         ...
         ::hexerboost::container::uninitialized_move_alloc
            (this->alloc(), old_finish - n, old_finish, old_finish);
         this->members_.m_size += n;
         //Copy previous to last objects to the initialized end
         hexerboost::move_backward(pos, old_finish - n, old_finish);
         ...
         ::hexerboost::container::uninitialized_move_alloc(this->alloc(), pos, old_finish, pos + n);
         BOOST_TRY{
      ...
      (T* const new_start, size_type new_cap, T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if(old_buffer){
         new_finish = ::hexerboost::container::uninitialized_move_alloc
          ...
          T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if(s_before >= before_plus_new){
         ...
         T *const new_elem_pos = ::hexerboost::container::uninitialized_move_alloc(this->alloc(), old_start, pos, new_start);
         ...
         //s_before is so big that divides old_end
            ...
            ::hexerboost::container::uninitialized_move_alloc_n
            ...
            T * const to_destroy = ::hexerboost::move(pos + raw_gap, old_finish, old_start);
         ...
         if (s_before <= elemsbefore) {
            ...
            T *const next = ::hexerboost::move(old_start + s_before, pos, old_start);
            if(do_after){
               ...
               T* const move_end   = ::hexerboost::move(pos, old_finish, next + n);
            ...
            T * const new_pos = ::hexerboost::container::uninitialized_move_alloc
            ...
            if(do_after){
               ...
               //Displace old_end
               T* move_end = ::hexerboost::move(pos, old_finish, move_start);
         ...
         if(do_after){
            ...
            if (elemsafter >= n_after){
               ...
               hexerboost::move_backward(pos, finish_n, old_finish);
...
template <class T, class Allocator>
struct has_trivial_destructor_after_move<hexerboost::container::vector<T, Allocator> >
   : public ::hexerboost::has_trivial_destructor_after_move<Allocator>
{};
