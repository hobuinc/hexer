...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace mpl { namespace aux {
...
template< typename T, typename name = ::hexerboost::mpl::aux::has_xxx_tag > \
struct BOOST_PP_CAT(trait,_impl) : T \
{ \
    static hexerboost::mpl::aux::no_tag \
    test(void(*)(::hexerboost::mpl::aux::has_xxx_tag)); \
    \
    static hexerboost::mpl::aux::yes_tag test(...); \
    \
    BOOST_STATIC_CONSTANT(bool, value = \
          sizeof(test(static_cast<void(*)(name)>(0))) \
            != sizeof(hexerboost::mpl::aux::no_tag) \
        ); \
    typedef hexerboost::mpl::bool_<value> type; \
}; \
\
template< typename T, typename fallback_ = hexerboost::mpl::bool_<default_> > \
struct trait \
    : hexerboost::mpl::if_c< \
          hexerboost::mpl::aux::msvc_is_incomplete<T>::value \
        , hexerboost::mpl::bool_<false> \
...
{ \
    BOOST_STATIC_CONSTANT(bool, value = false); \
    typedef hexerboost::mpl::bool_<false> type; \
}; \
/**/
...
{ \
    ...
    { \
        template < class U > \
        static int  resolve( hexerboost::mpl::aux::type_wrapper<U> const volatile * \
                           , hexerboost::mpl::aux::type_wrapper<typename U::name >* = 0 ); \
        static char resolve( ... ); \
    }; \
    typedef hexerboost::mpl::aux::type_wrapper<T> t_; \
    BOOST_STATIC_CONSTANT( bool, value = ( sizeof( trait_tester_impl::resolve( static_cast< t_ * >(0) ) ) == sizeof(int) ) ); \
}; \
template< typename T, typename fallback_ = hexerboost::mpl::bool_<default_> > \
struct trait           \
{                      \
    BOOST_STATIC_CONSTANT( bool, value = (trait_tester< T, hexerboost::is_class< T >::value >::value) );     \
    typedef hexerboost::mpl::bool_< trait< T, fallback_ >::value > type; \
};
...
{ \
    ...
    { \
        template< typename U > \
        static hexerboost::mpl::aux::yes_tag test( \
              hexerboost::mpl::aux::type_wrapper<U> const volatile* \
            , hexerboost::mpl::aux::type_wrapper<BOOST_MSVC_TYPENAME U::name>* = 0 \
            ); \
    \
        static hexerboost::mpl::aux::no_tag test(...); \
    }; \
    \
    typedef hexerboost::mpl::aux::type_wrapper<T> t_; \
    BOOST_STATIC_CONSTANT(bool, value = \
          sizeof(gcc_3_2_wknd::test(static_cast<t_*>(0))) \
            == sizeof(hexerboost::mpl::aux::yes_tag) \
        ); \
    typedef hexerboost::mpl::bool_<value> type; \
}; \
/**/
...
#     define BOOST_MPL_HAS_MEMBER_MULTI_ACCEPT(z, n, args) \
        template< typename V > \
        static hexerboost::mpl::aux::yes_tag \
        BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)( \
            hexerboost::mpl::aux::type_wrapper< V > const volatile* \
...
#       define BOOST_MPL_HAS_MEMBER_TEST(args) \
          sizeof( \
              BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)( \
                  static_cast< hexerboost::mpl::aux::type_wrapper< U >* >(0) \
              ) \
          ) == sizeof(hexerboost::mpl::aux::yes_tag) \
        /**/
#     else
...
#   define BOOST_MPL_HAS_MEMBER_IMPLEMENTATION( \
      ...
      template< \
          typename T \
        , typename fallback_ \
              = hexerboost::mpl::bool_< BOOST_PP_ARRAY_ELEM(3, args) > \
      > \
...
#   define BOOST_MPL_HAS_XXX_TEMPLATE_NAMED_DEF(trait, name, default_) \
      template< typename T \
              , typename fallback_ = hexerboost::mpl::bool_< default_ > > \
      struct trait { \
          BOOST_STATIC_CONSTANT(bool, value = fallback_::value); \
          typedef fallback_ type; \
      }; \
