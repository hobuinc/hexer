...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace mpl { using namespace BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE; 
...
#   define BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE hexerboost::mpl
#   define BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_OPEN namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace mpl {
#   define BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_CLOSE }}
#   define BOOST_MPL_AUX_ADL_BARRIER_DECL(type) /**/
