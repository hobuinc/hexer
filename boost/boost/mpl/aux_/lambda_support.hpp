...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::hexerboost::mpl::aux::yes_tag operator|( \
      ::hexerboost::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::hexerboost::mpl::aux::no_tag operator|( \
      ::hexerboost::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::hexerboost::mpl::na) >* \
    ); \
/**/
...
::hexerboost::mpl::aux::yes_tag operator|( \
      ::hexerboost::mpl::aux::has_rebind_tag<int> \
    , ::hexerboost::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
