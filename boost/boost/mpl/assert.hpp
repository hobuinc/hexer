...
hexerboost::mpl::aux::weighted_tag<1>::type operator==( assert_, assert_ );
hexerboost::mpl::aux::weighted_tag<2>::type operator!=( assert_, assert_ );
hexerboost::mpl::aux::weighted_tag<3>::type operator>(  assert_, assert_ );
hexerboost::mpl::aux::weighted_tag<4>::type operator>=( assert_, assert_ );
hexerboost::mpl::aux::weighted_tag<5>::type operator<( assert_, assert_ );
hexerboost::mpl::aux::weighted_tag<6>::type operator<=( assert_, assert_ );
...
template< typename Pred >
failed ************ (hexerboost::mpl::not_<Pred>::************ 
...
template< typename Pred >
typename assert_arg_type< hexerboost::mpl::not_<Pred> >::type 
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          hexerboost::mpl::assertion_failed<false>( \
              hexerboost::mpl::assert_arg( (void (*) pred)0, 1 ) \
            ) \
        ) \
    ) \
/**/
...
enum { \
      BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          hexerboost::mpl::assertion<false>::failed( \
              hexerboost::mpl::assert_not_arg( (void (*) pred)0, 1 ) \
            ) \
        ) \
}\
/**/
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        hexerboost::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value,counter)>( \
            (hexerboost::mpl::failed ************ ( hexerboost::mpl::assert_relation< \
                  hexerboost::mpl::assert_::relations( sizeof( \
                      hexerboost::mpl::assert_::arg rel hexerboost::mpl::assert_::arg \
                    ) ) \
                , x \
                , y \
                >::************)) 0 ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        hexerboost::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value,counter)>( \
              hexerboost::mpl::assert_rel_arg( hexerboost::mpl::assert_relation< \
                  hexerboost::mpl::assert_::relations(BOOST_PP_CAT(mpl_assert_rel,counter)) \
                , x \
                , y \
                >() ) \
            ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
        hexerboost::mpl::assertion_failed<(x rel y)>( hexerboost::mpl::assert_rel_arg( \
              hexerboost::mpl::BOOST_MPL_AUX_ASSERT_RELATION(x,y,(&hexerboost::mpl::operator rel))() \
            ) ) \
        ) \
    ) \
/**/
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
        hexerboost::mpl::assertion_failed<(x rel y)>( (hexerboost::mpl::failed ************ ( \
            hexerboost::mpl::BOOST_MPL_AUX_ASSERT_RELATION(x,y,(&hexerboost::mpl::operator rel))::************))0 ) \
        ) \
    ) \
/**/
#   endif
...
struct msg; \
typedef struct BOOST_PP_CAT(msg,counter) : hexerboost::mpl::assert_ \
{ \
    using hexerboost::mpl::assert_::types; \
    static hexerboost::mpl::failed ************ (msg::************ assert_arg()) types_ \
    { return 0; } \
} BOOST_PP_CAT(mpl_assert_arg,counter); \
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        hexerboost::mpl::assertion<(c)>::failed( BOOST_PP_CAT(mpl_assert_arg,counter)::assert_arg() ) \
        ) \
    ) \
/**/
#else
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        hexerboost::mpl::assertion_failed<(c)>( BOOST_PP_CAT(mpl_assert_arg,counter)::assert_arg() ) \
        ) \
    ) \
/**/
#endif
