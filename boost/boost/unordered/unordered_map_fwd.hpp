...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost
{
    ...
    using hexerboost::unordered::unordered_map;
    using hexerboost::unordered::unordered_multimap;
    using hexerboost::unordered::swap;
    using hexerboost::unordered::operator==;
    using hexerboost::unordered::operator!=;
}
