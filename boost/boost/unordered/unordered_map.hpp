...
namespace unordered
{
    ...
    private:
        ...
        typedef hexerboost::unordered::detail::map<A, K, T, H, P> types;
    ...
    public:
        ...
        explicit unordered_map(
                size_type = hexerboost::unordered::detail::default_bucket_count,
                const hasher& = hasher(),
        ...
        unordered_map(BOOST_RV_REF(unordered_map) other)
            : table_(other.table_, hexerboost::unordered::detail::move_tag())
        {
        }
        ...
        {
            return table_.emplace(hexerboost::forward<Args>(args)...);
        }

        template <class... Args>
        iterator emplace_hint(const_iterator, BOOST_FWD_REF(Args)... args)
        {
            return table_.emplace(hexerboost::forward<Args>(args)...).first;
        }
#else
        ...
        std::pair<iterator, bool> emplace(
                hexerboost::unordered::detail::empty_emplace
                    = hexerboost::unordered::detail::empty_emplace(),
                value_type v = value_type())
        {
            return this->emplace(hexerboost::move(v));
        }
        ...
        {
            return this->emplace_hint(hint, hexerboost::move(v));
        }
        ...
        std::pair<iterator, bool> emplace(BOOST_FWD_REF(A0) a0)
        {
            return table_.emplace(
                hexerboost::unordered::detail::create_emplace_args(
                    hexerboost::forward<A0>(a0))
            );
        }
...
#undef BOOST_UNORDERED_EMPLACE
        ...
        {
            return this->emplace(hexerboost::move(x));
        }
        ...
        {
            return this->emplace_hint(hint, hexerboost::move(x));
        }
    ...
    private:
        ...
        typedef hexerboost::unordered::detail::multimap<A, K, T, H, P> types;
        typedef typename types::traits allocator_traits;
        typedef typename types::table table;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    unordered_map<K,T,H,P,A>::unordered_map(allocator_type const& a)
      : table_(hexerboost::unordered::detail::default_bucket_count,
            hasher(), key_equal(), a)
    {
    }
    ...
    unordered_map<K,T,H,P,A>::unordered_map(InputIt f, InputIt l)
      : table_(hexerboost::unordered::detail::initial_size(f, l),
    ...
    unordered_map<K,T,H,P,A>::unordered_map(
            ...
            const hasher &hf,
            const key_equal &eql)
      : table_(hexerboost::unordered::detail::initial_size(f, l, n),
    ...
    unordered_map<K,T,H,P,A>::unordered_map(
            ...
            const key_equal &eql,
            const allocator_type &a)
      : table_(hexerboost::unordered::detail::initial_size(f, l, n), hf, eql, a)
    {
        table_.insert_range(f, l);
    }
    ...
    unordered_map<K,T,H,P,A>::unordered_map(
      ...
      : table_(other.table_, a, hexerboost::unordered::detail::move_tag())
    {
    }
    ...
    unordered_map<K,T,H,P,A>::unordered_map(
      ...
      : table_(
            hexerboost::unordered::detail::initial_size(
