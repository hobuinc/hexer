...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace unordered { namespace detail {
    ...
    struct grouped_node :
        hexerboost::unordered::detail::value_base<T>
    {
        typedef typename ::hexerboost::unordered::detail::rebind_wrap<
            A, grouped_node<A, T> >::type allocator;
        typedef typename ::hexerboost::unordered::detail::
    ...
    struct grouped_ptr_node :
        hexerboost::unordered::detail::value_base<T>,
        hexerboost::unordered::detail::ptr_bucket
    {
        typedef hexerboost::unordered::detail::ptr_bucket bucket_base;
    ...
    {
        typedef hexerboost::unordered::detail::grouped_node<A, T> node;

        typedef typename hexerboost::unordered::detail::allocator_traits<
            typename hexerboost::unordered::detail::rebind_wrap<A, node>::type
        >::pointer node_pointer;

        typedef hexerboost::unordered::detail::bucket<node_pointer> bucket;
        typedef node_pointer link_pointer;
    };

    template <typename A, typename T>
    struct pick_grouped_node2<A, T,
        hexerboost::unordered::detail::grouped_ptr_node<T>*,
        hexerboost::unordered::detail::ptr_bucket*>
    {
        typedef hexerboost::unordered::detail::grouped_ptr_node<T> node;
        typedef hexerboost::unordered::detail::ptr_bucket bucket;
    ...
    {
        typedef hexerboost::unordered::detail::allocator_traits<
            typename hexerboost::unordered::detail::rebind_wrap<A,
                hexerboost::unordered::detail::grouped_ptr_node<T> >::type
        > tentative_node_traits;

        typedef hexerboost::unordered::detail::allocator_traits<
            typename hexerboost::unordered::detail::rebind_wrap<A,
                hexerboost::unordered::detail::ptr_bucket >::type
    ...
    struct multiset
    {
        typedef hexerboost::unordered::detail::multiset<A, T, H, P> types;
        ...
        typedef hexerboost::unordered::detail::pick_grouped_node<allocator,
            value_type> pick;
        typedef typename pick::node node;
        typedef typename pick::bucket bucket;
        typedef typename pick::link_pointer link_pointer;

        typedef hexerboost::unordered::detail::grouped_table_impl<types> table;
        typedef hexerboost::unordered::detail::set_extractor<value_type> extractor;

        typedef hexerboost::unordered::detail::pick_policy::type policy;
    };

    template <typename A, typename K, typename M, typename H, typename P>
    struct multimap
    {
        typedef hexerboost::unordered::detail::multimap<A, K, M, H, P> types;
        ...
        typedef hexerboost::unordered::detail::grouped_table_impl<types> table;
        typedef hexerboost::unordered::detail::map_extractor<key_type, value_type>
            extractor;
    ...
    struct grouped_table_impl : hexerboost::unordered::detail::table<Types>
    {
        typedef hexerboost::unordered::detail::table<Types> table;
        ...
        grouped_table_impl(grouped_table_impl& x,
                hexerboost::unordered::detail::move_tag m)
          : table(x, m)
        {}
...
#   if defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
        iterator emplace(hexerboost::unordered::detail::emplace_args1<
                hexerboost::unordered::detail::please_ignore_this_overload> const&)
        {
            BOOST_ASSERT(false);
            return iterator();
        }
...
#   endif
        ...
        template <class I>
        typename hexerboost::unordered::detail::enable_if_forward<I, void>::type
            insert_range(I i, I j)
        {
            if(i == j) return;

            std::size_t distance = hexerboost::unordered::detail::distance(i, j);
            if(distance == 1) {
                node_constructor a(this->node_alloc());
        ...
        template <class I>
        typename hexerboost::unordered::detail::disable_if_forward<I, void>::type
            insert_range(I i, I j)
        {
            node_constructor a(this->node_alloc());
            for (; i != j; ++i) {
        ...
        static link_pointer split_groups(node_pointer begin, node_pointer end)
        {
            ...
            if (end) {
                ...
                hexerboost::swap(first->group_prev_, end->group_prev_);
            ...
            if (prev) {
                ...
                hexerboost::swap(first->group_prev_, begin->group_prev_);
            }
