...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace unordered { namespace detail {
    ...
    struct value_base
    {
        ...
        typename hexerboost::aligned_storage<
            sizeof(value_type),
            hexerboost::alignment_of<value_type>::value>::type data_;
    ...
    struct move_nodes
    {
        ...
        {
            constructor.construct_with_value2(hexerboost::move(v));
            return constructor.release();
        }
    };
    ...
    struct table :
        hexerboost::unordered::detail::functions<
    ...
    public:
        ...
        typedef hexerboost::unordered::detail::functions<
            typename Types::hasher,
        ...
        typedef hexerboost::unordered::detail::allocator_traits<node_allocator>
            node_allocator_traits;
        typedef hexerboost::unordered::detail::allocator_traits<bucket_allocator>
        ...
        typedef typename bucket_allocator_traits::pointer
            bucket_pointer;
        typedef hexerboost::unordered::detail::node_constructor<node_allocator>
            node_constructor;

        typedef hexerboost::unordered::iterator_detail::
        ...
        hexerboost::unordered::detail::compressed<bucket_allocator, node_allocator>
            allocators_;
        ...
        std::size_t max_size() const
        {
            ...
            // size < mlf_ * count
            return hexerboost::unordered::detail::double_to_size(ceil(
        ...
        void recalculate_max_load()
        {
            ...
            max_load_ = buckets_ ? hexerboost::unordered::detail::double_to_size(ceil(
                    static_cast<double>(mlf_) *
        ...
        std::size_t min_buckets_for_size(std::size_t size) const
        {
            ...
            return policy::new_bucket_count(
                hexerboost::unordered::detail::double_to_size(floor(
        ...
        table(table& x, hexerboost::unordered::detail::move_tag m) :
            functions(x),
        ...
        table(table& x, node_allocator const& a,
                hexerboost::unordered::detail::move_tag) :
            functions(x),
            allocators_(a, a),
            bucket_count_(x.bucket_count_),
            size_(0),
        ...
        {
            hexerboost::unordered::detail::array_constructor<bucket_allocator>
        ...
        void swap(table& x)
        {
            hexerboost::unordered::detail::set_hash_functions<hasher, key_equal>
                op1(*this, x);
            hexerboost::unordered::detail::set_hash_functions<hasher, key_equal>
                op2(x, *this);
            ...
            swap_allocators(x,
                hexerboost::unordered::detail::integral_constant<bool,
                    allocator_traits<node_allocator>::
                    propagate_on_container_swap::value>());

            hexerboost::swap(buckets_, x.buckets_);
            hexerboost::swap(bucket_count_, x.bucket_count_);
            hexerboost::swap(size_, x.size_);
        ...
        void delete_node(link_pointer prev)
        {
            ...
            hexerboost::unordered::detail::destroy_value_impl(node_alloc(),
                n->value_ptr());
            node_allocator_traits::destroy(node_alloc(),
                    hexerboost::addressof(*n));
        ...
        {
            if (this != hexerboost::addressof(x))
            {
                assign(x,
                    hexerboost::unordered::detail::integral_constant<bool,
                        allocator_traits<node_allocator>::
