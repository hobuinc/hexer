...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace unordered { namespace iterator_detail {
            ...
            typename Node::value_type&>
    {
        ...
        friend struct hexerboost::unordered::iterator_detail::cl_iterator;
    private:
#endif
        typedef typename Node::node_pointer node_pointer;
        typedef hexerboost::unordered::iterator_detail::iterator<Node> iterator;
        node_pointer ptr_;
        std::size_t bucket_;
    ...
    {
        friend struct hexerboost::unordered::iterator_detail::l_iterator
            <Node, Policy>;
    private:
    ...
    public:
        ...
        cl_iterator(hexerboost::unordered::iterator_detail::l_iterator<
                Node, Policy> const& x) :
            ...
            typename Node::value_type&>
    {
        ...
        friend struct hexerboost::unordered::iterator_detail::c_iterator;
        template <typename, typename>
        friend struct hexerboost::unordered::iterator_detail::l_iterator;
        template <typename, typename, typename>
        friend struct hexerboost::unordered::iterator_detail::cl_iterator;
        template <typename>
        friend struct hexerboost::unordered::detail::table;
        template <typename>
        friend struct hexerboost::unordered::detail::table_impl;
        template <typename>
        friend struct hexerboost::unordered::detail::grouped_table_impl;
    private:
#endif
        typedef typename Node::node_pointer node_pointer;
        node_pointer node_;
    ...
    struct c_iterator
        : public hexerboost::iterator<
            ...
            typename Node::value_type const&>
    {
        friend struct hexerboost::unordered::iterator_detail::iterator<Node>;
...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace unordered { namespace detail {
    ...
    private:
        ...
        typedef hexerboost::unordered::detail::allocator_traits<NodeAlloc>
    ...
    public:
        ...
        {
            construct();
            hexerboost::unordered::detail::construct_value_impl(
        ...
        void construct_with_value2(BOOST_FWD_REF(A0) a0)
        {
            ...
            hexerboost::unordered::detail::construct_value_impl(
                ...
                BOOST_UNORDERED_EMPLACE_ARGS1(hexerboost::forward<A0>(a0)));
            value_constructed_ = true;
        }
    ...
    node_constructor<Alloc>::~node_constructor()
    {
        if (node_) {
            if (value_constructed_) {
                hexerboost::unordered::detail::destroy_value_impl(alloc_,
                    node_->value_ptr());
            }

            if (node_constructed_) {
                node_allocator_traits::destroy(alloc_,
                    hexerboost::addressof(*node_));
            }
    ...
    void node_constructor<Alloc>::construct()
    {
        if(!node_) {
            ...
            node_allocator_traits::construct(alloc_,
                hexerboost::addressof(*node_), node());
            node_->init(node_);
    ...
    public:
        ...
        inline void move_assign_impl(T& v) {
            if (this->node_ && this->value_constructed_) {
                this->node_->value() = hexerboost::move(v);
            }
            else {
                this->construct_with_value2(hexerboost::move(v));
            }
        }
    ...
    node_holder<Alloc>::~node_holder()
    {
        while (nodes_) {
            ...
            hexerboost::unordered::detail::destroy_value_impl(this->alloc_,
                p->value_ptr());
            node_allocator_traits::destroy(this->alloc_, hexerboost::addressof(*p));
    ...
    struct prime_policy
    {
        ...
        static inline SizeT new_bucket_count(SizeT min) {
            return hexerboost::unordered::detail::next_prime(min);
        }

        static inline SizeT prev_bucket_count(SizeT max) {
            return hexerboost::unordered::detail::prev_prime(max);
        }
    };
    ...
    class functions
    {
        friend class hexerboost::unordered::detail::set_hash_functions<H, P>;
        functions& operator=(functions const&);

        typedef compressed<H, P> function_pair;

        typedef typename hexerboost::aligned_storage<
            sizeof(function_pair),
            hexerboost::alignment_of<function_pair>::value>::type aligned_function;
        ...
        {
            hexerboost::unordered::detail::destroy((function_pair*)(&funcs_[which]));
        }
...
#   define BOOST_UNORDERED_RV_REF(T) BOOST_RV_REF(T)
    ...
    template <typename T>
    struct rv_ref :
        hexerboost::detail::if_true<
            hexerboost::is_class<T>::value
        >::BOOST_NESTED_TEMPLATE then <
            hexerboost::unordered::detail::rv_ref_impl<T>,
            please_ignore_this_overload
        >::type
    {};

#   define BOOST_UNORDERED_RV_REF(T) \
        typename hexerboost::unordered::detail::rv_ref<T>::type
#endif
}}}
