...
#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace { namespace hexerboost_typeof {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER hexerboost_typeof

#else

#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace type_of {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER hexerboost::type_of
