...
#define BOOST_TYPEOF_REGISTER_TEMPLATE_IMPL(Name, Params, Size, ID)\
    ...
    {\
        typedef typename hexerboost::type_of::push_back<V, hexerboost::mpl::size_t<ID> >::type V0;\
    ...
    {\
        typedef decode_type_impl<hexerboost::mpl::size_t<ID>, Iter> self_t;\
        typedef hexerboost::mpl::size_t<ID> self_id;\
        typedef Iter iter0;\
