...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace program_options {
    ...
    */
    ...
    public:
        ...
        */
        virtual void parse(hexerboost::any& value_store, 
        ...
        /** Called to assign default value to 'value_store'. Returns
            ...
            value exists. */
        virtual bool apply_default(hexerboost::any& value_store) const = 0;
                                   
        /** Called when final value of an option is determined. 
        */
        virtual void notify(const hexerboost::any& value_store) const = 0;
    ...
    */
    ...
    private: // base overrides
        void parse(hexerboost::any& value_store, 
                   const std::vector<std::string>& new_tokens,
                   bool utf8) const;
    protected: // interface for derived classes.
        virtual void xparse(hexerboost::any& value_store, 
                            const std::vector<std::string>& new_tokens) 
            const = 0;
    };
    ...
    */
    ...
    public:
        ...
        /** If 'value_store' is already initialized, or new_tokens
            ...
            any modifications.
         */
        void xparse(hexerboost::any& value_store,
                    const std::vector<std::string>& new_tokens) const;

        /** Does nothing. */
        bool apply_default(hexerboost::any&) const { return false; }

        /** Does nothing. */
        void notify(const hexerboost::any&) const {}        
    private:
        bool m_zero_tokens;
    };
    ...
    */
    ...
    public:
        ...
        */
        ...
        {
            m_default_value = hexerboost::any(v);
            m_default_value_as_text = hexerboost::lexical_cast<std::string>(v);
            return this;
        }
        ...
        */
        ...
        {
            m_implicit_value = hexerboost::any(v);
            m_implicit_value_as_text =
                hexerboost::lexical_cast<std::string>(v);
            return this;
        }
    ...
    public: // value semantic overrides
        ...
        */
        virtual bool apply_default(hexerboost::any& value_store) const
        {
        ...
        /** If an address of variable to store value was specified
            ...
            does nothing. */
        void notify(const hexerboost::any& value_store) const;
    ...
    private:
        ...
        // Default value is stored as hexerboost::any and not
        // as hexerboost::optional to avoid unnecessary instantiations.
        std::string m_value_name;
        hexerboost::any m_default_value;
        std::string m_default_value_as_text;
        hexerboost::any m_implicit_value;
        std::string m_implicit_value_as_text;
        bool m_composing, m_implicit, m_multitoken, m_zero_tokens, m_required;
        hexerboost::function1<void, const T&> m_notifier;
    };
