...
#   pragma warning (push)
#   pragma warning (disable:4251) // class 'hexerboost::shared_ptr<T>' needs to have dll-interface to be used by clients of class 'hexerboost::program_options::option_description'
#endif
