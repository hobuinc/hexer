...
#   pragma warning (push)
#   pragma warning (disable:4251) // 'hexerboost::program_options::variable_value::v' : class 'hexerboost::any' needs to have dll-interface to be used by clients of class 'hexerboost::program_options::variable_value
#endif
...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace program_options {
    ...
    */
    ...
    public:
        ...
        variable_value(const hexerboost::any& xv, bool xdefaulted) 
        : v(xv), m_defaulted(xdefaulted) 
        {}

        /** If stored value if of type T, returns that value. Otherwise,
            throws hexerboost::bad_any_cast exception. */
       template<class T>
       const T& as() const {
           return hexerboost::any_cast<const T&>(v);
       }
       /** @overload */
       template<class T>
       T& as() {
           return hexerboost::any_cast<T&>(v);
       }
        ...
        const hexerboost::any& value() const;

        /** Returns the contained value. */
        hexerboost::any& value();
    private:
        hexerboost::any v;
        bool m_defaulted;
