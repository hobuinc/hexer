...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_impl(Float v,
            BOOST_DEDUCED_TYPENAME hexerboost::enable_if_c<
        ...
        {
            hexerboost::hash_detail::call_frexp<T> frexp;
            hexerboost::hash_detail::call_ldexp<T> ldexp;
            ...
            std::size_t const length
                = (limits<T>::digits *
                        hexerboost::static_log2<limits<T>::radix>::value
...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_value(T v)
        {
            return hexerboost::hash_detail::is_zero(v) ? 0 : float_hash_impl(v, 0);
        }
    }
}
