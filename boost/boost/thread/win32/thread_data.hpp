...
//#endif
            ...
            void notify_all_hexerboostat_thread_exit(condition_variable* cv, mutex* m)
            {
        ...
        typedef hexerboost::intrusive_ptr<detail::thread_data_base> thread_data_ptr;
        ...
        struct BOOST_SYMBOL_VISIBLE timeout
        {
            ...
            bool relative;
            hexerboost::system_time abs_time;
            ...
            timeout(uintmax_t milliseconds_):
                ...
                relative(true),
                abs_time(hexerboost::get_system_time())
            {}

            timeout(hexerboost::system_time const& abs_time_):
                start(win32::GetTickCount()),
                milliseconds(0),
                relative(false),
                abs_time(abs_time_)
