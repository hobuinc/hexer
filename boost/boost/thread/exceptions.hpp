...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost
{
    ...
    public:
        lock_error()
        : base_type(0, "hexerboost::lock_error")
        {}

        lock_error( int ev )
        : base_type(ev, "hexerboost::lock_error")
        {
        }
    ...
    public:
          ...
          : base_type(system::errc::resource_unavailable_try_again, "hexerboost::thread_resource_error")
          {}

          thread_resource_error( int ev )
          : base_type(ev, "hexerboost::thread_resource_error")
          {
          }
    ...
    public:
          ...
          : base_type(system::errc::invalid_argument, "hexerboost::unsupported_thread_option")
          {}

          unsupported_thread_option( int ev )
          : base_type(ev, "hexerboost::unsupported_thread_option")
          {
          }
    ...
    public:
        ...
        : base_type(system::errc::invalid_argument, "hexerboost::invalid_thread_argument")
        {}

        invalid_thread_argument( int ev )
        : base_type(ev, "hexerboost::invalid_thread_argument")
        {
        }
    ...
    public:
          ...
          : base_type(system::errc::permission_denied, "hexerboost::thread_permission_error")
          {}

          thread_permission_error( int ev )
          : base_type(ev, "hexerboost::thread_permission_error")
          {
          }
