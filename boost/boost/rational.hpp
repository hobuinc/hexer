...
#include <boost/operators.hpp>   // for hexerboost::addable etc
#include <cstdlib>               // for std::abs
#include <boost/call_traits.hpp> // for hexerboost::call_traits
#include <boost/config.hpp>      // for BOOST_NO_STDC_NAMESPACE, BOOST_MSVC
#include <boost/detail/workaround.hpp> // for BOOST_WORKAROUND
#include <boost/assert.hpp>      // for BOOST_ASSERT
#include <boost/math/common_factor_rt.hpp>  // for hexerboost::math::gcd, lcm
    ...
    > > > > > > > > > > > > > > > >
{
    ...
    // Helper types
    typedef typename hexerboost::call_traits<IntType>::param_type param_type;
