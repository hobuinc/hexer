...
namespace date_time {
  ...
  class date_duration : private
              hexerboost::less_than_comparable1< date_duration< duration_rep_traits >
            , hexerboost::equality_comparable1< date_duration< duration_rep_traits >
            , hexerboost::addable1< date_duration< duration_rep_traits >
            , hexerboost::subtractable1< date_duration< duration_rep_traits >
            , hexerboost::dividable2< date_duration< duration_rep_traits >, int
            > > > > >
  {
  public:
  ...
  {
    typedef long int_type;
    typedef hexerboost::date_time::int_adapter<long> impl_type;
