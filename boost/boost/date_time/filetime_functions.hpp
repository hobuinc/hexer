...
namespace winapi {
    ...
    extern "C" {
        ...
        struct FILETIME
        {
            hexerboost::uint32_t dwLowDateTime;
            hexerboost::uint32_t dwHighDateTime;
        };
        struct SYSTEMTIME
        {
            hexerboost::uint16_t wYear;
            hexerboost::uint16_t wMonth;
            hexerboost::uint16_t wDayOfWeek;
            hexerboost::uint16_t wDay;
            hexerboost::uint16_t wHour;
            hexerboost::uint16_t wMinute;
            hexerboost::uint16_t wSecond;
            hexerboost::uint16_t wMilliseconds;
        };
     ...
     *       hexerboost::date_time::winapi::file_time type.
     */
    template< typename FileTimeT >
    inline hexerboost::uint64_t file_time_to_microseconds(FileTimeT const& ft)
    {
