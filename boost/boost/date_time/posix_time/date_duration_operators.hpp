...
namespace posix_time {
  ...
  inline
  ptime 
  operator+(const ptime& t, const hexerboost::gregorian::months& m)
  {
  ...
  inline
  ptime 
  operator+=(ptime& t, const hexerboost::gregorian::months& m)
  {
  ...
  inline
  ptime 
  operator+(const ptime& t, const hexerboost::gregorian::years& y)
  {
  ...
  inline
  ptime 
  operator+=(ptime& t, const hexerboost::gregorian::years& y)
  {
    return t += y.get_offset(t.date());
  }
