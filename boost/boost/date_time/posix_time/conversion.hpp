...
namespace posix_time {
  ...
  inline
  std::tm to_tm(const hexerboost::posix_time::ptime& t) {
    std::tm timetm = hexerboost::gregorian::to_tm(t.date());
    hexerboost::posix_time::time_duration td = t.time_of_day();
  ...
  inline
  std::tm to_tm(const hexerboost::posix_time::time_duration& td) {
    std::tm timetm;
  ...
  ptime ptime_from_tm(const std::tm& timetm) {
    hexerboost::gregorian::date d = hexerboost::gregorian::date_from_tm(timetm);
  ...
  {
    return hexerboost::date_time::time_from_ftime<TimeT>(ft);
  }

#endif // BOOST_HAS_FTIME

} } //namespace hexerboost::posix_time
