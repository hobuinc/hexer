...
class multi_index_container:
  private ::hexerboost::base_from_member<
    typename hexerboost::detail::allocator::rebind_to<
      Allocator,
...
private:
  ...
  typedef typename
  hexerboost::detail::allocator::rebind_to<
      Allocator,
      typename super::node_type
  >::type                                         node_allocator;
  typedef ::hexerboost::base_from_member<
...
BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS:
  ...
  friend class hexerboost::serialization::access;
...
>
typename ::hexerboost::multi_index::index<
  ...
  BOOST_APPEND_EXPLICIT_TEMPLATE_TYPE(Tag))
{
  typedef multi_index_container<
    Value,IndexSpecifierList,Allocator>         multi_index_type;
  typedef typename ::hexerboost::multi_index::index<
    multi_index_container<
      Value,IndexSpecifierList,Allocator>,
    Tag
  >::type                                       index;
...
template<
  typename Tag,typename Value,typename IndexSpecifierList,typename Allocator
>
const typename ::hexerboost::multi_index::index<
  multi_index_container<Value,IndexSpecifierList,Allocator>,Tag>::type&
get(
  const multi_index_container<Value,IndexSpecifierList,Allocator>& m
  BOOST_APPEND_EXPLICIT_TEMPLATE_TYPE(Tag))
 ...
 * hexerboost::serialization::collection_size_type.
...
template<typename Value,typename IndexSpecifierList,typename Allocator>
struct version<
  hexerboost::multi_index_container<Value,IndexSpecifierList,Allocator>
>
{
...
/* Associated global functions are promoted to namespace hexerboost, except
