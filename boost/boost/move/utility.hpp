...
#include <boost/move/detail/meta_utils.hpp>
   ...
   template <class T>
   inline typename ::hexerboost::move_detail::enable_if_c
   ...
   inline typename ::hexerboost::move_detail::enable_if_c
      < enable_move_utility_emulation<T>::value && has_move_emulation_enabled<T>::value, rv<T>&>::type
         move(T& x)
   {
      return *static_cast<rv<T>* >(::hexerboost::move_detail::addressof(x));
   }
   ...
   template <class T>
   inline typename ::hexerboost::move_detail::enable_if_c
      < enable_move_utility_emulation<T>::value && ::hexerboost::move_detail::is_rv<T>::value, T &>::type
         forward(const typename ::hexerboost::move_detail::identity<T>::type &x)
   {
   ...
   template <class T>
   inline typename ::hexerboost::move_detail::enable_if_c
      < enable_move_utility_emulation<T>::value && !::hexerboost::move_detail::is_rv<T>::value, const T &>::type
      forward(const typename ::hexerboost::move_detail::identity<T>::type &x)
   {
      return x;
   }
      ...
      //! so that the user can define a different move emulation for that type in namespace hexerboost
      ...
      //////////////////////////////////////////////////////////////////////////////
         ...
         //! <i>::hexerboost::rv<T> &</i> so that move emulation is activated.
         template <class T>
      ...
      //////////////////////////////////////////////////////////////////////////////
         ...
         //!
         //! Otherwise:
         //! * If input_reference binds to const ::hexerboost::rv<T> & then it output_reference is
         //!   ::hexerboost::rv<T> &
         //!
         ...
         template <class T>
         inline T&& forward (typename ::hexerboost::move_detail::identity<T>::type&& t)
         {  return t;   }
         ...
         inline T&& forward(U&& t
             , typename ::hexerboost::move_detail::enable_if_c<
