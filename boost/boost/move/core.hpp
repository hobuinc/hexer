...
#include <boost/move/detail/config_begin.hpp>
   ...
   template <class T>
   class rv
      : public ::hexerboost::move_detail::if_c
         < ::hexerboost::move_detail::is_class_or_union<T>::value
         , T
         , ::hexerboost::move_detail::empty
         >::type
   {
      rv();
      ~rv();
   ...
   template <class T>
   struct is_rv
      : ::hexerboost::move_detail::integral_constant<bool, false>
   {};
   ...
   struct has_move_emulation_enabled
      : ::hexerboost::move_detail::is_convertible< T, ::hexerboost::rv<T>& >
   {};
   ...
   template<class T>
   struct has_move_emulation_enabled< ::hexerboost::rv<T> >
      : ::hexerboost::move_detail::integral_constant<bool, false>
   {};
   ...
   #define BOOST_RV_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      ::hexerboost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_RV_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      ::hexerboost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      const ::hexerboost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_COPY_ASSIGN_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      const ::hexerboost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   #define BOOST_COPYABLE_AND_MOVABLE(TYPE)\
      ...
      {  this->operator=(static_cast<const ::hexerboost::rv<TYPE> &>(const_cast<const TYPE &>(t))); return *this;}\
      public:\
      operator ::hexerboost::rv<TYPE>&() \
      {  return *static_cast< ::hexerboost::rv<TYPE>* >(this);  }\
      operator const ::hexerboost::rv<TYPE>&() const \
