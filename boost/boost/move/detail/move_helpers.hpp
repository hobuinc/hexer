...
#define BOOST_MOVE_CATCH_CONST(U)  \
   typename ::hexerboost::mpl::if_< ::hexerboost::is_class<U>, BOOST_CATCH_CONST_RLVALUE(U), const U &>::type
#define BOOST_MOVE_CATCH_RVALUE(U)\
   typename ::hexerboost::mpl::if_< ::hexerboost::is_class<U>, BOOST_RV_REF(U), not_a_type>::type
...
\
   ...
   {  return FWD_FUNCTION(::hexerboost::move(x));  }\
\
...
\
   ...
   typename ::hexerboost::enable_if_c\
                     <  ::hexerboost::is_class<TYPE>::value &&\
                        ::hexerboost::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>::value &&\
                       !::hexerboost::has_move_emulation_enabled<BOOST_MOVE_TEMPL_PARAM>::value\
                     , RETURN_VALUE >::type\
...
\
   template<class BOOST_MOVE_TEMPL_PARAM>\
   typename ::hexerboost::enable_if_c\
                     < (!::hexerboost::is_class<BOOST_MOVE_TEMPL_PARAM>::value || \
                        !::hexerboost::move_detail::is_rv<BOOST_MOVE_TEMPL_PARAM>::value) && \
                       !::hexerboost::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>::value \
                     , RETURN_VALUE >::type\
   PUB_FUNCTION(const BOOST_MOVE_TEMPL_PARAM &u)\
   {\
      TYPE t(u);\
      return FWD_FUNCTION(::hexerboost::move(t));\
   }\
//
...
\
   ...
   {  return FWD_FUNCTION(arg1, ::hexerboost::move(x));  }\
\
...
\
   ...
   {\
      TYPE t(u);\
      return FWD_FUNCTION(arg1, ::hexerboost::move(t));\
   }\
//
