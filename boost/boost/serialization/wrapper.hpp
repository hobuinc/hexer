...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace serialization {
...
struct is_wrapper_impl :
    hexerboost::mpl::eval_if<
      hexerboost::is_base_and_derived<basic_traits,T>,
      hexerboost::mpl::true_,
...
template<>                                              \
struct is_wrapper_impl<const T> : hexerboost::mpl::true_ {}; \
}                                                       \
}                                                       \
/**/
