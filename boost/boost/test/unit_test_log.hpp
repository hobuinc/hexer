...
#define BOOST_TEST_LOG_ENTRY( ll )                                                  \
    (::hexerboost::unit_test::unit_test_log                                              \
        << ::hexerboost::unit_test::log::begin( BOOST_TEST_L(__FILE__), __LINE__ ))(ll)  \
/**/
...
#define BOOST_TEST_MESSAGE( M )                                 \
    BOOST_TEST_LOG_ENTRY( ::hexerboost::unit_test::log_messages )    \
    << (::hexerboost::unit_test::lazy_ostream::instance() << M)      \
/**/

//____________________________________________________________________________//

#define BOOST_TEST_PASSPOINT()                                  \
    ::hexerboost::unit_test::unit_test_log.set_checkpoint(           \
...
#define BOOST_TEST_CHECKPOINT( M )                              \
    ::hexerboost::unit_test::unit_test_log.set_checkpoint(           \
        BOOST_TEST_L(__FILE__),                                 \
        static_cast<std::size_t>(__LINE__),                     \
        (::hexerboost::wrap_stringstream().ref() << M).str() )       \
/**/
