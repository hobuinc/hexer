...
hexerboost::unit_test::make_test_case( hexerboost::unit_test::callback0<>(test_function), BOOST_TEST_STRINGIZE( test_function ) )
#define BOOST_CLASS_TEST_CASE( test_function, tc_instance ) \
hexerboost::unit_test::make_test_case((test_function), BOOST_TEST_STRINGIZE( test_function ), tc_instance )
...
( new hexerboost::unit_test::test_suite( testsuite_name ) )
...
: hexerboost::unit_test::ut_detail::                                         \
...
BOOST_AUTO_TU_REGISTRAR( test_name )(                                   \
    hexerboost::unit_test::make_test_case(                                   \
        &BOOST_AUTO_TC_INVOKER( test_name ), #test_name ),              \
    hexerboost::unit_test::ut_detail::auto_tc_exp_fail<                      \
...
struct BOOST_AUTO_TC_INVOKER( test_name ) {                             \
    ...
    static void run( hexerboost::type<TestType>* = 0 )                       \
    {                                                                   \
        ...
        t.test_method();                                                \
                                                                        ...
                                                                        \
BOOST_AUTO_TU_REGISTRAR( test_name )(                                   \
    hexerboost::unit_test::ut_detail::template_test_case_gen<                \
...
#define BOOST_TEST_CASE_TEMPLATE( name, typelist )                          \
    hexerboost::unit_test::ut_detail::template_test_case_gen<name,typelist >(    \
...
template<typename type_name>                                    \
void BOOST_JOIN( name, _impl )( hexerboost::type<type_name>* );      \
                                                                \
struct name {                                                   \
    template<typename TestType>                                 \
    static void run( hexerboost::type<TestType>* frwrd = 0 )         \
    {                                                           \
...
static hexerboost::unit_test::ut_detail::global_fixture_impl<F> BOOST_JOIN( gf_, F ) ; \
/**/
...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace unit_test { namespace ut_detail {
...
typedef ::hexerboost::unit_test::ut_detail::nil_t BOOST_AUTO_TEST_CASE_FIXTURE;
...
static hexerboost::unit_test::ut_detail::auto_test_unit_registrar BOOST_JOIN( BOOST_JOIN( test_name, _registrar ), __LINE__ )
...
bool init_unit_test()                   {
#else
::hexerboost::unit_test::test_suite*
init_unit_test_suite( int, char* [] )   {
#endif

#ifdef BOOST_TEST_MODULE
    using namespace ::hexerboost::unit_test;
