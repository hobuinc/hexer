...
#  define BOOST_LIB_NAME hexerboost_unit_test_framework
...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace unit_test {
...
{
    return ::hexerboost::unit_test::unit_test_main( &init_unit_test, argc, argv );
}
