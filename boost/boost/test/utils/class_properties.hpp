...
public:
    ...
    // access methods
    arrow_res_t     operator->() const      { return hexerboost::addressof( base_prop::value ); }
};
...
#define BOOST_READONLY_PROPERTY( property_type, friends ) hexerboost::unit_test::readwrite_property<property_type >
...
: public hexerboost::unit_test::readonly_property<property_type > {                      \
    typedef hexerboost::unit_test::readonly_property<property_type > base_prop;          \
...
public:
    ...
    arrow_res_t     operator->()            { return hexerboost::addressof( base_prop::value ); }
    const_arrow_res_t operator->() const    { return hexerboost::addressof( base_prop::value ); }
