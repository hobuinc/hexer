...
struct default_value_interpreter {
    template<typename T>
    void operator()( argv_traverser& tr, hexerboost::optional<T>& value )
    {
...
// !! private?
    ...
    unit_test::callback2<parser const&,hexerboost::optional<T>&>     m_value_generator;
    unit_test::callback2<argv_traverser&,hexerboost::optional<T>&>   m_value_interpreter;
};
