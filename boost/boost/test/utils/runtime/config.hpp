...
#include <boost/test/utils/basic_cstring/io.hpp> // operator<<(hexerboost::runtime::cstring)
...
#define BOOST_RT_PARAM_PUTENV ::hexerboost::BOOST_RT_PARAM_NAMESPACE::putenv_impl
