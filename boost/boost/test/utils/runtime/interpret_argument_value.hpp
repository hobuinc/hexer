...
struct interpret_argument_value_impl {
    static bool _( cstring source, hexerboost::optional<T>& res )
    {
...
struct interpret_argument_value_impl<cstring> {
    static bool _( cstring source, hexerboost::optional<cstring>& res )
    {
...
template<typename T>
inline bool
interpret_argument_value( cstring source, hexerboost::optional<T>& res, long )
{
