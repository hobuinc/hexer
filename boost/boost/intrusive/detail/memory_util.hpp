...
#define BOOST_INTRUSIVE_INSTANTIATE_DEFAULT_TYPE_TMPLT(TNAME)              \
   ...
   {                                                                       \
      ...
      static char test(int, typename X::TNAME*);                           \
                                                                           \
      template <typename X>                                                \
      static int test(hexerboost::intrusive::detail::                           \
      ...
      static const bool value = (1 == sizeof(test<T>(0, 0)));              \
                                                                           \
      typedef typename                                                     \
         ::hexerboost::intrusive::detail::if_c                                  \
   ...
   {                                                                       \
      ...
      static const bool value = (1 == sizeof(test<T>(0, 0)));              \
                                                                           \
      typedef typename                                                     \
         ::hexerboost::intrusive::detail::eval_if_c                             \
            < value                                                        \
            , ::hexerboost::intrusive::detail::identity<T>                      \
            , ::hexerboost::intrusive::detail::identity<DefaultWrap>            \
            >::type::TNAME type;                                           \
   };                                                                      \
//
...
}}}   //namespace hexerboost::intrusive::detail

#include <boost/intrusive/detail/has_member_function_callable_with.hpp>

#define BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME pointer_to
#define BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_BEGIN namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace intrusive { namespace detail {
...
struct type_has_rebind
{
   ...
   template <typename X>
   static int test(hexerboost::intrusive::detail::LowPriorityConversion<int>, void*);
