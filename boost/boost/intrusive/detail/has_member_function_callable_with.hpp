...
// sample.h
   ...
   #define BOOST_INTRUSIVE_DETAIL_HAS_MEMBER_FUNCTION_CALLABLE_WITH_DETAILS_INCLUDED
      ...
      namespace hexerboost_intrusive_has_member_function_callable_with {
   ...
   #error "BOOST_PP_ITERATION_START() must be zero (0)"
      ...
      class BOOST_PP_CAT(has_member_function_named_, BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME)
      {
         ...
         struct Base : public ::hexerboost::intrusive::detail::remove_cv<Type>::type, public BaseMixin { Base(); };
         template <typename T, T t> class Helper{};

         template <typename U>
         static hexerboost_intrusive_has_member_function_callable_with::no_type  deduce
            (U*, Helper<void (BaseMixin::*)(), &U::BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME>* = 0);
         static hexerboost_intrusive_has_member_function_callable_with::yes_type deduce(...);

         public:
         static const bool value =
            sizeof(hexerboost_intrusive_has_member_function_callable_with::yes_type) == sizeof(deduce((Base*)(0)));
      };
         ...
         //!
            ...
            template< class F
                  , std::size_t N =
                        sizeof((hexerboost::move_detail::declval<F>().
            ...
            {
               hexerboost_intrusive_has_member_function_callable_with::yes_type dummy;
            ...
            {
               hexerboost_intrusive_has_member_function_callable_with::no_type dummy;
               BOOST_PP_CAT(zeroarg_checker_, BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME)(int);
            };
               ...
               <Fun, true BOOST_PP_ENUM_TRAILING(BOOST_PP_SUB(BOOST_PP_ITERATION_FINISH(), BOOST_PP_ITERATION()), BOOST_INTRUSIVE_PP_IDENTITY, void)>
            {
               ...
               template <class U>
               static hexerboost_intrusive_has_member_function_callable_with::no_type Test(...);

               static const bool value = sizeof(Test< Fun >(0))
                                    == sizeof(hexerboost_intrusive_has_member_function_callable_with::yes_type);
            };
            ...
            {
               template<class U>
               static decltype( hexerboost::move_detail::declval<Fun>().BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME()
                              , hexerboost_intrusive_has_member_function_callable_with::yes_type())
                  Test(Fun*);
            ...
            : Fun
         {
            ...
            hexerboost_intrusive_has_member_function_callable_with::private_type
            ...
            <Fun, true , Args...>
         {
            ...
            {
               typedef hexerboost_intrusive_has_member_function_callable_with::dont_care type;
            };
            ...
            static bool const value = (sizeof(hexerboost_intrusive_has_member_function_callable_with::no_type) ==
                                       sizeof(hexerboost_intrusive_has_member_function_callable_with::is_private_type
                                                ( (::hexerboost::move_detail::declval< FunWrap >().
                                          BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME
                                             ( ::hexerboost::move_detail::declval<Args>()... ), 0) )
                                             )
                                       );
         };
      ...
      BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_END
            ...
            : Fun
         {
            ...
            hexerboost_intrusive_has_member_function_callable_with::private_type
               BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME
                  ...
                  , hexerboost_intrusive_has_member_function_callable_with::dont_care))  const;
         };
                                  ...
                                  , void)>
         {
            ...
            (sizeof(hexerboost_intrusive_has_member_function_callable_with::no_type) ==
               sizeof(hexerboost_intrusive_has_member_function_callable_with::is_private_type
                        (  (hexerboost::move_detail::declval<FunWrap>().
                              BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME
