         ...
         >
{
   ...
   {
      return hexerboost::intrusive::detail::to_raw_pointer(this->get_real_value_traits()->to_value_ptr
   ...
   void increment()
   {
      const Container *cont =  hexerboost::intrusive::detail::to_raw_pointer(cont_);
      bucket_type* buckets = hexerboost::intrusive::detail::to_raw_pointer(cont->bucket_pointer());
