...
inline typename hexerboost::intrusive::pointer_traits<Pointer>::element_type*
to_raw_pointer(const Pointer &p)
{  return hexerboost::intrusive::detail::to_raw_pointer(p.operator->());  }
...
struct constptr
{
   typedef typename hexerboost::intrusive::pointer_traits<VoidPointer>::
   ...
   const void *get_ptr() const
   {  return hexerboost::intrusive::detail::to_raw_pointer(const_void_ptr_);  }
...
struct member_hook_traits
{
   ...
   static pointer to_value_ptr(const node_ptr & n)
   {
      return pointer_traits<pointer>::pointer_to
         (*detail::parent_from_member<T, Hook>
            (static_cast<Hook*>(hexerboost::intrusive::detail::to_raw_pointer(n)), P));
   }
   ...
   static const_pointer to_value_ptr(const const_node_ptr & n)
   {
      return pointer_traits<const_pointer>::pointer_to
         (*detail::parent_from_member<T, Hook>
            (static_cast<const Hook*>(hexerboost::intrusive::detail::to_raw_pointer(n)), P));
   }
};
...
struct function_hook_traits
{
   ...
   static node_ptr to_node_ptr(reference value)
   {  return static_cast<node*>(hexerboost::intrusive::detail::to_raw_pointer(Functor::to_hook_ptr(value)));  }

   static const_node_ptr to_node_ptr(const_reference value)
   {  return static_cast<const node*>(hexerboost::intrusive::detail::to_raw_pointer(Functor::to_hook_ptr(value)));  }
...
inline float fast_log2 (float val)
{
   union caster_t
   {
      hexerboost::uint32_t x;
      float val;
   } caster;

   caster.val = val;
   hexerboost::uint32_t x = caster.x;
...
{
   static const hexerboost::uint32_t value = 0xb504f334;
...
{
   static const hexerboost::uint64_t value = 0xb504f333f9de6484ull;
