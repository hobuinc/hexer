...
struct get_slist_impl
{
   ...
   struct type : make_slist
      ...
      , hexerboost::intrusive::value_traits<trivial_traits>
      , hexerboost::intrusive::constant_time_size<false>
	  , hexerboost::intrusive::size_type<typename hexerboost::make_unsigned
      ...
      , typename Config::size_type>
{
   ...
   bucket_plus_size(BOOST_FWD_REF(BucketTraits) b_traits)
      :  bucket_traits_(::hexerboost::forward<BucketTraits>(b_traits))
   {}
   ...
   : public detail::ebo_functor_holder<typename Config::hash> //hash
{
   ...
   bucket_hash_t(BOOST_FWD_REF(BucketTraits) b_traits, const hasher & h)
      :  detail::ebo_functor_holder<hasher>(h), bucket_plus_size_(::hexerboost::forward<BucketTraits>(b_traits))
   {}
   ...
   : public detail::ebo_functor_holder<typename Config::equal>
{
   ...
   bucket_hash_equal_t(BOOST_FWD_REF(BucketTraits) b_traits, const hasher & h, const equal &e)
      ...
      , bucket_hash(::hexerboost::forward<BucketTraits>(b_traits), h)
   {}
...
struct hashtable_data_t : public Config::value_traits
{
   ...
   hashtable_data_t( BOOST_FWD_REF(BucketTraits) b_traits, const hasher & h
      ...
      , internal_(::hexerboost::forward<BucketTraits>(b_traits), h, e)
   {}
         ...
         , typename Config::size_type>
   {
      ...
      internal(BOOST_FWD_REF(BucketTraits) b_traits, const hasher & h, const equal &e)
         :  bucket_hash_equal_(::hexerboost::forward<BucketTraits>(b_traits), h, e)
      {}
   ...
   :  private detail::clear_on_destructor_base<hashtable_impl<Config> >
{
   ...
   hashtable_impl(BOOST_RV_REF(hashtable_impl) x)
      : data_( ::hexerboost::move(x.priv_bucket_traits())
             , ::hexerboost::move(x.priv_hasher())
             , ::hexerboost::move(x.priv_equal())
             , ::hexerboost::move(x.priv_value_traits())
             )
   {
   ...
   bool empty() const
   {
      if(constant_time_size){
         ...
         const bucket_type *b = hexerboost::intrusive::detail::to_raw_pointer(this->priv_bucket_pointer());
         ...
         >::type
{
   ...
   {  this->Base::operator=(::hexerboost::move(static_cast<Base&>(x))); return *this;  }
};
