   ...
   :  private detail::clear_on_destructor_base<rbtree_impl<Config> >
{
   ...
   typedef hexerboost::intrusive::detail::reverse_iterator<iterator>      reverse_iterator;
   typedef hexerboost::intrusive::detail::reverse_iterator<const_iterator>const_reverse_iterator;
   ...
   rbtree_impl(BOOST_RV_REF(rbtree_impl) x)
      : data_(::hexerboost::move(x.priv_comp()), ::hexerboost::move(x.priv_value_traits()))
   {
      node_algorithms::init_header(this->priv_header_ptr());
      this->priv_size_traits().set_size(size_type(0));
      this->swap(x);
   ...
   static rbtree_impl &priv_container_from_end_iterator(const const_iterator &end_iterator)
   {
      header_plus_size *r = detail::parent_from_member<header_plus_size, node>
         ( hexerboost::intrusive::detail::to_raw_pointer(end_iterator.pointed_node()), &header_plus_size::header_);
