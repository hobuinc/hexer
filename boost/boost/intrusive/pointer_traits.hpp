...
struct pointer_traits
{
      ...
      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_EVAL_DEFAULT
         ( hexerboost::intrusive::detail::, Ptr, element_type
         , hexerboost::intrusive::detail::first_param<Ptr>)                        element_type;
      //
      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT
         (hexerboost::intrusive::detail::, Ptr, difference_type, std::ptrdiff_t)   difference_type;
      //
      typedef typename hexerboost::intrusive::detail::unvoid<element_type>::type&  reference;
      //
      template <class U> struct rebind_pointer
      {
         typedef typename hexerboost::intrusive::detail::type_rebinder<Ptr, U>::type  type;
      };

      #if !defined(BOOST_NO_CXX11_TEMPLATE_ALIASES)
         template <class U> using rebind = typename hexerboost::intrusive::detail::type_rebinder<Ptr, U>::type;
      #endif
   ...
   static pointer pointer_to(reference r)
   {
      ...
      const bool value = hexerboost::intrusive::detail::
         has_member_function_callable_with_pointer_to
            <Ptr, typename hexerboost::intrusive::detail::unvoid<element_type &>::type>::value;
   ...
   //priv_pointer_to
   static pointer priv_pointer_to(hexerboost::true_type, typename hexerboost::intrusive::detail::unvoid<element_type>::type& r)
      { return Ptr::pointer_to(r); }

   static pointer priv_pointer_to(hexerboost::false_type, typename hexerboost::intrusive::detail::unvoid<element_type>::type& r)
      { return pointer(hexerboost::intrusive::detail::addressof(r)); }

   //priv_static_cast_from
   template<class UPtr>
   static pointer priv_static_cast_from(hexerboost::true_type, const UPtr &uptr)
   { return Ptr::static_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_static_cast_from(hexerboost::false_type, const UPtr &uptr)
   {  return pointer_to(*static_cast<element_type*>(to_raw_pointer(uptr)));  }

   //priv_const_cast_from
   template<class UPtr>
   static pointer priv_const_cast_from(hexerboost::true_type, const UPtr &uptr)
   { return Ptr::const_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_const_cast_from(hexerboost::false_type, const UPtr &uptr)
   {  return pointer_to(const_cast<element_type&>(*uptr));  }

   //priv_dynamic_cast_from
   template<class UPtr>
   static pointer priv_dynamic_cast_from(hexerboost::true_type, const UPtr &uptr)
   { return Ptr::dynamic_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_dynamic_cast_from(hexerboost::false_type, const UPtr &uptr)
...
struct pointer_traits<T*>
{
   ...
   //!
   static pointer pointer_to(reference r)
   { return hexerboost::intrusive::detail::addressof(r); }
