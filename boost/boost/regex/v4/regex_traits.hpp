...
struct default_wrapper : public BaseT
{
   ...
   std::string error_string(::hexerboost::regex_constants::error_type e)const
   {
      return ::hexerboost::re_detail::get_default_error_string(e);
   }
   ::hexerboost::regex_constants::syntax_type syntax_type(char_type c)const
   {
      return ((c & 0x7f) == c) ? get_default_syntax_type(static_cast<char>(c)) : ::hexerboost::regex_constants::syntax_char;
   }
   ::hexerboost::regex_constants::escape_syntax_type escape_syntax_type(char_type c)const
   {
      return ((c & 0x7f) == c) ? get_default_escape_syntax_type(static_cast<char>(c)) : ::hexerboost::regex_constants::escape_type_identity;
   }
...
struct regex_traits_wrapper 
   : public ::hexerboost::re_detail::compute_wrapper_base<
               BaseT, 
               ::hexerboost::re_detail::has_boost_extensions_tag<BaseT>::value
            >::type
{
