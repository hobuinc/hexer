...
namespace regex_constants{
   ...
   enum flag_type_
   {
      ...
      no_except = ::hexerboost::regbase::no_except,
      failbit = ::hexerboost::regbase::failbit,
      literal = ::hexerboost::regbase::literal,
      icase = ::hexerboost::regbase::icase,
      nocollate = ::hexerboost::regbase::nocollate,
      collate = ::hexerboost::regbase::collate,
      nosubs = ::hexerboost::regbase::nosubs,
      optimize = ::hexerboost::regbase::optimize,
      bk_plus_qm = ::hexerboost::regbase::bk_plus_qm,
      bk_vbar = ::hexerboost::regbase::bk_vbar,
      no_intervals = ::hexerboost::regbase::no_intervals,
      no_char_classes = ::hexerboost::regbase::no_char_classes,
      no_escape_in_lists = ::hexerboost::regbase::no_escape_in_lists,
      no_mod_m = ::hexerboost::regbase::no_mod_m,
      mod_x = ::hexerboost::regbase::mod_x,
      mod_s = ::hexerboost::regbase::mod_s,
      no_mod_s = ::hexerboost::regbase::no_mod_s,
      save_subexpression_location = ::hexerboost::regbase::save_subexpression_location,
      no_empty_expressions = ::hexerboost::regbase::no_empty_expressions,

      basic = ::hexerboost::regbase::basic,
      extended = ::hexerboost::regbase::extended,
      normal = ::hexerboost::regbase::normal,
      emacs = ::hexerboost::regbase::emacs,
      awk = ::hexerboost::regbase::awk,
      grep = ::hexerboost::regbase::grep,
      egrep = ::hexerboost::regbase::egrep,
      sed = basic,
      perl = normal,
      ECMAScript = normal,
      JavaScript = normal,
   ...
   typedef ::hexerboost::regbase::flag_type syntax_option_type;
