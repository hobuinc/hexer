...
struct sub_match : public std::pair<BidiIterator, BidiIterator>
{
   ...
   {
      difference_type n = matched ? ::hexerboost::re_detail::distance((BidiIterator)this->first, (BidiIterator)this->second) : 0;
      return n;
   }
   std::basic_string<value_type> str()const
   {
      ...
      if(matched)
      {
         std::size_t len = ::hexerboost::re_detail::distance((BidiIterator)this->first, (BidiIterator)this->second);
         result.reserve(len);
...
private:
   mutable hexerboost::scoped_ptr<capture_sequence_type> m_captures;
public:
