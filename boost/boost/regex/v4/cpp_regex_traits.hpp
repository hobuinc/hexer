...
{
   typedef typename hexerboost::int_t<sizeof(way) * CHAR_BIT>::least cast_type;
...
void cpp_regex_traits_implementation<charT>::init()
{
   ...
   if((int)cat >= 0)
   {
      ...
      static const char_class_type masks[16] = 
      {
         ::hexerboost::re_detail::char_class_alnum,
         ::hexerboost::re_detail::char_class_alpha,
         ::hexerboost::re_detail::char_class_cntrl,
         ::hexerboost::re_detail::char_class_digit,
         ::hexerboost::re_detail::char_class_graph,
         ::hexerboost::re_detail::char_class_horizontal_space,
         ::hexerboost::re_detail::char_class_lower,
         ::hexerboost::re_detail::char_class_print,
         ::hexerboost::re_detail::char_class_punct,
         ::hexerboost::re_detail::char_class_space,
         ::hexerboost::re_detail::char_class_upper,
         ::hexerboost::re_detail::char_class_vertical_space,
         ::hexerboost::re_detail::char_class_xdigit,
         ::hexerboost::re_detail::char_class_blank,
         ::hexerboost::re_detail::char_class_word,
         ::hexerboost::re_detail::char_class_unicode,
      };
#endif
   ...
   cpp_regex_traits_implementation<charT>::lookup_classname_imp(const charT* p1, const charT* p2) const
{
   ...
   static const char_class_type masks[22] = 
   {
      ...
      ::hexerboost::re_detail::char_class_upper,
      ::hexerboost::re_detail::char_class_vertical_space,
      ::hexerboost::re_detail::char_class_alnum | ::hexerboost::re_detail::char_class_word, 
      ::hexerboost::re_detail::char_class_alnum | ::hexerboost::re_detail::char_class_word, 
      ::hexerboost::re_detail::char_class_xdigit,
   };
#endif
...
{
   return
      ((mask & ::hexerboost::re_detail::char_class_space) && (this->m_pctype->is(std::ctype<charT>::space, c)))
      || ((mask & ::hexerboost::re_detail::char_class_print) && (this->m_pctype->is(std::ctype<charT>::print, c)))
      || ((mask & ::hexerboost::re_detail::char_class_cntrl) && (this->m_pctype->is(std::ctype<charT>::cntrl, c)))
      || ((mask & ::hexerboost::re_detail::char_class_upper) && (this->m_pctype->is(std::ctype<charT>::upper, c)))
      || ((mask & ::hexerboost::re_detail::char_class_lower) && (this->m_pctype->is(std::ctype<charT>::lower, c)))
      || ((mask & ::hexerboost::re_detail::char_class_alpha) && (this->m_pctype->is(std::ctype<charT>::alpha, c)))
      || ((mask & ::hexerboost::re_detail::char_class_digit) && (this->m_pctype->is(std::ctype<charT>::digit, c)))
      || ((mask & ::hexerboost::re_detail::char_class_punct) && (this->m_pctype->is(std::ctype<charT>::punct, c)))
      || ((mask & ::hexerboost::re_detail::char_class_xdigit) && (this->m_pctype->is(std::ctype<charT>::xdigit, c)))
      || ((mask & ::hexerboost::re_detail::char_class_blank) && (this->m_pctype->is(std::ctype<charT>::space, c)) && !::hexerboost::re_detail::is_separator(c))
      || ((mask & ::hexerboost::re_detail::char_class_word) && (c == '_'))
      || ((mask & ::hexerboost::re_detail::char_class_unicode) && ::hexerboost::re_detail::is_extended(c))
      || ((mask & ::hexerboost::re_detail::char_class_vertical_space) && (is_separator(c) || (c == '\v')))
      || ((mask & ::hexerboost::re_detail::char_class_horizontal_space) && this->m_pctype->is(std::ctype<charT>::space, c) && !(is_separator(c) || (c == '\v')));
}
#endif


template <class charT>
inline hexerboost::shared_ptr<const cpp_regex_traits_implementation<charT> > create_cpp_regex_traits(const std::locale& l BOOST_APPEND_EXPLICIT_TEMPLATE_TYPE(charT))
{
   cpp_regex_traits_base<charT> key(l);
   return ::hexerboost::object_cache<cpp_regex_traits_base<charT>, cpp_regex_traits_implementation<charT> >::get(key, 5);
}
...
private:
   hexerboost::shared_ptr<const re_detail::cpp_regex_traits_implementation<charT> > m_pimpl;
   //
