...
void perl_matcher<BidiIterator, Allocator, traits>::estimate_max_state_count(std::random_access_iterator_tag*)
{
   ...
   std::ptrdiff_t dist = hexerboost::re_detail::distance(base, last);
   if(dist == 0)
      dist = 1;
...
{
   ::hexerboost::re_detail::concrete_protected_call
...
#pragma warning(disable:4127)
   ...
   {
      std::ptrdiff_t maxlen = ::hexerboost::re_detail::distance(backstop, position);
