...
//
typedef ::hexerboost::uint32_t lcid_type;   // placeholder for LCID.
typedef ::hexerboost::shared_ptr<void> cat_type; // placeholder for dll HANDLE.
...
#endif
BOOST_REGEX_DECL bool BOOST_REGEX_CALL w32_is(lcid_type, hexerboost::uint32_t mask, char c);
#ifndef BOOST_NO_WREGEX
BOOST_REGEX_DECL bool BOOST_REGEX_CALL w32_is(lcid_type, hexerboost::uint32_t mask, wchar_t c);
#ifdef BOOST_REGEX_HAS_OTHER_WCHAR_T
BOOST_REGEX_DECL bool BOOST_REGEX_CALL w32_is(lcid_type state_id, hexerboost::uint32_t m, unsigned short c);
#endif
#endif
//
...
public:
   ...
   regex_constants::escape_syntax_type escape_syntax_type(charT c) const
   {
      ...
      if(i == m_char_map.end())
      {
         if(::hexerboost::re_detail::w32_is_lower(c, this->m_locale)) return regex_constants::escape_type_class;
         if(::hexerboost::re_detail::w32_is_upper(c, this->m_locale)) return regex_constants::escape_type_not_class;
         return 0;
      }
      return i->second;
   }
   ...
   {
      return ::hexerboost::re_detail::w32_tolower(c, this->m_locale);
   }
   bool isctype(hexerboost::uint32_t mask, charT c)const
   {
      return ::hexerboost::re_detail::w32_is(this->m_locale, mask, c);
   }
...
template <class charT>
w32_regex_traits_char_layer<charT>::w32_regex_traits_char_layer(::hexerboost::re_detail::lcid_type l) 
   : w32_regex_traits_base<charT>(l)
{
   ...
   if(cat_name.size())
   {
      cat = ::hexerboost::re_detail::w32_cat_open(cat_name);
      if(!cat)
      {
         std::string m("Unable to open message catalog: ");
         std::runtime_error err(m + cat_name);
         hexerboost::re_detail::raise_runtime_error(err);
      }
   }
   //
   ...
   if(cat)
   {
      ...
      {
         string_type mss = ::hexerboost::re_detail::w32_cat_get(cat, this->m_locale, i, get_default_message(i));
...
public:
   w32_regex_traits_char_layer(::hexerboost::re_detail::lcid_type l)
   ...
   bool isctype(hexerboost::uint32_t mask, char c)const
   {
...
private:
   ...
   hexerboost::uint16_t m_type_map[1u << CHAR_BIT];
   void init();
};
...
public:
   ...
   w32_regex_traits_implementation(::hexerboost::re_detail::lcid_type l);
   ...
   {
      return ::hexerboost::re_detail::w32_transform(this->m_locale, p1, p2);
   }
private:
...
template <class charT>
w32_regex_traits_implementation<charT>::w32_regex_traits_implementation(::hexerboost::re_detail::lcid_type l)
: w32_regex_traits_char_layer<charT>(l)
{
   ...
   if(cat)
   {
      ...
      // Error messages:
      //
      for(hexerboost::regex_constants::error_type i = static_cast<hexerboost::regex_constants::error_type>(0); 
         i <= hexerboost::regex_constants::error_unknown; 
         i = static_cast<hexerboost::regex_constants::error_type>(i + 1))
      {
         ...
         string_type s = ::hexerboost::re_detail::w32_cat_get(cat, this->m_locale, i+200, default_message);
         std::string result;
      ...
      {
         string_type s(::hexerboost::re_detail::w32_cat_get(cat, this->m_locale, j+300, null_string));
         if(s.size())
...
template <class charT>
hexerboost::shared_ptr<const w32_regex_traits_implementation<charT> > create_w32_regex_traits(::hexerboost::re_detail::lcid_type l BOOST_APPEND_EXPLICIT_TEMPLATE_TYPE(charT))
{
   // TODO: create a cache for previously constructed objects.
   return hexerboost::object_cache< ::hexerboost::re_detail::lcid_type, w32_regex_traits_implementation<charT> >::get(l, 5);
}
...
public:
   ...
   typedef ::hexerboost::re_detail::lcid_type locale_type;
   typedef hexerboost::uint_least32_t         char_class_type;

   struct boost_extensions_tag{};

   w32_regex_traits()
      : m_pimpl(re_detail::create_w32_regex_traits<charT>(::hexerboost::re_detail::w32_get_default_locale()))
   { }
   ...
   {
      return ::hexerboost::re_detail::w32_toupper(c, this->m_pimpl->m_locale);
   }
   string_type transform(const charT* p1, const charT* p2) const
   {
      return ::hexerboost::re_detail::w32_transform(this->m_pimpl->m_locale, p1, p2);
   }
   string_type transform_primary(const charT* p1, const charT* p2) const
   {
   ...
   bool isctype(charT c, char_class_type f) const
   {
      if((f & re_detail::w32_regex_traits_implementation<charT>::mask_base) 
         ...
         && (::hexerboost::re_detail::is_separator(c) || (c == '\v')))
         return true;
   ...
   {
      return ::hexerboost::re_detail::global_toi(p1, p2, radix, *this);
   }
   int value(charT c, int radix)const
   {
      int result = ::hexerboost::re_detail::global_value(c);
      return result < radix ? result : -1;
   }
   locale_type imbue(locale_type l)
   {
      ::hexerboost::re_detail::lcid_type result(getloc());
...
private:
   hexerboost::shared_ptr<const re_detail::w32_regex_traits_implementation<charT> > m_pimpl;
   //
