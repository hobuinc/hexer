...
// because hexerboost::call_once doesn't alow us to pass instance information
...
public:
   typedef scoped_static_mutex_lock scoped_lock;
   static void init();
   static hexerboost::recursive_mutex* m_pmutex;
   static hexerboost::once_flag m_once;
};
...
public:
   ...
   void unlock();
private:
   hexerboost::recursive_mutex::scoped_lock* m_plock;
   bool m_have_lock;
};
