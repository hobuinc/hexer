...
// ... except in C++0x, move disables the implicit copy
    ...
    shared_array( shared_array<Y> const & r, typename hexerboost::detail::sp_enable_if_convertible< Y[], T[] >::type = hexerboost::detail::sp_empty() )
...
#include <boost/smart_ptr/detail/operator_bool.hpp>
    ...
    void * _internal_get_deleter( hexerboost::detail::sp_typeinfo const & ti ) const
    {
...
template<class T> inline bool operator==( shared_array<T> const & p, hexerboost::detail::sp_nullptr_t ) BOOST_NOEXCEPT
{
    return p.get() == 0;
}

template<class T> inline bool operator==( hexerboost::detail::sp_nullptr_t, shared_array<T> const & p ) BOOST_NOEXCEPT
{
    return p.get() == 0;
}
