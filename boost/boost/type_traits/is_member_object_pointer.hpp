...
struct is_member_object_pointer_impl
{
   BOOST_STATIC_CONSTANT(
      bool, value = (::hexerboost::type_traits::ice_and<
         ::hexerboost::is_member_pointer<T>::value,
         ::hexerboost::type_traits::ice_not<
            ::hexerboost::is_member_function_pointer<T>::value
         >::value
      >::value ));
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_member_object_pointer,T,::hexerboost::detail::is_member_object_pointer_impl<T>::value)
