...
namespace type_traits_detail {
    ...
    {
       typedef typename hexerboost::type_traits_detail::add_rvalue_reference_helper
                  <T, (is_void<T>::value == false && is_reference<T>::value == false) >::type type;
    };

}

BOOST_TT_AUX_TYPE_TRAIT_DEF1(add_rvalue_reference,T,typename hexerboost::type_traits_detail::add_rvalue_reference_imp<T>::type)
