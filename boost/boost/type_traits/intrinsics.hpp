...
#   endif
#   define BOOST_IS_POD(T) ::hexerboost::is_same< typename ::__type_traits<T>::is_POD_type, ::__true_type>::value
#   define BOOST_HAS_TRIVIAL_CONSTRUCTOR(T) ::hexerboost::is_same< typename ::__type_traits<T>::has_trivial_default_constructor, ::__true_type>::value
#   define BOOST_HAS_TRIVIAL_COPY(T) ::hexerboost::is_same< typename ::__type_traits<T>::has_trivial_copy_constructor, ::__true_type>::value
#   define BOOST_HAS_TRIVIAL_ASSIGN(T) ::hexerboost::is_same< typename ::__type_traits<T>::has_trivial_assignment_operator, ::__true_type>::value
#   define BOOST_HAS_TRIVIAL_DESTRUCTOR(T) ::hexerboost::is_same< typename ::__type_traits<T>::has_trivial_destructor, ::__true_type>::value
...
#   define BOOST_HAS_TRIVIAL_COPY(T) (__has_trivial_copy(T)|| ( ::hexerboost::is_pod<T>::value && !::hexerboost::is_volatile<T>::value))
#   define BOOST_HAS_TRIVIAL_ASSIGN(T) (__has_trivial_assign(T) || ( ::hexerboost::is_pod<T>::value && ! ::hexerboost::is_const<T>::value && !::hexerboost::is_volatile<T>::value))
#   define BOOST_HAS_TRIVIAL_DESTRUCTOR(T) (__has_trivial_destructor(T) || ::hexerboost::is_pod<T>::value)
#   define BOOST_HAS_NOTHROW_CONSTRUCTOR(T) (__has_nothrow_constructor(T) || ::hexerboost::has_trivial_constructor<T>::value)
#   define BOOST_HAS_NOTHROW_COPY(T) (__has_nothrow_copy(T) || ::hexerboost::has_trivial_copy<T>::value)
#   define BOOST_HAS_NOTHROW_ASSIGN(T) (__has_nothrow_assign(T) || ::hexerboost::has_trivial_assign<T>::value)
...
#     define BOOST_IS_CONVERTIBLE(T,U) (__is_convertible_to(T,U) && !::hexerboost::is_abstract<U>::value)
#   endif
...
#   define BOOST_IS_POD(T) __is_pod(T)
#   define BOOST_IS_EMPTY(T) __is_empty(T)
#   define BOOST_HAS_TRIVIAL_CONSTRUCTOR(T) ((__has_trivial_constructor(T) BOOST_INTEL_TT_OPTS) && ! ::hexerboost::is_volatile<T>::value)
#   define BOOST_HAS_TRIVIAL_COPY(T) ((__has_trivial_copy(T) BOOST_INTEL_TT_OPTS) && !is_reference<T>::value && ! ::hexerboost::is_volatile<T>::value)
#   define BOOST_HAS_TRIVIAL_ASSIGN(T) ((__has_trivial_assign(T) BOOST_INTEL_TT_OPTS) && ! ::hexerboost::is_volatile<T>::value && ! ::hexerboost::is_const<T>::value)
