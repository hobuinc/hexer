...
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral, ::hexerboost::ulong_long_type,true)
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral, ::hexerboost::long_long_type,true)
...
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral,hexerboost::int128_type,true)
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral,hexerboost::uint128_type,true)
#endif
