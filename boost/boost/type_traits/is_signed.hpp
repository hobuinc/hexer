...
{
   typedef typename remove_cv<T>::type no_cv_t;
   BOOST_STATIC_CONSTANT(bool, value = (!(::hexerboost::detail::is_signed_values<T>::minus_one  > hexerboost::detail::is_signed_values<T>::zero)));
};
...
#else
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_signed,T,::hexerboost::detail::is_signed_imp<T>::value)
#endif
