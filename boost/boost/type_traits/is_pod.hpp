...
{ 
    BOOST_STATIC_CONSTANT(
        ...
        (::hexerboost::type_traits::ice_or<
            ::hexerboost::is_scalar<T>::value,
            ::hexerboost::is_void<T>::value,
...
{
    typedef ::hexerboost::type_traits::no_type type;
};

template <>
struct bool_to_yes_no_type<true>
{
    typedef ::hexerboost::type_traits::yes_type type;
};

template <typename ArrayType>
struct is_pod_array_helper
{
    enum { is_pod = ::hexerboost::is_POD<ArrayType>::value }; // MSVC workaround
...
struct is_pod_helper<true>
{
    template <typename T> struct result_
    {
        ...
        BOOST_STATIC_CONSTANT(bool, value =
            sizeof(is_POD_array(help()).instance()) == sizeof(::hexerboost::type_traits::yes_type)
            );
    };
};
...
{ 
   BOOST_STATIC_CONSTANT(
       bool, value = (
           ::hexerboost::detail::is_pod_helper<
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_POD,T,::hexerboost::detail::is_pod_impl<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_pod,T,::hexerboost::detail::is_pod_impl<T>::value)
