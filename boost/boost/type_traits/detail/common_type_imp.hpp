 ...
 *
 * struct hexerboost::common_type<T,U>
 *
...
{
    typedef hexerboost::mpl::vector8<
...
struct common_type_impl
    : public common_type_dispatch_on_rvalueness<T,U, sizeof( ::hexerboost::detail_type_traits_common_type::rvalue_test(
