...
#else
   BOOST_STATIC_CONSTANT(bool, value = ::hexerboost::has_trivial_copy<T>::value);
#endif
};

}

BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_nothrow_copy,T,::hexerboost::detail::has_nothrow_copy_imp<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_nothrow_copy_constructor,T,::hexerboost::detail::has_nothrow_copy_imp<T>::value)
