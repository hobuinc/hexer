...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_copy,T,::hexerboost::detail::has_trivial_copy_impl<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_copy_constructor,T,::hexerboost::detail::has_trivial_copy_impl<T>::value)
