...
struct alignment_of_impl
{
    ...
    BOOST_STATIC_CONSTANT(std::size_t, value =
        (::hexerboost::detail::alignment_logic<
            sizeof(::hexerboost::detail::alignment_of_hack<T>) - sizeof(T),
            __alignof(T)
        >::value));
...
BOOST_TT_AUX_SIZE_T_TRAIT_DEF1(alignment_of,T,::hexerboost::detail::alignment_of_impl<T>::value)
