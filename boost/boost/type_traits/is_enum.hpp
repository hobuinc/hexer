...
# else
    template <class U> static ::hexerboost::type_traits::yes_type is_class_or_union_tester(void(U::*)(void));

#  if BOOST_WORKAROUND(BOOST_MSVC, == 1300)                 \
    || BOOST_WORKAROUND(__MWERKS__, <= 0x3000) // no SFINAE
    static ::hexerboost::type_traits::no_type is_class_or_union_tester(...);
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_class_or_union_tester(0)) == sizeof(::hexerboost::type_traits::yes_type));
#  else
    template <class U>
    static ::hexerboost::type_traits::no_type is_class_or_union_tester(...);
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_class_or_union_tester<T>(0)) == sizeof(::hexerboost::type_traits::yes_type));
#  endif
# endif
};
#endif
...
{
    template <typename T> struct type
       : public ::hexerboost::is_convertible<typename hexerboost::add_reference<T>::type,::hexerboost::detail::int_convertible>
    {
    };
};
...
{
   //typedef ::hexerboost::add_reference<T> ar_t;
   ...
   BOOST_STATIC_CONSTANT(bool, selector =
      (::hexerboost::type_traits::ice_or<
           ::hexerboost::is_arithmetic<T>::value
         , ::hexerboost::is_reference<T>::value
         , ::hexerboost::is_function<T>::value
   ...
   BOOST_STATIC_CONSTANT(bool, selector =
    ...
    typedef ::hexerboost::detail::is_enum_helper<
          ::hexerboost::detail::is_enum_impl<T>::selector
        > se_t;
#else
    typedef ::hexerboost::detail::is_enum_helper<selector> se_t;
#endif
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_enum,T,::hexerboost::detail::is_enum_impl<T>::value)
