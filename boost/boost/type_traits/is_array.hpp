...
{ 
    BOOST_STATIC_CONSTANT(bool, value = 
        sizeof(::hexerboost::detail::is_array_tester2(
            ::hexerboost::detail::is_array_tester1(
                ::hexerboost::type_traits::wrap<T>()
                )
        )) == 1
    );
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_array,T,::hexerboost::detail::is_array_impl<T>::value)
