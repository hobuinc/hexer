...
{
   BOOST_STATIC_CONSTANT(std::size_t, value = (::hexerboost::detail::extent_imp<T, N-1>::value));
};
...
struct extent
   : public ::hexerboost::integral_constant<std::size_t, ::hexerboost::detail::extent_imp<T,N>::value>
{
#if BOOST_WORKAROUND(BOOST_MSVC, < 1300) 
   typedef ::hexerboost::integral_constant<std::size_t, ::hexerboost::detail::extent_imp<T,N>::value> base_; 
   using base_::value;
#endif
