...
{
   BOOST_STATIC_CONSTANT(bool, value = (::hexerboost::detail::is_unsigned_values<T>::minus_one > ::hexerboost::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned_imp
{
   typedef is_ununsigned_select_helper< 
      ::hexerboost::type_traits::ice_or<
         ...
         ::hexerboost::is_enum<T>::value>::value 
   > selector;
...
#else
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_unsigned,T,::hexerboost::detail::is_unsigned_imp<T>::value)
#endif
