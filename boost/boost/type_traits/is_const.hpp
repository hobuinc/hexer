...
{
#if BOOST_WORKAROUND(BOOST_MSVC, < 1400)
   BOOST_STATIC_CONSTANT(bool, value = ::hexerboost::detail::cv_traits_imp<typename hexerboost::remove_bounds<T>::type*>::is_const);
#else
   BOOST_STATIC_CONSTANT(bool, value = ::hexerboost::detail::cv_traits_imp<T*>::is_const);
#endif
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_const,T,::hexerboost::detail::is_const_rvalue_filter<T>::value)
...
BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_const,T const,!(::hexerboost::is_reference<T>::value))
BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_const,T volatile const,!(::hexerboost::is_reference<T>::value))
#endif
...
struct is_const_helper
    : public ::hexerboost::type_traits::false_result
{
};
...
struct is_const_helper<false,false>
{
    template <typename T> struct result_
    {
        ...
        BOOST_STATIC_CONSTANT(bool, value = (
            sizeof(hexerboost::detail::yes_type) == sizeof(hexerboost::detail::is_const_tester(t))
            ));
    };
};
...
//* is a type T  declared const - is_const<T>
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_const,T,::hexerboost::detail::is_const_impl<T>::value)
