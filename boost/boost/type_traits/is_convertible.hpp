...
using ::hexerboost::type_traits::yes_type;
using ::hexerboost::type_traits::no_type;
...
struct does_conversion_exist<void>
{
    template< typename To > struct result_
    {
        enum { value = ::hexerboost::is_void<To>::value };
    };
};
...
#pragma option push -w-8074
    ...
    {
        static ::hexerboost::type_traits::no_type BOOST_TT_DECL _m_check(...);
        static ::hexerboost::type_traits::yes_type BOOST_TT_DECL _m_check(T);
    };

    static typename add_lvalue_reference<From>::type  _m_from;
    static bool const value = sizeof( checker<To>::_m_check(_m_from) )
        == sizeof(::hexerboost::type_traits::yes_type);
#pragma option pop
};
...
template <typename T> struct checker
{
    static hexerboost::type_traits::no_type _m_check(any_conversion ...);
    static hexerboost::type_traits::yes_type _m_check(T, int);
};
...
struct is_convertible_basic_impl
{
    ...
    static bool const value =
        sizeof( hexerboost::detail::checker<To>::_m_check(static_cast<rvalue_type>(_m_from), 0) )
        == sizeof(::hexerboost::type_traits::yes_type);
#else
    static bool const value =
        sizeof( hexerboost::detail::checker<To>::_m_check(_m_from, 0) )
        == sizeof(::hexerboost::type_traits::yes_type);
#endif
};
...
struct is_convertible_basic_impl
{
    static ::hexerboost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion ...);
    static ::hexerboost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type; 
    static lvalue_type _m_from;
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0) ) == sizeof(::hexerboost::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from, 0) ) == sizeof(::hexerboost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl
{
    ...
    template <class T>
    static ::hexerboost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion,  float, T);
    static ::hexerboost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    enum { value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0, 0) ) == sizeof(::hexerboost::type_traits::yes_type)
        };
#else
    enum { value =
        sizeof( _m_check(_m_from, 0, 0) ) == sizeof(::hexerboost::type_traits::yes_type)
        };
#endif
};
...
{
    static ::hexerboost::type_traits::no_type BOOST_TT_DECL _m_check(...);
    static ::hexerboost::type_traits::yes_type BOOST_TT_DECL _m_check(To);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from)) ) == sizeof(::hexerboost::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from) ) == sizeof(::hexerboost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl:
  is_convertible_basic_impl_aux<
    From,To,
    ::hexerboost::is_function<typename ::hexerboost::remove_reference<From>::type>::value
  >
{};
    ...
    enum { value =
        (::hexerboost::type_traits::ice_and<
            ::hexerboost::type_traits::ice_or<
               ::hexerboost::detail::is_convertible_basic_impl<From,To>::value,
               ::hexerboost::is_void<To>::value
            >::value,
            ::hexerboost::type_traits::ice_not<
               ::hexerboost::is_array<To>::value
            >::value,
            ::hexerboost::type_traits::ice_not<
               ::hexerboost::is_function<To>::value
            >::value
        >::value) };
};
...
struct is_convertible_impl_dispatch_base
{
   ...
   typedef is_convertible_impl_select< 
      ::hexerboost::is_arithmetic<From>::value, 
      ::hexerboost::is_arithmetic<To>::value,
#ifndef BOOST_NO_IS_ABSTRACT
      ::hexerboost::is_abstract<To>::value
#else
      false
#endif
   > selector;
...
BOOST_TT_AUX_BOOL_TRAIT_DEF2(is_convertible,From,To,(::hexerboost::detail::is_convertible_impl_dispatch<From,To>::value))
