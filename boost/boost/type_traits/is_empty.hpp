    ...
    BOOST_STATIC_CONSTANT(
        bool, value = (
            ::hexerboost::type_traits::ice_or<
              ::hexerboost::detail::empty_helper<cvt,::hexerboost::is_class<T>::value>::value
...
struct is_empty_impl
{
   ...
   BOOST_STATIC_CONSTANT(
       bool, value = (
           ::hexerboost::type_traits::ice_or<
              ::hexerboost::detail::empty_helper<
                  cvt
                , ::hexerboost::is_class<T>::value
                , ::hexerboost::is_convertible< r_type,int>::value
              >::value
              , BOOST_INTERNAL_IS_EMPTY(cvt)
           >::value));
};
...
struct is_empty_impl
{
   typedef ::hexerboost::detail::empty_helper_chooser<
      ::hexerboost::type_traits::ice_and<
         ::hexerboost::type_traits::ice_not< ::hexerboost::is_reference<T>::value >::value,
         ::hexerboost::type_traits::ice_not< ::hexerboost::is_convertible<T,double>::value >::value,
         ::hexerboost::type_traits::ice_not< ::hexerboost::is_pointer<T>::value >::value,
         ::hexerboost::type_traits::ice_not< ::hexerboost::is_member_pointer<T>::value >::value,
         ...
         ::hexerboost::type_traits::ice_not<
            ::hexerboost::is_convertible<T,void const volatile*>::value
            >::value
      >::value > chooser;
   ...
   BOOST_STATIC_CONSTANT(bool, value =
      (::hexerboost::type_traits::ice_or<eh_type::value, BOOST_INTERNAL_IS_EMPTY(T)>::value));
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_empty,T,::hexerboost::detail::is_empty_impl<T>::value)
