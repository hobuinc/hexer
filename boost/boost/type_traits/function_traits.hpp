...
struct function_traits : 
  public hexerboost::detail::function_traits_helper<typename hexerboost::add_pointer<Function>::type>
{
};
...
struct function_traits
{
  BOOST_STATIC_CONSTANT(unsigned, arity = (sizeof(hexerboost::detail::function_arity_helper((Function*)0))-1));
};
