...
*/
    ...
    public:
        ...
        corpusIter operator () ( corpusIter corpus_first, corpusIter corpus_last ) const {
            BOOST_STATIC_ASSERT (( hexerboost::is_same<
        ...
        typename hexerboost::range_iterator<Range>::type operator () ( Range &r ) const {
            return (*this) (hexerboost::begin(r), hexerboost::end(r));
            }
...
///
    ...
    {
        typedef typename hexerboost::range_iterator<const PatternRange>::type pattern_iterator;
        boyer_moore_horspool<pattern_iterator> bmh ( hexerboost::begin(pattern), hexerboost::end (pattern));
        return bmh ( corpus_first, corpus_last );
    }
    
    template <typename patIter, typename CorpusRange>
    typename hexerboost::lazy_disable_if_c<
        hexerboost::is_same<CorpusRange, patIter>::value, typename hexerboost::range_iterator<CorpusRange> >
    ::type
    boyer_moore_horspool_search ( CorpusRange &corpus, patIter pat_first, patIter pat_last )
    {
        boyer_moore_horspool<patIter> bmh ( pat_first, pat_last );
        return bm (hexerboost::begin (corpus), hexerboost::end (corpus));
    }
    
    template <typename PatternRange, typename CorpusRange>
    typename hexerboost::range_iterator<CorpusRange>::type
    boyer_moore_horspool_search ( CorpusRange &corpus, const PatternRange &pattern )
    {
        typedef typename hexerboost::range_iterator<const PatternRange>::type pattern_iterator;
        boyer_moore_horspool<pattern_iterator> bmh ( hexerboost::begin(pattern), hexerboost::end (pattern));
        return bmh (hexerboost::begin (corpus), hexerboost::end (corpus));
    }


    //  Creator functions -- take a pattern range, return an object
    template <typename Range>
    hexerboost::algorithm::boyer_moore_horspool<typename hexerboost::range_iterator<const Range>::type>
    make_boyer_moore_horspool ( const Range &r ) {
        return hexerboost::algorithm::boyer_moore_horspool
            <typename hexerboost::range_iterator<const Range>::type> (hexerboost::begin(r), hexerboost::end(r));
        }
    
    template <typename Range>
    hexerboost::algorithm::boyer_moore_horspool<typename hexerboost::range_iterator<Range>::type>
    make_boyer_moore_horspool ( Range &r ) {
        return hexerboost::algorithm::boyer_moore_horspool
            <typename hexerboost::range_iterator<Range>::type> (hexerboost::begin(r), hexerboost::end(r));
        }
