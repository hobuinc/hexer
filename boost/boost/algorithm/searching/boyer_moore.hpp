...
///
        ...
        corpusIter corpus_first, corpusIter corpus_last, const PatternRange &pattern )
    {
        ...
        boyer_moore<pattern_iterator> bm ( hexerboost::begin(pattern), hexerboost::end (pattern));
        return bm ( corpus_first, corpus_last );
    }
    ...
    template <typename Range>
    hexerboost::algorithm::boyer_moore<typename hexerboost::range_iterator<const Range>::type>
    make_boyer_moore ( const Range &r ) {
        return hexerboost::algorithm::boyer_moore
            <typename hexerboost::range_iterator<const Range>::type> (hexerboost::begin(r), hexerboost::end(r));
        }
    
    template <typename Range>
    hexerboost::algorithm::boyer_moore<typename hexerboost::range_iterator<Range>::type>
