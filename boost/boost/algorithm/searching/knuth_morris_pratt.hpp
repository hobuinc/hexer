...
///
        ...
        corpusIter corpus_first, corpusIter corpus_last, const PatternRange &pattern )
    {
        ...
        knuth_morris_pratt<pattern_iterator> kmp ( hexerboost::begin(pattern), hexerboost::end (pattern));
        return kmp ( corpus_first, corpus_last );
    }
    ...
    {
        knuth_morris_pratt<patIter> kmp ( pat_first, pat_last );
        return kmp (hexerboost::begin (corpus), hexerboost::end (corpus));
    }
    ...
    template <typename Range>
    hexerboost::algorithm::knuth_morris_pratt<typename hexerboost::range_iterator<const Range>::type>
    make_knuth_morris_pratt ( const Range &r ) {
        return hexerboost::algorithm::knuth_morris_pratt
            <typename hexerboost::range_iterator<const Range>::type> (hexerboost::begin(r), hexerboost::end(r));
        }
    
    template <typename Range>
    hexerboost::algorithm::knuth_morris_pratt<typename hexerboost::range_iterator<Range>::type>
