...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace algorithm { namespace detail {
...
//  Special case small numeric values; use an array
    ...
    private:
        typedef typename hexerboost::make_unsigned<key_type>::type unsigned_key_type;
        typedef hexerboost::array<value_type, 1U << (CHAR_BIT * sizeof(key_type))> skip_map;
        skip_map skip_;
        const value_type k_default_value;
    public:
    ...
    struct BM_traits {
        ...
        typedef hexerboost::algorithm::detail::skip_table<key_type, value_type, 
                hexerboost::is_integral<key_type>::value && (sizeof(key_type)==1)> skip_table_t;
        };
