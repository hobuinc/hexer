...
#include <boost/utility/enable_if.hpp> // for hexerboost::disable_if

namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace algorithm {

/// \fn clamp ( T const& val, 
///               typename hexerboost::mpl::identity<T>::type const& lo, 
///               typename hexerboost::mpl::identity<T>::type const& hi, Pred p )
...
/// \fn clamp ( T const& val, 
///               typename hexerboost::mpl::identity<T>::type const& lo, 
///               typename hexerboost::mpl::identity<T>::type const& hi )
/// \return the value "val" brought into the range [ lo, hi ].
...
///       typename std::iterator_traits<typename hexerboost::range_iterator<const Range>::type>::value_type lo,
///       typename std::iterator_traits<typename hexerboost::range_iterator<const Range>::type>::value_type hi )
/// \return clamp the sequence of values [first, last) into [ lo, hi ]
/// 
...
///
  ...
  typename hexerboost::disable_if_c<hexerboost::is_same<Range, OutputIterator>::value, OutputIterator>::type
  clamp_range ( const Range &r, OutputIterator out,
    typename std::iterator_traits<typename hexerboost::range_iterator<const Range>::type>::value_type lo, 
    typename std::iterator_traits<typename hexerboost::range_iterator<const Range>::type>::value_type hi )
  {
    return clamp_range ( hexerboost::begin ( r ), hexerboost::end ( r ), out, lo, hi );
  } 
...
//  In that case, the user will get the two iterator version.
  ...
  clamp_range ( const Range &r, OutputIterator out,
    ...
    Pred p )
  {
    return clamp_range ( hexerboost::begin ( r ), hexerboost::end ( r ), out, lo, hi, p );
  } 
