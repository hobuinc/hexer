...
{
    return hexerboost::algorithm::none_of (hexerboost::begin (r), hexerboost::end (r), p );
} 
...
{
    return hexerboost::algorithm::none_of_equal (hexerboost::begin (r), hexerboost::end (r), val);
} 
