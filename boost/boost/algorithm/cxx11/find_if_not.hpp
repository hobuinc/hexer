...
typename hexerboost::range_iterator<const Range>::type find_if_not ( const Range &r, Predicate p )
{
    return hexerboost::algorithm::find_if_not (hexerboost::begin (r), hexerboost::end(r), p);
}
