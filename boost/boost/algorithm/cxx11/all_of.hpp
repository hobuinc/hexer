...
{
    return hexerboost::algorithm::all_of ( hexerboost::begin (r), hexerboost::end (r), p );
} 
...
{
    return hexerboost::algorithm::all_of_equal ( hexerboost::begin (r), hexerboost::end (r), val );
} 
