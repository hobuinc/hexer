...
{
    return hexerboost::algorithm::copy_if (hexerboost::begin (r), hexerboost::end(r), result, p);
}
...
{
    return hexerboost::algorithm::copy_while (hexerboost::begin (r), hexerboost::end(r), result, p);
}
...
{
    return hexerboost::algorithm::copy_until (hexerboost::begin (r), hexerboost::end(r), result, p);
}
