...
//  and ForwardIterator2::value_type could be different? Define my own comparison predicate?
    return hexerboost::algorithm::is_permutation ( first, last, first2,
...
{
    return hexerboost::algorithm::is_permutation (hexerboost::begin (r), hexerboost::end (r), first2 );
}
...
typename hexerboost::disable_if_c<hexerboost::is_same<Range, ForwardIterator>::value, bool>::type
is_permutation ( const Range &r, ForwardIterator first2, BinaryPredicate pred )
{
    return hexerboost::algorithm::is_permutation (hexerboost::begin (r), hexerboost::end (r), first2, pred );
}
