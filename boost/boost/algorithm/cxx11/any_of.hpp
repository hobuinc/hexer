...
{
    return hexerboost::algorithm::any_of (hexerboost::begin (r), hexerboost::end (r), p);
} 
...
{
    return hexerboost::algorithm::any_of_equal (hexerboost::begin (r), hexerboost::end (r), val);
}
