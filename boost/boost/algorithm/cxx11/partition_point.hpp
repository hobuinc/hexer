...
typename hexerboost::range_iterator<Range> partition_point ( Range &r, Predicate p )
{
    return hexerboost::algorithm::partition_point (hexerboost::begin(r), hexerboost::end(r), p);
}
