...
///
    ...
    ForwardIterator is_sorted_until ( ForwardIterator first, ForwardIterator last )
    {
        ...
        return hexerboost::algorithm::is_sorted_until ( first, last, std::less<value_type>());
    }
...
///
    ...
    {
        return hexerboost::algorithm::is_sorted_until (first, last, p) == last;
    }
...
///
    ...
    {
        return hexerboost::algorithm::is_sorted_until (first, last) == last;
    }
#endif
...
///
    ...
    typename hexerboost::lazy_disable_if_c<
        hexerboost::is_same<R, Pred>::value, 
        typename hexerboost::range_iterator<const R> 
    >::type is_sorted_until ( const R &range, Pred p )
    {
        return hexerboost::algorithm::is_sorted_until ( hexerboost::begin ( range ), hexerboost::end ( range ), p );
    }
...
///
    template <typename R>
    typename hexerboost::range_iterator<const R>::type is_sorted_until ( const R &range )
    {
        return hexerboost::algorithm::is_sorted_until ( hexerboost::begin ( range ), hexerboost::end ( range ));
    }
...
///
    template <typename R, typename Pred>
    typename hexerboost::lazy_disable_if_c< hexerboost::is_same<R, Pred>::value, hexerboost::mpl::identity<bool> >::type
    is_sorted ( const R &range, Pred p )
    {
        return hexerboost::algorithm::is_sorted ( hexerboost::begin ( range ), hexerboost::end ( range ), p );
    }
...
///
    ...
    {
        return hexerboost::algorithm::is_sorted ( hexerboost::begin ( range ), hexerboost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_strictly_increasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return hexerboost::algorithm::is_sorted (first, last, std::less<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_strictly_increasing instead.
    ...
    {
        return is_increasing ( hexerboost::begin ( range ), hexerboost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_strictly_decreasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return hexerboost::algorithm::is_sorted (first, last, std::greater<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_strictly_decreasing instead.
    ...
    {
        return is_decreasing ( hexerboost::begin ( range ), hexerboost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_increasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return hexerboost::algorithm::is_sorted (first, last, std::less_equal<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_increasing instead.
    ...
    {
        return is_strictly_increasing ( hexerboost::begin ( range ), hexerboost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_decreasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return hexerboost::algorithm::is_sorted (first, last, std::greater_equal<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_decreasing instead.
    ...
    {
        return is_strictly_decreasing ( hexerboost::begin ( range ), hexerboost::end ( range ));
    }
