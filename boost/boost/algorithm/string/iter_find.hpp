...
//  iterate find ---------------------------------------------------//
        ...
        /*!
            ...
            \param Result A 'container container' to contain the result of search.
                ...
                Typical type of the result is 
                    \c std::vector<hexerboost::iterator_range<iterator>>
        ...
        */
            ...
            FinderT Finder )
        {
            ...
            input_iterator_type InputEnd=::hexerboost::end(lit_input);

            typedef transform_iterator<copy_range_type, find_iterator_type>
                transform_iter_type;
    
            transform_iter_type itBegin=
                ::hexerboost::make_transform_iterator( 
                    find_iterator_type( ::hexerboost::begin(lit_input), InputEnd, Finder ),
                    copy_range_type());
