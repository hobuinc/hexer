        ...
        public:
            ...
            */
            ...
            find_iterator(
                ...
                detail::find_iterator_base<IteratorT>(Finder,0)
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::hexerboost::as_literal(Col));
                m_Match=::hexerboost::make_iterator_range(::hexerboost::begin(lit_col), ::hexerboost::begin(lit_col));
                m_End=::hexerboost::end(lit_col);
        ...
        */
        ...
        public:
            ...
            */
            ...
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::hexerboost::as_literal(Col));
                m_Match=make_iterator_range(::hexerboost::begin(lit_col), ::hexerboost::begin(lit_col));
                m_Next=::hexerboost::begin(lit_col);
                m_End=::hexerboost::end(lit_col);
