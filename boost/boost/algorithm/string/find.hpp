...
//  Generic find -----------------------------------------------//
        ...
        */
            ...
            const FinderT& Finder)
        {
            ...
            return Finder(::hexerboost::begin(lit_input),::hexerboost::end(lit_input));
        }
...
//  find_first  -----------------------------------------------//
        ...
        */
        ...
        {
            return ::hexerboost::algorithm::find(Input, ::hexerboost::algorithm::first_finder(Search));
        }
        ...
        */
        ...
        {
            return ::hexerboost::algorithm::find(Input, ::hexerboost::algorithm::first_finder(Search,is_iequal(Loc)));
        }
...
//  find_last  -----------------------------------------------//
        ...
        */
        ...
        find_last( 
            ...
            const Range2T& Search)
        {
            return ::hexerboost::algorithm::find(Input, ::hexerboost::algorithm::last_finder(Search));
        }
        ...
        */
        ...
        ifind_last( 
            ...
            const std::locale& Loc=std::locale())
        {
            return ::hexerboost::algorithm::find(Input, ::hexerboost::algorithm::last_finder(Search, is_iequal(Loc)));
        }
...
//  find_nth ----------------------------------------------------------------------//
        ...
        */
        ...
        find_nth( 
            ...
            int Nth)
        {
            return ::hexerboost::algorithm::find(Input, ::hexerboost::algorithm::nth_finder(Search,Nth));
        }
        ...
        */
        ...
        ifind_nth( 
            ...
            const std::locale& Loc=std::locale())
        {
            return ::hexerboost::algorithm::find(Input, ::hexerboost::algorithm::nth_finder(Search,Nth,is_iequal(Loc)));
        }
...
//  find_head ----------------------------------------------------------------------//
        ...
        */
        ...
        find_head( 
            ...
            int N)
        {
            return ::hexerboost::algorithm::find(Input, ::hexerboost::algorithm::head_finder(N));
        }
...
//  find_tail ----------------------------------------------------------------------//
        ...
        */
        ...
        find_tail( 
            ...
            int N)
        {
            return ::hexerboost::algorithm::find(Input, ::hexerboost::algorithm::tail_finder(N));
        }
...
//  find_token --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::hexerboost::algorithm::find(Input, ::hexerboost::algorithm::token_finder(Pred, eCompress));
        }
