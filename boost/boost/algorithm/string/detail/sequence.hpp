...
//  insert helpers  -------------------------------------------------//
            ...
            {
                ::hexerboost::algorithm::detail::insert( Input, At, ::hexerboost::begin(Insert), ::hexerboost::end(Insert) );
            }
...
//  replace helper  -------------------------------------------------//
                ...
                const InsertT& Insert )
            {
                if(From!=To)
                {
                    ::hexerboost::algorithm::detail::replace( Input, From, To, ::hexerboost::begin(Insert), ::hexerboost::end(Insert) );
                }
                else
                {
                    ::hexerboost::algorithm::detail::insert( Input, From, ::hexerboost::begin(Insert), ::hexerboost::end(Insert) );
                }
            }
