...
//  find_regex  -----------------------------------------------//
        ...
        */
        ...
        {
            iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_input(::hexerboost::as_literal(Input));

            return ::hexerboost::algorithm::regex_finder(Rx,Flags)(
                ::hexerboost::begin(lit_input), ::hexerboost::end(lit_input) );
        }
...
//  replace_regex --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::hexerboost::algorithm::find_format_copy( 
                Output,
                Input,
                ::hexerboost::algorithm::regex_finder( Rx, Flags ),
                ::hexerboost::algorithm::regex_formatter( Format, Flags ) );
        }
        ...
        */
        ...
        inline void replace_regex( 
            ...
            match_flag_type Flags=match_default | format_default )
        {
            ::hexerboost::algorithm::find_format( 
                Input,
                ::hexerboost::algorithm::regex_finder( Rx, Flags ),
                ::hexerboost::algorithm::regex_formatter( Format, Flags ) );
        }
...
//  replace_all_regex --------------------------------------------------------------------//
        ...
        */
        ...
        inline OutputIteratorT replace_all_regex_copy(
            ...
            match_flag_type Flags=match_default | format_default )
        {
            return ::hexerboost::algorithm::find_format_all_copy( 
                Output,
                Input,
                ::hexerboost::algorithm::regex_finder( Rx, Flags ),
                ::hexerboost::algorithm::regex_formatter( Format, Flags ) );
        ...
        */
        ...
        inline void replace_all_regex( 
            ...
            match_flag_type Flags=match_default | format_default )
        {
            ::hexerboost::algorithm::find_format_all( 
                Input,
                ::hexerboost::algorithm::regex_finder( Rx, Flags ),
                ::hexerboost::algorithm::regex_formatter( Format, Flags ) );
        }
       ...
       */
            ...
            match_flag_type Flags=match_default )
        {
            return ::hexerboost::algorithm::find_format_copy(
                ...
                Input,
                ::hexerboost::algorithm::regex_finder( Rx, Flags ),
                ::hexerboost::algorithm::empty_formatter( Input ) );
        }
...
//  find_all_regex ------------------------------------------------------------------//
        ...
        /*!
            ...
            or \c std::list<hexerboost::iterator_range<std::string::iterator>>
        ...
        */
        ...
        inline SequenceSequenceT& find_all_regex(
            ...
            match_flag_type Flags=match_default )
        {
            return ::hexerboost::algorithm::iter_find(
                Result,
                Input,
                ::hexerboost::algorithm::regex_finder(Rx,Flags) );         
        }
...
//  split_regex ------------------------------------------------------------------//
        ...
        */
        ...
        inline SequenceSequenceT& split_regex(
            ...
            match_flag_type Flags=match_default )
        {
            return ::hexerboost::algorithm::iter_split(
                Result,
                Input,
                ::hexerboost::algorithm::regex_finder(Rx,Flags) );         
        }
...
//  join_if ------------------------------------------------------------------//
        ...
        */
            ...
            match_flag_type Flags=match_default )
        {
            ...
            // Parse input
            InputIteratorT itBegin=::hexerboost::begin(Input);
            InputIteratorT itEnd=::hexerboost::end(Input);
            ...
            while(
                itBegin!=itEnd && 
                !::hexerboost::regex_match(::hexerboost::begin(*itBegin), ::hexerboost::end(*itBegin), Rx, Flags)) ++itBegin;

            // Add this element
            if(itBegin!=itEnd)
            {
                detail::insert(Result, ::hexerboost::end(Result), *itBegin);
                ++itBegin;
            }

            for(;itBegin!=itEnd; ++itBegin)
            {
                if(::hexerboost::regex_match(::hexerboost::begin(*itBegin), ::hexerboost::end(*itBegin), Rx, Flags))
                {
                    // Add separator
                    detail::insert(Result, ::hexerboost::end(Result), ::hexerboost::as_literal(Separator));
                    // Add element
                    detail::insert(Result, ::hexerboost::end(Result), *itBegin);
                }
            }
