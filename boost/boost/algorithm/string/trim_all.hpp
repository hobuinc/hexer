...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost {
    namespace algorithm {
        ...
        inline SequenceT trim_all_copy_if(const SequenceT& Input, PredicateT IsSpace)
        {
            return 
                ::hexerboost::find_format_all_copy(      
                    ::hexerboost::trim_copy_if(Input, IsSpace),
                    ::hexerboost::token_finder(IsSpace, ::hexerboost::token_compress_on),
                    ::hexerboost::dissect_formatter(::hexerboost::head_finder(1)));
        }
        ...
        */
        ...
        {
            ::hexerboost::trim_if(Input, IsSpace);
        ...
        */
        ...
        {
            return trim_all_copy_if(Input, ::hexerboost::is_space(Loc));
        }
        ...
        */
        ...
        {
            trim_all_if(Input, ::hexerboost::is_space(Loc));
        }
        ...
        inline SequenceT trim_fill_copy_if(const SequenceT& Input, const RangeT& Fill, PredicateT IsSpace)
        {
            return 
                ::hexerboost::find_format_all_copy(      
                    ::hexerboost::trim_copy_if(Input, IsSpace),
                    ::hexerboost::token_finder(IsSpace, ::hexerboost::token_compress_on),
                    ::hexerboost::const_formatter(::hexerboost::as_literal(Fill)));
        }
        ...
        */
        ...
        {
            return trim_fill_copy_if(Input, Fill, ::hexerboost::is_space(Loc));
        }
        ...
        */
        ...
        {
            trim_fill_if(Input, Fill, ::hexerboost::is_space(Loc));
        }
