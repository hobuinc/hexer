...
namespace hexerboost {} namespace boost = hexerboost; namespace
hexerboost
    {
    class exception_ptr;
    ...
    exception_ptr
        {
        typedef hexerboost::shared_ptr<exception_detail::clone_base const> impl;
        impl ptr_;
...
# endif
    ...
    exception_detail
        ...
        current_exception_std_exception_wrapper:
            ...
            current_exception_std_exception_wrapper( T const & e1, hexerboost::exception const & e2 ):
                T(e1),
                hexerboost::exception(e2)
                {
                add_original_type(e1);
                }
        ...
        get_boost_exception( T const * x )
            {
            return dynamic_cast<hexerboost::exception const *>(x);
            }
#endif
        ...
        current_exception_std_exception( T const & e1 )
            {
            if( hexerboost::exception const * e2 = get_boost_exception(&e1) )
                return hexerboost::copy_exception(current_exception_std_exception_wrapper<T>(e1,*e2));
            else
                return hexerboost::copy_exception(current_exception_std_exception_wrapper<T>(e1));
            }
        ...
        current_exception_unknown_exception()
            {
            return hexerboost::copy_exception(unknown_exception());
            }

        inline
        exception_ptr
        current_exception_unknown_boost_exception( hexerboost::exception const & e )
            {
            return hexerboost::copy_exception(unknown_exception(e));
            }
        ...
        current_exception_unknown_std_exception( std::exception const & e )
            {
            if( hexerboost::exception const * be = get_boost_exception(&e) )
