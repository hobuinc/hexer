...
namespace aux {
  ...
  template< typename T1, hexerboost::intmax_t n1, bool n1_is_0
                  , typename T2, hexerboost::intmax_t n2, bool n2_is_0 >
      struct gcd_aux
          : gcd_aux<T2, n2, n2==0, T1, (n1 % n2), (n1 % n2)==0>
      {};

      template <typename T1, hexerboost::intmax_t n1, typename T2, hexerboost::intmax_t n2>
      struct gcd_aux<T1, n1, false, T2, n2, true> : integral_c<T1, n1>
      {};

      template <typename T1, hexerboost::intmax_t n1, typename T2, hexerboost::intmax_t n2, bool C>
