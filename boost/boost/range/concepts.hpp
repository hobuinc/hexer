...
// during the search for black listed compilers.
    ...
    #define BOOST_RANGE_CONCEPT_ASSERT( x )
        ...
        // use case is the combination of the hexerboost::adaptors::filtered
        // class with a hexerboost::lambda::bind generated functor.
            ...
            , EqualityComparable<Iterator>
        {
            ...
            {
                Iterator i2(++i);
                hexerboost::ignore_unused_variable_warning(i2);
                ...
                BOOST_DEDUCED_TYPENAME hexerboost::detail::iterator_traits<Iterator>::reference r1(*i);
                hexerboost::ignore_unused_variable_warning(r1);

                BOOST_DEDUCED_TYPENAME hexerboost::detail::iterator_traits<Iterator>::reference r2(*(++i));
                hexerboost::ignore_unused_variable_warning(r2);
            }
        private:
            Iterator i;
#endif
        ...
        {
#if BOOST_RANGE_ENABLE_CONCEPT_ASSERT
            typedef BOOST_DEDUCED_TYPENAME hexerboost::detail::iterator_traits<Iterator>::difference_type difference_type;
            ...
            BOOST_CONCEPT_USAGE(ForwardIteratorConcept)
            {
                ...
                Iterator i2(i++);
                hexerboost::ignore_unused_variable_warning(i2);
                BOOST_DEDUCED_TYPENAME hexerboost::detail::iterator_traits<Iterator>::reference r(*(i++));
    ...
    struct SinglePassRangeConcept
    {
         ...
         BOOST_CONCEPT_USAGE(SinglePassRangeConcept)
         {
            ...
            iterator i1 = hexerboost::begin(*m_range);
            iterator i2 = hexerboost::end(*m_range);
    ...
    private:
        ...
        {
            const_iterator ci1 = hexerboost::begin(const_range);
            const_iterator ci2 = hexerboost::end(const_range);
