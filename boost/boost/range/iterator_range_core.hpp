...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return static_cast<IteratorT>( hexerboost::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return static_cast<IteratorT>( hexerboost::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( hexerboost::begin(l),
                                                 hexerboost::end(l),
                                                 hexerboost::begin(r),
                                                 hexerboost::end(r) );
        }
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                hexerboost::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
        ...
        */
        ...
        private: // for return value of operator()()
            typedef BOOST_DEDUCED_TYPENAME
                hexerboost::mpl::if_< hexerboost::is_abstract<value_type>,
        ...
        public:
            ...
            {
                return hexerboost::equal( *this, r );
            }
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        make_iterator_range( Range& r )
        {
            return iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<Range>::type >
                ( hexerboost::begin( r ), hexerboost::end( r ) );
        }
        ...
        namespace iterator_range_detail
        {
                             ...
                             BOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                ...
                BOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = hexerboost::begin( r ),
                    new_end   = hexerboost::end( r );
        ...
        */
        ...
        {
            return SeqT( hexerboost::begin( r ), hexerboost::end( r ) );
        }
