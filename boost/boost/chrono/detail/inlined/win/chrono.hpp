...
namespace chrono_detail
{
  ...
  {
      hexerboost::detail::win32::LARGE_INTEGER_ freq;
      if ( !hexerboost::detail::win32::QueryPerformanceFrequency( &freq ) )
          return 0.0L;
  ...
  steady_clock::time_point steady_clock::now() BOOST_NOEXCEPT
  {
    ...
    hexerboost::detail::win32::LARGE_INTEGER_ pcount;
    if ( (nanosecs_per_tic <= 0.0L) ||
            (!hexerboost::detail::win32::QueryPerformanceCounter( &pcount )) )
    {
  ...
  steady_clock::time_point steady_clock::now( system::error_code & ec )
  {
    ...
    if ( (nanosecs_per_tic <= 0.0L)
            || (!hexerboost::detail::win32::QueryPerformanceCounter( &pcount )) )
    {
        hexerboost::detail::win32::DWORD_ cause =
            ((nanosecs_per_tic <= 0.0L)
                    ? ERROR_NOT_SUPPORTED
                    : hexerboost::detail::win32::GetLastError());
  ...
  {
    hexerboost::detail::win32::FILETIME_ ft;
  #if defined(UNDER_CE)
    // Windows CE does not define GetSystemTimeAsFileTime so we do it in two steps.
    hexerboost::detail::win32::SYSTEMTIME_ st;
    hexerboost::detail::win32::GetSystemTime( &st );
    hexerboost::detail::win32::SystemTimeToFileTime( &st, &ft );
  #else
    hexerboost::detail::win32::GetSystemTimeAsFileTime( &ft );  // never fails
  #endif
