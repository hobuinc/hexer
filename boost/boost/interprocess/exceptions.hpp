...
//!thrown by hexerboost::interprocess
class interprocess_exception : public std::exception
{
   ...
   interprocess_exception(const char *err/*error_code_t ec = other_error*/)
      :  m_err(other_error)
   {
//      try   {  m_str = "hexerboost::interprocess_exception::library_error"; }
      try   {  m_str = err; }
      catch (...) {}
   }
/*
...
class lock_exception : public interprocess_exception
{
   ...
   virtual const char* what() const throw()
   {  return "hexerboost::interprocess::lock_exception";  }
};
...
class sem_exception : public interprocess_exception
{
   ...
   virtual const char* what() const throw()
   {  return "hexerboost::interprocess::sem_exception";  }
};
*/
...
class wait_exception : public interprocess_exception
{
   public:
   virtual const char* what() const throw()
   {  return "hexerboost::interprocess::wait_exception";  }
};
*/
...
class not_previously_created : public interprocess_exception
{
 public:
    virtual const char* what() const throw()
      {  return "hexerboost::interprocess::not_previously_created";  }
};
*/
...
{
 public:
   bad_alloc() : interprocess_exception("::hexerboost::interprocess::bad_alloc"){}
   virtual const char* what() const throw()
      {  return "hexerboost::interprocess::bad_alloc";  }
};
