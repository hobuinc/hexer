...
//!std::vector, hexerboost::interprocess::vector or hexerboost::interprocess::basic_string
...
//!contiguous storage, like std::vector, hexerboost::interprocess::vector or
//!hexerboost::interprocess::basic_string
template <class CharVector, class CharTraits>
