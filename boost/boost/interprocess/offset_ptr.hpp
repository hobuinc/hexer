...
namespace ipcdetail {
   ...
   union offset_ptr_internal
   {
      ...
      typename ::hexerboost::aligned_storage
         < sizeof(OffsetType)
         , (OffsetAlignment == offset_type_alignment) ?
            ::hexerboost::alignment_of<OffsetType>::value : OffsetAlignment
...
inline hexerboost::interprocess::offset_ptr<T1, P1, O1, A1>
   static_pointer_cast(const hexerboost::interprocess::offset_ptr<T2, P2, O2, A2> & r)
{
   return hexerboost::interprocess::offset_ptr<T1, P1, O1, A1>
            (r, hexerboost::interprocess::ipcdetail::static_cast_tag());
}

//!Simulation of const_cast between pointers. Never throws.
template<class T1, class P1, class O1, std::size_t A1, class T2, class P2, class O2, std::size_t A2>
inline hexerboost::interprocess::offset_ptr<T1, P1, O1, A1>
   const_pointer_cast(const hexerboost::interprocess::offset_ptr<T2, P2, O2, A2> & r)
{
   return hexerboost::interprocess::offset_ptr<T1, P1, O1, A1>
            (r, hexerboost::interprocess::ipcdetail::const_cast_tag());
}

//!Simulation of dynamic_cast between pointers. Never throws.
template<class T1, class P1, class O1, std::size_t A1, class T2, class P2, class O2, std::size_t A2>
inline hexerboost::interprocess::offset_ptr<T1, P1, O1, A1>
   dynamic_pointer_cast(const hexerboost::interprocess::offset_ptr<T2, P2, O2, A2> & r)
{
   return hexerboost::interprocess::offset_ptr<T1, P1, O1, A1>
            (r, hexerboost::interprocess::ipcdetail::dynamic_cast_tag());
}

//!Simulation of reinterpret_cast between pointers. Never throws.
template<class T1, class P1, class O1, std::size_t A1, class T2, class P2, class O2, std::size_t A2>
inline hexerboost::interprocess::offset_ptr<T1, P1, O1, A1>
   reinterpret_pointer_cast(const hexerboost::interprocess::offset_ptr<T2, P2, O2, A2> & r)
{
   return hexerboost::interprocess::offset_ptr<T1, P1, O1, A1>
            (r, hexerboost::interprocess::ipcdetail::reinterpret_cast_tag());
}
...
struct has_trivial_constructor< hexerboost::interprocess::offset_ptr<T, P, O, A> >
{
...
template <class T, class P, class O, std::size_t A>
struct has_trivial_destructor< hexerboost::interprocess::offset_ptr<T, P, O, A> >
{
   static const bool value = true;
};
...
//!to_raw_pointer() enables hexerboost::mem_fn to recognize offset_ptr.
//!Never throws.
template <class T, class P, class O, std::size_t A>
inline T * to_raw_pointer(hexerboost::interprocess::offset_ptr<T, P, O, A> const & p)
...
struct max_pointer_plus_bits<hexerboost::interprocess::offset_ptr<void, P, O, A>, OffsetAlignment>
{
   //The offset ptr can embed one bit less than the alignment since it
   //uses offset == 1 to store the null pointer.
   static const std::size_t value = ::hexerboost::interprocess::ipcdetail::ls_zeros<OffsetAlignment>::value - 1;
};
...
struct pointer_plus_bits<hexerboost::interprocess::offset_ptr<T, P, O, A>, NumBits>
{
   typedef hexerboost::interprocess::offset_ptr<T, P, O, A>      pointer;
   typedef ::hexerboost::interprocess::pointer_size_t_caster<T*> caster_t;
...
struct pointer_to_other
   < ::hexerboost::interprocess::offset_ptr<PointedType, DifferenceType, OffsetType, OffsetAlignment>, U >
{
   typedef ::hexerboost::interprocess::offset_ptr<U, DifferenceType, OffsetType, OffsetAlignment> type;
};
