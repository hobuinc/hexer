...
//!\file
//!Describes index adaptor of hexerboost::intrusive::unordered_set container, to use it
   ...
   struct equal_function
   {
      ...
      : std::unary_function<value_type, std::size_t>
    {
        std::size_t operator()(const value_type &val) const
        {
            ...
            return hexerboost::hash_range(beg, end);
        }
...
//!Index type based in hexerboost::intrusive::set.
//!Just derives from hexerboost::intrusive::set
   ...
   ,  public iunordered_set_index_aux<MapConfig>::index_t
{
      ...
      , allocator_type &alloc, size_type new_size)
   {
      ...
      if(!alloc.allocation_command
         (hexerboost::interprocess::try_shrink_in_place | hexerboost::interprocess::nothrow_allocation, old_size, new_size, received_size, buckets).first){
         return old_size;
      }
      ...
      bucket_ptr shunk_p = alloc.allocation_command
         (hexerboost::interprocess::shrink_in_place | hexerboost::interprocess::nothrow_allocation, received_size, received_size, received_size, buckets).first;
      ...
      , allocator_type &alloc,  const size_type new_num)
   {
      ...
      std::pair<bucket_ptr, bool> ret =
         alloc.allocation_command
            (hexerboost::interprocess::expand_fwd | hexerboost::interprocess::allocate_new, new_num, new_num, received_size, old_buckets);
...
struct is_intrusive_index
   <hexerboost::interprocess::iunordered_set_index<MapConfig> >
{
