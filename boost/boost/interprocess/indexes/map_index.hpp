...
//!\file
//!Describes index adaptor of hexerboost::map container, to use it
...
struct map_index_aux
{
   ...
   typedef hexerboost::interprocess::map
...
//!Index type based in hexerboost::interprocess::map. Just derives from hexerboost::interprocess::map
...
struct is_node_index
   <hexerboost::interprocess::map_index<MapConfig> >
{
