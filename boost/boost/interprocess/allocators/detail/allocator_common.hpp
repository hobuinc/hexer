...
#include <boost/utility/addressof.hpp> //hexerboost::addressof
#include <boost/assert.hpp>   //BOOST_ASSERT
#include <boost/interprocess/exceptions.hpp> //bad_alloc
#include <boost/interprocess/sync/scoped_lock.hpp> //scoped_lock
#include <boost/interprocess/containers/allocation_type.hpp> //hexerboost::interprocess::allocation_type
...
struct get_or_create_node_pool_func
{
   ...
   //!Can throw hexerboost::interprocess::bad_alloc
   void operator()()
   {
      //Find or create the node_pool_t
      mp_node_pool =    mp_segment_manager->template find_or_construct
                        <NodePool>(hexerboost::interprocess::unique_instance)(mp_segment_manager);
...
struct destroy_if_last_link_func
{
   ...
   void operator()()
   {
      ...
      mp_node_pool->get_segment_manager()->template destroy<NodePool>(hexerboost::interprocess::unique_instance);
   }
...
class array_allocation_impl
{
   ...
   typedef hexerboost::container::container_detail::transform_multiallocation_chain
   ...
   std::pair<pointer, bool>
      allocation_command(hexerboost::interprocess::allocation_type command,
   ...
   {  return pointer(hexerboost::addressof(value));  }

   //!Returns address of non mutable object.
   //!Never throws
   const_pointer address(const_reference value) const
   {  return const_pointer(hexerboost::addressof(value));  }
   ...
   {  ::new((void*)ipcdetail::to_raw_pointer(ptr)) value_type(::hexerboost::forward<P>(p));  }
      ...
      , SegmentManager>
{
   ...
   //!Throws hexerboost::interprocess::bad_alloc if there is no enough memory
   ...
   : public private_node_allocator_t
{
 ...
 public:
   ...
   //!Allocates array of count elements. Can throw hexerboost::interprocess::bad_alloc
   void *allocate_node()
   {
      //-----------------------
