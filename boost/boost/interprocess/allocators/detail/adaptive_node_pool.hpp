...
class private_adaptive_node_pool
   :  public hexerboost::container::container_detail::private_adaptive_node_pool_impl
         < typename SegmentManager::segment_manager_base_type
         , ::hexerboost::container::adaptive_pool_flag::size_ordered |
           ::hexerboost::container::adaptive_pool_flag::address_ordered
         >
{
   typedef hexerboost::container::container_detail::private_adaptive_node_pool_impl
      < typename SegmentManager::segment_manager_base_type
      , ::hexerboost::container::adaptive_pool_flag::size_ordered |
        ::hexerboost::container::adaptive_pool_flag::address_ordered
      > base_t;
