...
//!based on hexerboost::interprocess synchronization objects.
struct mutex_family
{
   typedef hexerboost::interprocess::interprocess_mutex                 mutex_type;
   typedef hexerboost::interprocess::interprocess_recursive_mutex       recursive_mutex_type;
};
...
{
   typedef hexerboost::interprocess::null_mutex                   mutex_type;
   typedef hexerboost::interprocess::null_mutex                   recursive_mutex_type;
};
