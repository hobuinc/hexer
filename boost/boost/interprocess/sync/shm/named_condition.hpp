...
class shm_named_condition
{
   ...
   friend class hexerboost::interprocess::ipcdetail::interprocess_tester;
   void dont_close_on_destruction();

   typedef ipcdetail::managed_open_or_create_impl<shared_memory_object, 0, true, false> open_create_impl_t;
   open_create_impl_t m_shmem;

   template <class T, class Arg> friend class hexerboost::interprocess::ipcdetail::named_creation_functor;
   typedef hexerboost::interprocess::ipcdetail::named_creation_functor<internal_condition> construct_func_t;
   /// @endcond
};
...
inline bool shm_named_condition::timed_wait
   (L& lock, const hexerboost::posix_time::ptime &abs_time)
{  return m_cond.timed_wait(lock, abs_time); }

template <typename L, typename Pr>
inline bool shm_named_condition::timed_wait
   (L& lock, const hexerboost::posix_time::ptime &abs_time, Pr pred)
