...
class windows_condition
{
   ...
   {
      typedef hexerboost::int32_t     integer_type;
      ...
      hexerboost::int32_t    m_nwaiters_blocked;
      hexerboost::int32_t    m_nwaiters_gone;
      hexerboost::int32_t    m_nwaiters_to_unblock;
