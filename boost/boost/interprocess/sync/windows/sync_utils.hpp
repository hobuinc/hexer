...
class sync_id
{
   ...
   {  return hexerboost::hash_value(m.rand_);  }
...
class sync_handles
{
   ...
   typedef hexerboost::unordered_map<sync_id, void*> umap_type;
   typedef hexerboost::container::map<const sync_id*, umap_type::iterator, address_less> map_type;
