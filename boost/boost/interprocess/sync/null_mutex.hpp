...
class null_mutex
{
   ...
   //!Equivalent to "return true;"
   bool timed_lock(const hexerboost::posix_time::ptime &)
   {  return true;   }
   ...
   //!Equivalent to "return true;"
   bool timed_lock_sharable(const hexerboost::posix_time::ptime &)
   {  return true;   }
   ...
   //!Equivalent to "return true;"
   bool timed_lock_upgradable(const hexerboost::posix_time::ptime &)
   {  return true;   }
   ...
   //!Equivalent to "return true;"
   bool timed_unlock_upgradable_and_lock(const hexerboost::posix_time::ptime &)
   {  return true;   }
