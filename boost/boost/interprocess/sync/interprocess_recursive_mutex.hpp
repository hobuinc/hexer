...
inline void interprocess_recursive_mutex::lock()
{
      ...
      hexerboost::posix_time::ptime wait_time
         = hexerboost::posix_time::microsec_clock::universal_time()
         + hexerboost::posix_time::milliseconds(BOOST_INTERPROCESS_TIMEOUT_WHEN_LOCKING_DURATION_MS);
...
inline bool interprocess_recursive_mutex::timed_lock(const hexerboost::posix_time::ptime &abs_time)
