...
class sharable_lock
{
   ...
   sharable_lock(mutex_type& m, const hexerboost::posix_time::ptime& abs_time)
      : mp_mutex(&m), m_locked(false)
   ...
   //!   "hexerboost::move(lock);". This constructor does not alter the state of the mutex,
