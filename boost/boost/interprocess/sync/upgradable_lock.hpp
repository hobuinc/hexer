...
class upgradable_lock
{
   ...
   upgradable_lock(mutex_type& m, const hexerboost::posix_time::ptime& abs_time)
      : mp_mutex(&m), m_locked(false)
   ...
   //!   expression: "hexerboost::move(lock);". This constructor does not alter the
   ...
   //!   expression: "hexerboost::move(lock);".
   template<class T>
