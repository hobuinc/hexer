...
// to_raw_pointer() enables hexerboost::mem_fn to recognize shared_ptr
template<class T, class VoidAllocator, class Deleter> inline
...
//!of type T with the allocator hexerboost::interprocess::allocator allocator
//!and hexerboost::interprocess::deleter deleter
...
// to_raw_pointer() enables hexerboost::mem_fn to recognize shared_ptr
template<class T, class VoidAllocator, class Deleter> inline
T * to_raw_pointer(hexerboost::interprocess::shared_ptr<T, VoidAllocator, Deleter> const & p)
{  return p.get();   }
#endif
