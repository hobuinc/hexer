...
inline typename hexerboost::interprocess::intrusive_ptr<T, VP>::pointer
...
inline hexerboost::interprocess::intrusive_ptr<T, VP> static_pointer_cast
   (hexerboost::interprocess::intrusive_ptr<U, VP> const & p)
{  return do_static_cast<U>(p.get());  }
*/
/*Emulates const cast operator. Does not throw*/
/*
template<class T, class U, class VP>
inline hexerboost::interprocess::intrusive_ptr<T, VP> const_pointer_cast
   (hexerboost::interprocess::intrusive_ptr<U, VP> const & p)
...
/*
template<class T, class U, class VP>
inline hexerboost::interprocess::intrusive_ptr<T, VP> dynamic_pointer_cast
   (hexerboost::interprocess::intrusive_ptr<U, VP> const & p)
...
/*
template<class T, class U, class VP>
inline hexerboost::interprocess::intrusive_ptr<T, VP>reinterpret_pointer_cast
   (hexerboost::interprocess::intrusive_ptr<U, VP> const & p)
...
//!Does not throw
template<class T, class VP>
inline T *to_raw_pointer(hexerboost::interprocess::intrusive_ptr<T, VP> p)
{  return p.get();   }
#endif
