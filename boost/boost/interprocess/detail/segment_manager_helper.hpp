...
struct block_header
{
   ...
   size_type total_size_with_header() const
   {
      return get_rounded_size
			   ...
			   , size_type(::hexerboost::alignment_of<block_header<size_type> >::value))
           + total_size();
   }
   ...
   {  return block_header_from_value(value, sizeof(T), ::hexerboost::alignment_of<T>::value);  }
   ...
   static block_header<size_type> *from_first_header(Header *header)
   {
      block_header<size_type> * hdr =
		 ...
		 get_rounded_size(size_type(sizeof(Header)), size_type(::hexerboost::alignment_of<block_header<size_type> >::value)));
      //Some sanity checks
      return hdr;
   }
   ...
   :  public Hook
{
   ...
   enum  {  BlockHdrAlignment = ::hexerboost::alignment_of<block_header<size_type> >::value  };
...
struct index_key
{
   ...
   typedef CharT                                         char_type;
   typedef typename hexerboost::intrusive::pointer_traits<const_char_ptr_t>::difference_type difference_type;
