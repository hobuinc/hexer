   ...
   :  public intersegment_base
{
   ...
   typedef hexerboost::interprocess::flat_map
      <const void *
      ,segment_info_t
   ...
   {
      //------------------------------------------------------------------
      hexerboost::interprocess::scoped_lock<typename mappings_t::mutex_type> lock(s_map);
      //------------------------------------------------------------------
      base = 0;
...
//! swap specialization
template<class T> inline
void swap (hexerboost::interprocess::intersegment_ptr<T> &pt,
           hexerboost::interprocess::intersegment_ptr<T> &pt2)
{  pt.swap(pt2);  }

//!to_raw_pointer() enables hexerboost::mem_fn to recognize intersegment_ptr.
//!Never throws.
template<class T> inline
T * to_raw_pointer(hexerboost::interprocess::intersegment_ptr<T> const & p)
{  return p.get();   }

//!Simulation of static_cast between pointers.
//!Never throws.
template<class T, class U> inline
hexerboost::interprocess::intersegment_ptr<T> static_pointer_cast(const hexerboost::interprocess::intersegment_ptr<U> &r)
{  return hexerboost::interprocess::intersegment_ptr<T>(r, hexerboost::interprocess::ipcdetail::static_cast_tag());  }

//!Simulation of const_cast between pointers.
//!Never throws.
template<class T, class U> inline
hexerboost::interprocess::intersegment_ptr<T> const_pointer_cast(const hexerboost::interprocess::intersegment_ptr<U> &r)
{  return hexerboost::interprocess::intersegment_ptr<T>(r, hexerboost::interprocess::ipcdetail::const_cast_tag());  }

//!Simulation of dynamic_cast between pointers.
//!Never throws.
template<class T, class U> inline
hexerboost::interprocess::intersegment_ptr<T> dynamic_pointer_cast(const hexerboost::interprocess::intersegment_ptr<U> &r)
{  return hexerboost::interprocess::intersegment_ptr<T>(r, hexerboost::interprocess::ipcdetail::dynamic_cast_tag());  }

//!Simulation of reinterpret_cast between pointers.
//!Never throws.
template<class T, class U> inline
hexerboost::interprocess::intersegment_ptr<T> reinterpret_pointer_cast(const hexerboost::interprocess::intersegment_ptr<U> &r)
{  return hexerboost::interprocess::intersegment_ptr<T>(r, hexerboost::interprocess::ipcdetail::reinterpret_cast_tag());  }

//!Trait class to detect if an smart pointer has
//!multi-segment addressing capabilities.
template <class T>
struct is_multisegment_ptr
   <hexerboost::interprocess::intersegment_ptr<T> >
{
