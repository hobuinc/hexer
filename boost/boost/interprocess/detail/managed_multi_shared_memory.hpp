 ...
 public:
                          ...
                          const permissions &perm)
   {
      BOOST_TRY{
         ...
         hexerboost::interprocess::basic_ovectorstream<hexerboost::interprocess::string> formatter;
         ...
         //This can throw.
         m_shmem_list.push_back(hexerboost::move(mshm));
         return true;
      }
      BOOST_CATCH(const std::bad_alloc&){
      }
