...
struct CtorNArg : public placement_destroy<T>
{
   ...
   {  new((void*)mem)T(*hexerboost::forward<Args>(get<IdxPack>(args_))...); }
...
}}}   //namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace interprocess { namespace ipcdetail {
