...
class message_queue_t
{
   ...
   bool timed_send    (const void *buffer,     size_type buffer_size,
                           unsigned int priority,  const hexerboost::posix_time::ptime& abs_time);
   ...
   /// @cond
   private:
   typedef hexerboost::posix_time::ptime ptime;
   ...
   : public ipcdetail::priority_functor<VoidPointer>
{
   ...
   {
      const size_type
		 msg_hdr_align  = ::hexerboost::alignment_of<msg_header>::value,
		 index_align    = ::hexerboost::alignment_of<msg_hdr_ptr_t>::value,
