...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace numeric {
    ...
    #define BOOST_NUMERIC_CONVERSION_SEQ_A() BOOST_NUMERIC_CONVERSION_BASE_BUILTIN_TYPES()(hexerboost::long_long_type)(hexerboost::ulong_long_type)
	#define BOOST_NUMERIC_CONVERSION_SEQ_B() (hexerboost::long_long_type)(hexerboost::ulong_long_type)
