...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost { namespace numeric { namespace boundsdetail
{
  template<class N>
  class Integral
  {
...
} } } // namespace hexerboost::numeric::boundsdetail.
