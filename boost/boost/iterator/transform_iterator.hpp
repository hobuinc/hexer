...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost
{
  ...
  template <class UnaryFunc, class Iterator, class Reference, class Value>
  class transform_iterator
    : public hexerboost::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
  {
    typedef typename
    hexerboost::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
    super_t;
