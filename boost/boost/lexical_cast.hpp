...
#       error "hexerboost::lexical_cast to use only 'C' locale during conversions."
#   endif
#endif
...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost
{
    ...
    namespace detail // widest_char
    {
        ...
        struct widest_char
        {
            typedef BOOST_DEDUCED_TYPENAME hexerboost::mpl::if_c<
...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost {
    ...
    namespace detail // is_char_or_wchar<...>
    {
        ...
        {
            typedef hexerboost::type_traits::ice_or<
                    hexerboost::is_same< T, char >::value,
                    #ifndef BOOST_LCAST_NO_WCHAR_T
                        hexerboost::is_same< T, wchar_t >::value,
                    #endif
                    #ifndef BOOST_NO_CXX11_CHAR16_T
                        hexerboost::is_same< T, char16_t >::value,
                    #endif
                    #ifndef BOOST_NO_CXX11_CHAR32_T
                        hexerboost::is_same< T, char32_t >::value,
                    #endif
                    hexerboost::is_same< T, unsigned char >::value,
                    hexerboost::is_same< T, signed char >::value
            > result_type;
    ...
    namespace detail // stream_char_common<T>
    {
        ...
        struct stream_char_common: public hexerboost::mpl::if_c<
            hexerboost::detail::is_char_or_wchar< Type >::value,
            Type,
            hexerboost::detail::deduce_character_type_later< Type >
        > {};

        template < typename Char >
        struct stream_char_common< Char* >: public hexerboost::mpl::if_c<
            hexerboost::detail::is_char_or_wchar< Char >::value,
            Char,
            hexerboost::detail::deduce_character_type_later< Char* >
        > {};

        template < typename Char >
        struct stream_char_common< const Char* >: public hexerboost::mpl::if_c<
            hexerboost::detail::is_char_or_wchar< Char >::value,
            Char,
            hexerboost::detail::deduce_character_type_later< const Char* >
        > {};

        template < typename Char >
        struct stream_char_common< hexerboost::iterator_range< Char* > >: public hexerboost::mpl::if_c<
            hexerboost::detail::is_char_or_wchar< Char >::value,
            Char,
            hexerboost::detail::deduce_character_type_later< hexerboost::iterator_range< Char* > >
        > {};
    
        template < typename Char >
        struct stream_char_common< hexerboost::iterator_range< const Char* > >: public hexerboost::mpl::if_c<
            hexerboost::detail::is_char_or_wchar< Char >::value,
            Char,
            hexerboost::detail::deduce_character_type_later< hexerboost::iterator_range< const Char* > >
        > {};
        ...
        template < class Char, class Traits, class Alloc >
        struct stream_char_common< hexerboost::container::basic_string< Char, Traits, Alloc > >
        {
            typedef Char type;
        };

        template < typename Char, std::size_t N >
        struct stream_char_common< hexerboost::array< Char, N > >: public hexerboost::mpl::if_c<
            hexerboost::detail::is_char_or_wchar< Char >::value,
            Char,
            hexerboost::detail::deduce_character_type_later< hexerboost::array< Char, N > >
        > {};

        template < typename Char, std::size_t N >
        struct stream_char_common< hexerboost::array< const Char, N > >: public hexerboost::mpl::if_c<
            hexerboost::detail::is_char_or_wchar< Char >::value,
            Char,
            hexerboost::detail::deduce_character_type_later< hexerboost::array< const Char, N > >
        > {};

#ifndef BOOST_NO_CXX11_HDR_ARRAY
        template < typename Char, std::size_t N >
        struct stream_char_common< std::array<Char, N > >: public hexerboost::mpl::if_c<
            hexerboost::detail::is_char_or_wchar< Char >::value,
            Char,
            hexerboost::detail::deduce_character_type_later< std::array< Char, N > >
        > {};

        template < typename Char, std::size_t N >
        struct stream_char_common< std::array< const Char, N > >: public hexerboost::mpl::if_c<
            hexerboost::detail::is_char_or_wchar< Char >::value,
            Char,
            hexerboost::detail::deduce_character_type_later< std::array< const Char, N > >
        > {};
#endif
    ...
    namespace detail // deduce_source_char_impl<T>
    {
        ...
        // character type using hexerboost::has_left_shift<T> metafunction.
        ...
        { 
            typedef BOOST_DEDUCED_TYPENAME hexerboost::detail::normalize_single_byte_char< Char >::type type; 
        };
        
        template < class T > 
        struct deduce_source_char_impl< deduce_character_type_later< T > > 
        {
            typedef hexerboost::has_left_shift< std::basic_ostream< char >, T > result_t;
            ...
            BOOST_STATIC_ASSERT_MSG((result_t::value || hexerboost::has_left_shift< std::basic_ostream< type >, T >::value), 
    ...
    {
        // If type T is `deduce_character_type_later` type, then tries to deduce
        // character type using hexerboost::has_right_shift<T> metafunction.
        // Otherwise supplied type T is a character type, that must be normalized
        // using normalize_single_byte_char<Char>.
        // Executed at Stage 2  (See deduce_source_char<T> and deduce_target_char<T>)
        template < class Char > 
        ...
        { 
            typedef hexerboost::has_right_shift<std::basic_istream<char>, T > result_t;
            ...
            BOOST_STATIC_ASSERT_MSG((result_t::value || hexerboost::has_right_shift<std::basic_istream<wchar_t>, T >::value), 
    ...
    namespace detail // deduce_char_traits template
    {
        ...
        template < class Char, class Traits, class Alloc, class Source >
        struct deduce_char_traits< Char
                                 , hexerboost::container::basic_string< Char, Traits, Alloc >
                                 , Source
                                 >
        {
            typedef Traits type;
        ...
        template<class Char, class Traits, class Alloc1, class Alloc2>
        struct deduce_char_traits< Char
                                 , hexerboost::container::basic_string< Char, Traits, Alloc1 >
                                 , hexerboost::container::basic_string< Char, Traits, Alloc2 >
                                 >
        {
            typedef Traits type;
        };
    ...
    namespace detail // is_this_float_conversion_optimized<Float, Char>
    {
        ...
        {
            typedef hexerboost::type_traits::ice_and<
                hexerboost::is_float<Float>::value,
#if !defined(BOOST_LCAST_NO_WCHAR_T) && !defined(BOOST_NO_SWPRINTF) && !defined(__MINGW32__)
                hexerboost::type_traits::ice_or<
                    hexerboost::type_traits::ice_eq<sizeof(Char), sizeof(char) >::value,
                    hexerboost::is_same<Char, wchar_t>::value
                >::value
#else
                hexerboost::type_traits::ice_eq<sizeof(Char), sizeof(char) >::value
#endif
...
#define BOOST_LCAST_DEF(T)               \
    ...
    { static void check_coverage() {} };
        ...
        BOOST_LCAST_DEF(hexerboost::ulong_long_type)
        BOOST_LCAST_DEF(hexerboost::long_long_type )
...
#undef BOOST_LCAST_DEF
    ...
    namespace detail // lexical_cast_stream_traits<Source, Target>
    {
        ...
        struct lexical_cast_stream_traits {
            typedef BOOST_DEDUCED_TYPENAME hexerboost::detail::array_to_pointer_decay<Source>::type src;
            typedef BOOST_DEDUCED_TYPENAME hexerboost::remove_cv<src>::type            no_cv_src;
                
            typedef hexerboost::detail::deduce_source_char<no_cv_src>                           deduce_src_char_metafunc;
            typedef BOOST_DEDUCED_TYPENAME deduce_src_char_metafunc::type           src_char_t;
            typedef BOOST_DEDUCED_TYPENAME hexerboost::detail::deduce_target_char<Target>::type target_char_t;
                
            typedef BOOST_DEDUCED_TYPENAME hexerboost::detail::widest_char<
                target_char_t, src_char_t
            >::type char_type;

#if !defined(BOOST_NO_CXX11_CHAR16_T) && defined(BOOST_NO_CXX11_UNICODE_LITERALS)
            BOOST_STATIC_ASSERT_MSG(( !hexerboost::is_same<char16_t, src_char_t>::value
                                        && !hexerboost::is_same<char16_t, target_char_t>::value),
                "Your compiler does not have full support for char16_t" );
#endif
#if !defined(BOOST_NO_CXX11_CHAR32_T) && defined(BOOST_NO_CXX11_UNICODE_LITERALS)
            BOOST_STATIC_ASSERT_MSG(( !hexerboost::is_same<char32_t, src_char_t>::value
                                        && !hexerboost::is_same<char32_t, target_char_t>::value),
                "Your compiler does not have full support for char32_t" );
#endif

            typedef BOOST_DEDUCED_TYPENAME hexerboost::detail::deduce_char_traits<
                char_type, Target, no_cv_src
            >::type traits;

            typedef hexerboost::type_traits::ice_and<
                hexerboost::is_same<char, src_char_t>::value,                                  // source is not a wide character based type
                hexerboost::type_traits::ice_ne<sizeof(char), sizeof(target_char_t) >::value,  // target type is based on wide character
                hexerboost::type_traits::ice_not<
                    hexerboost::detail::is_char_or_wchar<no_cv_src>::value                     // single character widening is optimized
                >::value                                                                  // and does not requires stringbuffer
            >   is_string_widening_required_t;

            typedef hexerboost::type_traits::ice_not< hexerboost::type_traits::ice_or<
                hexerboost::is_integral<no_cv_src>::value,
                hexerboost::detail::is_this_float_conversion_optimized<no_cv_src, char_type >::value,
                hexerboost::detail::is_char_or_wchar<
            ...
            typedef hexerboost::detail::lcast_src_length<no_cv_src> len_t;
        };
    }
    ...
    namespace detail // lcast_to_unsigned
    {
        ...
        {
            typedef BOOST_DEDUCED_TYPENAME hexerboost::make_unsigned<T>::type result_type;
    ...
    namespace detail // lcast_put_unsigned
    {
        ...
        CharT* lcast_put_unsigned(const T n_param, CharT* finish)
        {
            ...
            BOOST_DEDUCED_TYPENAME hexerboost::mpl::if_c<
    ...
    namespace detail
    {
            ...
            , const CharT opening_brace, const CharT closing_brace) BOOST_NOEXCEPT
        {
            ...
            if( lc_iequal(begin, lc_nan, lc_NAN, 3) )
            {
                ...
                else value = (hexerboost::math::changesign) (std::numeric_limits<T>::quiet_NaN());
                return true;
            } else
            if (( /* 'INF' or 'inf' */
                  end-begin==3
             ...
             )
            {
                ...
                else value = (hexerboost::math::changesign) (std::numeric_limits<T>::infinity());
                return true;
            }
                         ...
                         , const CharT* lc_infinity) BOOST_NOEXCEPT
        {
            using namespace std;
            const CharT minus = lcast_char_constants<CharT>::minus;
            if ( (hexerboost::math::isnan)(value) )
            {
                if ( (hexerboost::math::signbit)(value) )
                {
                    *begin = minus;
                    ++ begin;
                }
                ...
                return true;
            } else if ( (hexerboost::math::isinf)(value) )
            {
                if ( (hexerboost::math::signbit)(value) )
                {
                    *begin = minus;
    ...
    namespace detail // lcast_ret_float
    {
        ...
        {
#if defined(BOOST_HAS_LONG_LONG)
            typedef hexerboost::ulong_long_type type;
#elif defined(BOOST_HAS_MS_INT64)
        ...
        inline bool lcast_ret_float(T& value, const CharT* begin, const CharT* end)
        {
            ...
            value = static_cast<T>( has_minus ? (hexerboost::math::changesign)(result) : result);

            if ( (hexerboost::math::isinf)(value) || (hexerboost::math::isnan)(value) ) return false;
...
/************************************ HELPER FUNCTIONS FOR OPERATORS << ( ... ) ********************************/
            ...
            bool shl_char(T ch)
            {
                BOOST_STATIC_ASSERT_MSG(( sizeof(T) <= sizeof(CharT)) ,
                    "hexerboost::lexical_cast does not support narrowing of char types."
                    "Use hexerboost::locale instead" );
#ifndef BOOST_LEXICAL_CAST_ASSUME_C_LOCALE
                std::locale loc;
            ...
            bool shl_input_streamable(InputStreamable& input)
            {
                ...
                BOOST_STATIC_ASSERT((hexerboost::is_same<char, CharT>::value));
#endif
            ...
            {   using namespace std;
                ...
                const double val_as_double = val;
                    ...
                    sprintf(begin, 
#endif
                    "%.*g", static_cast<int>(hexerboost::detail::lcast_get_precision<float>()), val_as_double);
                return end > begin;
            }
            ...
            {   using namespace std;
                if (put_inf_nan(begin, end, val)) return true;
                    ...
                    sprintf(begin, 
#endif
                    "%.*g", static_cast<int>(hexerboost::detail::lcast_get_precision<double>()), val);
                return end > begin;
            }
            ...
            {   using namespace std;
                if (put_inf_nan(begin, end, val)) return true;
                    ...
                    sprintf(begin, 
#endif
                    "%.*Lg", static_cast<int>(hexerboost::detail::lcast_get_precision<long double>()), val );
                return end > begin;
            }
#endif
            ...
            {   using namespace std;
                ...
                const double val_as_double = val;
                                       ...
                                       L"%.*g",
                                       static_cast<int>(hexerboost::detail::lcast_get_precision<float >()),
                                       val_as_double );
                return end > begin;
            }
            ...
            {   using namespace std;
                if (put_inf_nan(begin, end, val)) return true;
                                          ...
                                          L"%.*g", static_cast<int>(hexerboost::detail::lcast_get_precision<double >()), val );
                return end > begin;
            }
            ...
            {   using namespace std;
                if (put_inf_nan(begin, end, val)) return true;
                                          ...
                                          L"%.*Lg", static_cast<int>(hexerboost::detail::lcast_get_precision<long double >()), val );
                return end > begin;
            }
#endif
...
/************************************ OPERATORS << ( ... ) ********************************/
        public:
            ...
            template<class Alloc>
            bool operator<<(hexerboost::container::basic_string<CharT,Traits,Alloc> const& str) BOOST_NOEXCEPT
            {
                start = const_cast<CharT*>(str.data());
                finish = start + str.length();
                return true;
...
#if defined(BOOST_HAS_LONG_LONG)
            bool operator<<(hexerboost::ulong_long_type n)   { start = lcast_put_unsigned<Traits>(n, finish); return true; }
            bool operator<<(hexerboost::long_long_type n)    { return shl_signed(n); }
#elif defined(BOOST_HAS_MS_INT64)
            ...
            bool operator<<(hexerboost::array<CharT, N> const& input) BOOST_NOEXCEPT
            { return shl_char_array_limited(input.begin(), N); }

            template <std::size_t N>
            bool operator<<(hexerboost::array<unsigned char, N> const& input) BOOST_NOEXCEPT
            { return ((*this) << reinterpret_cast<hexerboost::array<char, N> const& >(input)); }

            template <std::size_t N>
            bool operator<<(hexerboost::array<signed char, N> const& input) BOOST_NOEXCEPT
            { return ((*this) << reinterpret_cast<hexerboost::array<char, N> const& >(input)); }

            template <std::size_t N>
            bool operator<<(hexerboost::array<const CharT, N> const& input) BOOST_NOEXCEPT
            { return shl_char_array_limited(input.begin(), N); }

            template <std::size_t N>
            bool operator<<(hexerboost::array<const unsigned char, N> const& input) BOOST_NOEXCEPT
            { return ((*this) << reinterpret_cast<hexerboost::array<const char, N> const& >(input)); }

            template <std::size_t N>
            bool operator<<(hexerboost::array<const signed char, N> const& input) BOOST_NOEXCEPT
            { return ((*this) << reinterpret_cast<hexerboost::array<const char, N> const& >(input)); }
        ...
        // configurations, which do provide std::char_traits<>::eof().
            ...
            inline bool shr_xchar(T& output)
            {
                BOOST_STATIC_ASSERT_MSG(( sizeof(CharT) == sizeof(T) ),
                    "hexerboost::lexical_cast does not support narrowing of character types."
                    "Use hexerboost::locale instead" );
...
/************************************ OPERATORS >> ( ... ) ********************************/
...
#if defined(BOOST_HAS_LONG_LONG)
            bool operator>>(hexerboost::ulong_long_type& output)     { return shr_unsigned(output); }
            bool operator>>(hexerboost::long_long_type& output)      { return shr_signed(output); }
#elif defined(BOOST_HAS_MS_INT64)
            ...
            template<class Alloc>
            bool operator>>(hexerboost::container::basic_string<CharT,Traits,Alloc>& str) { str.assign(start, finish); return true; }
    ...
    public:
            ...
            template <std::size_t N>
            bool operator>>(hexerboost::array<CharT, N>& output) BOOST_NOEXCEPT
            { 
                return shr_std_array<N>(output); 
            }

            template <std::size_t N>
            bool operator>>(hexerboost::array<unsigned char, N>& output)   
            { 
                return ((*this) >> reinterpret_cast<hexerboost::array<char, N>& >(output)); 
            }

            template <std::size_t N>
            bool operator>>(hexerboost::array<signed char, N>& output)   
            { 
                return ((*this) >> reinterpret_cast<hexerboost::array<char, N>& >(output)); 
            }
        ...
        public:
            ...
            bool operator>>(double& output)
            {
                ...
                hexerboost::mpl::if_c<
                    ...
                    hexerboost::type_traits::ice_eq< sizeof(double), sizeof(long double) >::value,
#else
                     0
#endif
                    int,
    ...
    namespace detail
    {
        ...
        template<typename CharT, typename Traits, typename Alloc>
        struct is_stdstring< hexerboost::container::basic_string<CharT, Traits, Alloc> >
        {
            BOOST_STATIC_CONSTANT(bool, value = true );
        };
            ...
            BOOST_STATIC_CONSTANT(bool, value =
               (
                   hexerboost::type_traits::ice_and<
                           hexerboost::is_arithmetic<Source>::value,
                           hexerboost::is_arithmetic<Target>::value,
                           hexerboost::type_traits::ice_not<
            ...
            BOOST_STATIC_CONSTANT(bool, value =
                (
                    hexerboost::type_traits::ice_or<
                        ...
                        >::value,
                        hexerboost::type_traits::ice_and<
                             hexerboost::type_traits::ice_eq< sizeof(char),sizeof(Target)>::value,
                             hexerboost::type_traits::ice_eq< sizeof(char),sizeof(Source)>::value,
                             is_char_or_wchar<Target>::value,
        ...
        template<typename CharT, typename Traits, typename Alloc>
        struct is_char_array_to_stdstring< hexerboost::container::basic_string<CharT, Traits, Alloc>, CharT* >
        {
            BOOST_STATIC_CONSTANT(bool, value = true );
        };

        template<typename CharT, typename Traits, typename Alloc>
        struct is_char_array_to_stdstring< hexerboost::container::basic_string<CharT, Traits, Alloc>, const CharT* >
        {
            BOOST_STATIC_CONSTANT(bool, value = true );
        };
...
# pragma warning( pop )
        ...
        {
         typedef hexerboost::numeric::Trunc<Source> Rounder;
         typedef Source source_type ;

         typedef BOOST_DEDUCED_TYPENAME mpl::if_<
            hexerboost::is_arithmetic<Source>, Source, Source const&
          >::type argument_type ;
        ...
        {
          void operator() ( hexerboost::numeric::range_check_result r )
          {
            if (r != hexerboost::numeric::cInRange)
                BOOST_LCAST_THROW_BAD_CAST(Source, Target);
          }
        } ;
        ...
        struct lexical_cast_dynamic_num_not_ignoring_minus
        {
            static inline Target lexical_cast_impl(const Source &arg)
            {
                return hexerboost::numeric::converter<
                        Target,
                        Source,
                        hexerboost::numeric::conversion_traits<Target,Source>,
        ...
        struct lexical_cast_dynamic_num_ignoring_minus
        {
            static inline Target lexical_cast_impl(const Source &arg)
            {
                typedef BOOST_DEDUCED_TYPENAME hexerboost::mpl::eval_if_c<
                        hexerboost::is_float<Source>::value,
                        hexerboost::mpl::identity<Source>,
                        hexerboost::make_unsigned<Source>
                >::type usource_t;

                typedef hexerboost::numeric::converter<
                        Target,
                        usource_t,
                        hexerboost::numeric::conversion_traits<Target,usource_t>,
         ...
         *
         *
         * Rule 2) required because hexerboost::lexical_cast has the behavior of
        ...
        struct lexical_cast_dynamic_num
        {
            static inline Target lexical_cast_impl(const Source &arg)
            {
                typedef BOOST_DEDUCED_TYPENAME hexerboost::mpl::if_c<
                    hexerboost::type_traits::ice_and<
                        hexerboost::type_traits::ice_or<
                            hexerboost::is_signed<Source>::value,
                            hexerboost::is_float<Source>::value
                        >::value,
                        hexerboost::type_traits::ice_not<
                            hexerboost::is_same<Source, bool>::value
                        >::value,
                        hexerboost::type_traits::ice_not<
                            hexerboost::is_same<Target, bool>::value
                        >::value,
                        hexerboost::is_unsigned<Target>::value
                    >::value,
    ...
    inline Target lexical_cast(const Source &arg)
    {
        ...
        typedef BOOST_DEDUCED_TYPENAME hexerboost::type_traits::ice_or<
                hexerboost::detail::is_xchar_to_xchar<Target, src >::value,
                hexerboost::detail::is_char_array_to_stdstring<Target, src >::value,
                hexerboost::type_traits::ice_and<
                     hexerboost::is_same<Target, src >::value,
                     hexerboost::detail::is_stdstring<Target >::value
                >::value
        > shall_we_copy_t;

        typedef BOOST_DEDUCED_TYPENAME
                hexerboost::detail::is_arithmetic_and_not_xchars<Target, src > shall_we_copy_with_dynamic_check_t;

        typedef BOOST_DEDUCED_TYPENAME hexerboost::mpl::if_c<
            shall_we_copy_t::value,
            hexerboost::detail::lexical_cast_copy<src >,
            BOOST_DEDUCED_TYPENAME hexerboost::mpl::if_c<
                 shall_we_copy_with_dynamic_check_t::value,
                 hexerboost::detail::lexical_cast_dynamic_num<Target, src >,
                 hexerboost::detail::lexical_cast_do_cast<Target, src >
            >::type
        >::type caster_type;
    ...
    {
        BOOST_STATIC_ASSERT_MSG(hexerboost::detail::is_char_or_wchar<CharType>::value, 
            "CharType must be a character or wide character type");

        return hexerboost::lexical_cast<Target>(
            hexerboost::iterator_range<const CharType*>(chars, chars + count)
        );
    }
