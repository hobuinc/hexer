...
//  BOOST_TEST_MESSAGE ( "Short input tests for hexerboost::algorithm::unhex" );
    test_short_input1 ();
    test_short_input2 ();
    test_short_input3 ();
    test_short_input4 ();
...
void test_nonhex_input1 () {
    ...
    try { ba::unhex ( "01234FG1234", std::back_inserter(s)); }
        ...
        BOOST_CHECK ( 'G' == *hexerboost::get_error_info<ba::bad_char>(ex));
        return;
        }
    catch ( ... ) {}
...
void test_nonhex_input2 () {
    ...
    try { ba::unhex ( "012Z4FA1234", std::back_inserter(s)); }
        ...
        BOOST_CHECK ( 'Z' == *hexerboost::get_error_info<ba::bad_char>(ex));
        return;
        }
    catch ( ... ) {}
...
void test_nonhex_input3 () {
    ...
    try { ba::unhex ( "01234FA12Q4", std::back_inserter(s)); }
        ...
        BOOST_CHECK ( 'Q' == *hexerboost::get_error_info<ba::bad_char>(ex));
        return;
        }
    catch ( ... ) {}
...
//  BOOST_TEST_MESSAGE ( "Non hex input tests for hexerboost::algorithm::unhex" );
    test_nonhex_input1 ();
    test_nonhex_input2 ();
    test_nonhex_input3 ();
    test_nonhex_input4 ();
