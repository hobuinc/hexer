...
{
    // basic_string traits
    BOOST_CHECK( hexerboost::algorithm::has_native_replace<string>::value );
    BOOST_CHECK( !hexerboost::algorithm::has_stable_iterators<string>::value );
    BOOST_CHECK( !hexerboost::algorithm::has_const_time_insert<string>::value );    
    BOOST_CHECK( !hexerboost::algorithm::has_const_time_erase<string>::value ); 

    // vector traits
    BOOST_CHECK( !hexerboost::algorithm::has_native_replace< vector<char> >::value );
    BOOST_CHECK( !hexerboost::algorithm::has_stable_iterators< vector<char> >::value );
    BOOST_CHECK( !hexerboost::algorithm::has_const_time_insert< vector<char> >::value );    
    BOOST_CHECK( !hexerboost::algorithm::has_const_time_erase< vector<char> >::value ); 

    // list traits
    BOOST_CHECK( !hexerboost::algorithm::has_native_replace< list<char> >::value );
    BOOST_CHECK( hexerboost::algorithm::has_stable_iterators< list<char> >::value );
    BOOST_CHECK( hexerboost::algorithm::has_const_time_insert< list<char> >::value );   
    BOOST_CHECK( hexerboost::algorithm::has_const_time_erase< list<char> >::value );    
}
