...
void test_minmax_element(CIterator first, CIterator last, int n, char* name)
{
  ...
  TIMER( n, hexerboost::first_min_element(first, last),
    "hexerboost::first_min_element" << name << "");
  TIMER( n, hexerboost::last_min_element(first, last),
    "hexerboost::last_min_element" << name << " ");
  TIMER( n, hexerboost::first_max_element(first, last),
    "hexerboost::first_max_element" << name << "");
  TIMER( n, hexerboost::last_max_element(first, last),
    "hexerboost::last_max_element" << name << " ");
  TIMER( n, hexerboost::minmax_element(first, last),
    "hexerboost::minmax_element" << name << "    ");
  TIMER( n, hexerboost::first_min_last_max_element(first, last),
    "hexerboost::first_min_last_max_element" << name << "");
  TIMER( n, hexerboost::last_min_first_max_element(first, last),
    "hexerboost::last_min_first_max_element" << name << "");
  TIMER( n, hexerboost::last_min_last_max_element(first, last),
    "hexerboost::last_min_last_max_element" << name << " ");

  #define pred std::bind2nd( std::greater<vtype>(), vtype(10) )
  TIMER( n, hexerboost::min_element_if(first, last, pred),
    "hexerboost::min_element_if" << name << "");
  TIMER( n, hexerboost::max_element_if(first, last, pred),
    "hexerboost::max_element_if" << name << "");
  TIMER( n, std::min_element(hexerboost::make_filter_iterator(first, last, pred),
                             hexerboost::make_filter_iterator(last, last, pred)),
    "std::min_element_with_filter_iterator" << name << "");
  TIMER( n, std::max_element(hexerboost::make_filter_iterator(first, last, pred),
                             hexerboost::make_filter_iterator(last, last, pred)),
  ...
  CTIMER( n, std::max_element(first, last, lc),
    "std::max_element" << name << "        ",
    counter, opt_min_count(n) );
  CTIMER( n, hexerboost::first_min_element(first, last, lc),
    "hexerboost::first_min_element" << name << "",
    counter, opt_min_count(n) );
  CTIMER( n, hexerboost::last_min_element(first, last, lc),
    "hexerboost::last_max_element" << name << " ",
    counter, opt_min_count(n) );
  CTIMER( n, hexerboost::first_max_element(first, last, lc),
    "hexerboost::first_min_element" << name << "",
    counter, opt_min_count(n) );
  CTIMER( n, hexerboost::last_max_element(first, last, lc),
    "hexerboost::last_max_element" << name << " ",
    counter, opt_min_count(n) );
  CTIMER( n, hexerboost::minmax_element(first, last, lc),
    "hexerboost::minmax_element" << name << "   ",
    counter, opt_minmax_count(n) );
  CTIMER( n, hexerboost::first_min_last_max_element(first, last, lc),
    "hexerboost::first_min_last_max_element" << name << "",
    counter, opt_boost_minmax_count(n) );
  CTIMER( n, hexerboost::last_min_first_max_element(first, last, lc),
    "hexerboost::last_min_first_max_element" << name << "",
    counter, opt_boost_minmax_count(n) );
  CTIMER( n, hexerboost::last_min_last_max_element(first, last, lc),
    "hexerboost::last_min_last_max_element" << name << " ",
    counter, opt_minmax_count(n) );
}
