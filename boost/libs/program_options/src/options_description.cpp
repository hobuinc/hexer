   ...
   namespace {
                                      ...
                                      bool short_ignore_case) const
    {
        ...
        if (full_matches.size() > 1) 
            hexerboost::throw_exception(ambiguous_option(full_matches));
        ...
        if (full_matches.empty() && approximate_matches.size() > 1)
            hexerboost::throw_exception(ambiguous_option(approximate_matches));
        ...
        */
        ...
        {                    
            ...
            else
            {
                ...
                {
                    hexerboost::throw_exception(program_options::error(
                                ...
                                unsigned line_length)
        {
            ...
            // hexerboost::tokenizer, not typedef.
            typedef hexerboost::tokenizer<hexerboost::char_separator<char> > tok;
          
            tok paragraphs(
                desc,
                char_separator<char>("\n", "", hexerboost::keep_empty_tokens));
