...
{
    hexerboost::program_options::detail::utf8_codecvt_facet facet;
    
    std::wstring output;
    { 
        hexerboost::progress_timer t;
        for (int i = 0; i < 10000; ++i)
            output = hexerboost::from_8_bit(
                input,
                facet);
    }
    ...
    string ref = hexerboost::to_8_bit(output, facet);
...
{       
    ...
    if (ac > 1) {
        ...
        std::wstring w = hexerboost::from_local_8_bit(av[1]);
