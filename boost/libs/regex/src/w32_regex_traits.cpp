...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost{ namespace re_detail{
...
void w32_regex_traits_char_layer<char>::init() 
{
   ...
   if(cat)
   {
      ...
      {
         string_type mss = ::hexerboost::re_detail::w32_cat_get(cat, this->m_locale, i, get_default_syntax(i));
   ...
   do
   {
      if(m_char_map[i] == 0)
      {
         if(::hexerboost::re_detail::w32_is(this->m_locale, 0x0002u, (char)i)) 
            m_char_map[i] = regex_constants::escape_type_class;
         else if(::hexerboost::re_detail::w32_is(this->m_locale, 0x0001u, (char)i)) 
...
#endif
#endif
BOOST_REGEX_DECL bool BOOST_REGEX_CALL w32_is(lcid_type idx, hexerboost::uint32_t m, char c)
{
   WORD mask;
#ifndef BOOST_NO_ANSI_APIS
...
#ifndef BOOST_NO_WREGEX
BOOST_REGEX_DECL bool BOOST_REGEX_CALL w32_is(lcid_type idx, hexerboost::uint32_t m, wchar_t c)
{
   WORD mask;
...
#ifdef BOOST_REGEX_HAS_OTHER_WCHAR_T
BOOST_REGEX_DECL bool BOOST_REGEX_CALL w32_is(lcid_type idx, hexerboost::uint32_t m, unsigned short c)
{
   WORD mask;
