 ...
 */
  ...
  *   DESCRIPTION: Implements high level class hexerboost::RexEx
  */
...
typedef hexerboost::match_flag_type match_flag_type;
#include <cstdio>
...
{
   hexerboost::uint_fast32_t f = icase ? regex::normal | regex::icase : regex::normal;
