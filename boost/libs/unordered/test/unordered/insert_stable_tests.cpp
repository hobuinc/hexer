...
UNORDERED_AUTO_TEST(stable_insert_test1) {
    hexerboost::unordered_multiset<insert_stable::member> x;

    x.insert(insert_stable::member(1,1));
    x.insert(insert_stable::member(1,2));
    x.insert(insert_stable::member(1,3));

    hexerboost::unordered_multiset<insert_stable::member>::const_iterator
...
UNORDERED_AUTO_TEST(stable_insert_test2) {
    hexerboost::unordered_multimap<insert_stable::member, int> x;
    typedef
        hexerboost::unordered_multimap<insert_stable::member, int>::const_iterator
        iterator;
