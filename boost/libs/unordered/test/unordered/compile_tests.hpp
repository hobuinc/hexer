...
void container_test(X& r, T const&)
{
    ...
    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::iterator_value<iterator>::type iterator_value_type;
    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::iterator_value<const_iterator>::type const_iterator_value_type;
    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::iterator_difference<iterator>::type iterator_difference_type;
    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::iterator_difference<const_iterator>::type
    ...
    BOOST_STATIC_ASSERT((hexerboost::is_same<T, value_type>::value));
    hexerboost::function_requires<hexerboost::CopyConstructibleConcept<X> >();

    // reference_type / const_reference_type

    BOOST_STATIC_ASSERT((hexerboost::is_same<T&, reference>::value));
    BOOST_STATIC_ASSERT((hexerboost::is_same<T const&, const_reference>::value));

    // iterator

    hexerboost::function_requires<hexerboost::InputIteratorConcept<iterator> >();
    BOOST_STATIC_ASSERT((hexerboost::is_same<T, iterator_value_type>::value));
    BOOST_STATIC_ASSERT((hexerboost::is_convertible<iterator, const_iterator>::value));

    // const_iterator

    hexerboost::function_requires<hexerboost::InputIteratorConcept<const_iterator> >();
    BOOST_STATIC_ASSERT((hexerboost::is_same<T, const_iterator_value_type>::value));
    ...
    BOOST_STATIC_ASSERT((hexerboost::is_same<difference_type,
...
void unordered_set_test(X&, Key const&)
{
    ...
    BOOST_STATIC_ASSERT((hexerboost::is_same<value_type, key_type>::value));
}
...
void unordered_map_test(X& r, Key const& k, T const& v)
{
    ...
    BOOST_STATIC_ASSERT((
        hexerboost::is_same<value_type, std::pair<key_type const, T> >::value));
...
void equality_test(X& r)
{
    ...
    test::check_return_type<bool>::equals(a != b);
    test::check_return_type<bool>::equals(hexerboost::operator==(a, b));
    test::check_return_type<bool>::equals(hexerboost::operator!=(a, b));
}
...
void unordered_test(X& x, Key& k, Hash& hf, Pred& eq)
{
    ...
    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::BOOST_ITERATOR_CATEGORY<iterator>::type
        iterator_category;
    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::iterator_difference<iterator>::type
        iterator_difference;
    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::iterator_pointer<iterator>::type
        iterator_pointer;
    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::iterator_reference<iterator>::type
        iterator_reference;

    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::BOOST_ITERATOR_CATEGORY<local_iterator>::type
        local_iterator_category;
    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::iterator_difference<local_iterator>::type
        local_iterator_difference;
    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::iterator_pointer<local_iterator>::type
        local_iterator_pointer;
    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::iterator_reference<local_iterator>::type
        local_iterator_reference;

    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::BOOST_ITERATOR_CATEGORY<const_iterator>::type
        const_iterator_category;
    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::iterator_difference<const_iterator>::type
        const_iterator_difference;
    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::iterator_pointer<const_iterator>::type
        const_iterator_pointer;
    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::iterator_reference<const_iterator>::type
        const_iterator_reference;

    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::BOOST_ITERATOR_CATEGORY<const_local_iterator>::type
        const_local_iterator_category;
    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::iterator_difference<const_local_iterator>::type
        const_local_iterator_difference;
    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::iterator_pointer<const_local_iterator>::type
        const_local_iterator_pointer;
    typedef BOOST_DEDUCED_TYPENAME
        hexerboost::iterator_reference<const_local_iterator>::type
        const_local_iterator_reference;

    BOOST_STATIC_ASSERT((hexerboost::is_same<Key, key_type>::value));
    //hexerboost::function_requires<hexerboost::CopyConstructibleConcept<key_type> >();
    //hexerboost::function_requires<hexerboost::AssignableConcept<key_type> >();

    BOOST_STATIC_ASSERT((hexerboost::is_same<Hash, hasher>::value));
    test::check_return_type<std::size_t>::equals(hf(k));

    BOOST_STATIC_ASSERT((hexerboost::is_same<Pred, key_equal>::value));
    test::check_return_type<bool>::convertible(eq(k, k));

    hexerboost::function_requires<hexerboost::InputIteratorConcept<local_iterator> >();
    BOOST_STATIC_ASSERT((hexerboost::is_same<local_iterator_category,
        iterator_category>::value));
    BOOST_STATIC_ASSERT((hexerboost::is_same<local_iterator_difference,
        iterator_difference>::value));
    BOOST_STATIC_ASSERT((hexerboost::is_same<local_iterator_pointer,
        iterator_pointer>::value));
    BOOST_STATIC_ASSERT((hexerboost::is_same<local_iterator_reference,
        iterator_reference>::value));

    hexerboost::function_requires<
        hexerboost::InputIteratorConcept<const_local_iterator> >();
    BOOST_STATIC_ASSERT((hexerboost::is_same<const_local_iterator_category,
        const_iterator_category>::value));
    BOOST_STATIC_ASSERT((hexerboost::is_same<const_local_iterator_difference,
        const_iterator_difference>::value));
    BOOST_STATIC_ASSERT((hexerboost::is_same<const_local_iterator_pointer,
        const_iterator_pointer>::value));
    BOOST_STATIC_ASSERT((hexerboost::is_same<const_local_iterator_reference,
...
void unordered_movable_test(X& x, Key& k, T& /* t */, Hash& hf, Pred& eq)
{
    ...
    X x2(hexerboost::move(x1));
    x1 = rvalue_default<X>();
    x2 = hexerboost::move(x1);
#endif
    ...
    T v1(v);
    a.emplace(hexerboost::move(v1));
    T v2(v);
    a.insert(hexerboost::move(v2));
    T v3(v);
    test::check_return_type<iterator>::equals(
            a.emplace_hint(q, hexerboost::move(v3)));
    T v4(v);
    test::check_return_type<iterator>::equals(
            a.insert(q, hexerboost::move(v4)));

    a.insert(i, j);

    X a10;
    T v5(v);
    a10.insert(hexerboost::move(v5));
    q = a10.cbegin();
    test::check_return_type<iterator>::equals(a10.erase(q));
