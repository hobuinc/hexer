...
template class hexerboost::unordered_map<
    int,
    int,
    hexerboost::hash<int>,
    std::equal_to<int>,
    test::minimal::allocator<std::pair<int const, int> > >;
template class hexerboost::unordered_multimap<
    int,
    int,
    hexerboost::hash<int>,
    std::equal_to<int>,
...
UNORDERED_AUTO_TEST(test0)
{
    ...
    hexerboost::unordered_map<int, int> int_map;
    ...
    hexerboost::unordered_multimap<int, int> int_multimap;
...
UNORDERED_AUTO_TEST(test1) {
    ...
    hexerboost::unordered_map<int, int> map;
    ...
    hexerboost::unordered_multimap<int, int> multimap;
