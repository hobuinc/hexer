...
hexerboost::unordered_set<int>* int_set_ptr;
hexerboost::unordered_multiset<int>* int_multiset_ptr;
hexerboost::unordered_map<int, int>* int_map_ptr;
hexerboost::unordered_multimap<int, int>* int_multimap_ptr;
