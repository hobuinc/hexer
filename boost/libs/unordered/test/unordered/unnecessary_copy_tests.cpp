...
namespace unnecessary_copy_tests
{
    ...
    hexerboost::unordered_set<count_copies>* set;
    hexerboost::unordered_multiset<count_copies>* multiset;
    hexerboost::unordered_map<int, count_copies>* map;
    hexerboost::unordered_multimap<int, count_copies>* multimap;
    ...
    UNORDERED_AUTO_TEST(unnecessary_copy_emplace_set_test)
    {
        ...
        reset();
        hexerboost::unordered_set<count_copies> x;
        count_copies a;
        x.insert(a);
        COPY_COUNT(2); MOVE_COUNT(0);
    ...
    UNORDERED_AUTO_TEST(unnecessary_copy_emplace_map_test)
    {
        ...
        reset();
        hexerboost::unordered_map<count_copies, count_copies> x;
...
#   if BOOST_WORKAROUND(BOOST_MSVC, >= 1700)
        ...
        // non-const mapped value). Since 'emplace(hexerboost::move(a))' (see below)
...
#   endif
        ...
        reset();
        x.emplace(hexerboost::unordered::piecewise_construct,
    ...
    (defined(BOOST_MSVC) && BOOST_MSVC >= 1600 )
        ...
        reset();
        x.emplace(hexerboost::unordered::piecewise_construct,
                hexerboost::make_tuple(hexerboost::ref(b.first)),
                hexerboost::make_tuple(hexerboost::ref(b.second)));
        COPY_COUNT(0); MOVE_COUNT(0);
