...
template class hexerboost::unordered_set<
    int,
    hexerboost::hash<int>,
    std::equal_to<int>,
    test::minimal::allocator<int> >;
template class hexerboost::unordered_multiset<
    int,
    hexerboost::hash<int>,
    std::equal_to<int>,
    test::minimal::allocator<int> >;
...
UNORDERED_AUTO_TEST(test0)
{
    ...
    hexerboost::unordered_set<int> int_set;

    hexerboost::unordered_set<int,
        hexerboost::hash<int>, std::equal_to<int>,
        test::minimal::cxx11_allocator<int>
        > int_set2;

    hexerboost::unordered_set<
        test::minimal::assignable,
        test::minimal::hash<test::minimal::assignable>,
        test::minimal::equal_to<test::minimal::assignable>,
    ...
    hexerboost::unordered_multiset<int> int_multiset;
...
UNORDERED_AUTO_TEST(test1)
{
    ...
    hexerboost::unordered_multiset<int> multiset;
