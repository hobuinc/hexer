...
void test_empty_allocator()
{
    ...
    BOOST_STATIC_ASSERT((hexerboost::is_same<traits::size_type,
        std::make_unsigned<std::ptrdiff_t>::type>::value));
#else
    BOOST_STATIC_ASSERT((hexerboost::is_same<traits::size_type, std::size_t>::value));
#endif
    BOOST_STATIC_ASSERT((hexerboost::is_same<traits::difference_type, std::ptrdiff_t>::value));
    BOOST_STATIC_ASSERT((hexerboost::is_same<traits::pointer, int*>::value));
    BOOST_STATIC_ASSERT((hexerboost::is_same<traits::const_pointer, int const*>::value));
    BOOST_STATIC_ASSERT((hexerboost::is_same<traits::value_type, int>::value));
...
void test_allocator3()
{
    ...
    typedef hexerboost::unordered::detail::allocator_traits<allocator> traits;
    BOOST_STATIC_ASSERT((hexerboost::is_same<traits::size_type, unsigned short>::value));
    BOOST_STATIC_ASSERT((hexerboost::is_same<traits::difference_type, std::ptrdiff_t>::value));
    BOOST_STATIC_ASSERT((hexerboost::is_same<traits::pointer, ptr<int> >::value));
    BOOST_STATIC_ASSERT((hexerboost::is_same<traits::const_pointer, ptr<int const> >::value));
    BOOST_STATIC_ASSERT((hexerboost::is_same<traits::value_type, int>::value));
    BOOST_TEST(traits::propagate_on_container_copy_assignment::value);
    BOOST_TEST(!traits::propagate_on_container_move_assignment::value);
    BOOST_TEST(!traits::propagate_on_container_swap::value);
