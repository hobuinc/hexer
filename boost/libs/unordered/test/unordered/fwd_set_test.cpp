...
true_type is_unordered_set_impl(
        hexerboost::unordered_set<Value, Hash, Pred, Alloc>*);

template<typename T>
void call_swap(hexerboost::unordered_set<T>& x,
    hexerboost::unordered_set<T>& y)
{
    swap(x,y);
}

template<typename T>
bool call_equals(hexerboost::unordered_set<T>& x,
    hexerboost::unordered_set<T>& y)
{
    return x == y;
}
...
template<typename T>
bool call_not_equals(hexerboost::unordered_set<T>& x,
    hexerboost::unordered_set<T>& y)
{
    return x != y;
}
...
template<typename T>
void call_swap(hexerboost::unordered_multiset<T>& x,
    hexerboost::unordered_multiset<T>& y)
{
    swap(x,y);
}

template<typename T>
bool call_equals(hexerboost::unordered_multiset<T>& x,
    hexerboost::unordered_multiset<T>& y)
{
    return x == y;
}
...
template<typename T>
bool call_not_equals(hexerboost::unordered_multiset<T>& x,
    hexerboost::unordered_multiset<T>& y)
{
    return x != y;
}
...
typedef hexerboost::unordered_set<int> int_set;
typedef hexerboost::unordered_multiset<int> int_multiset;
...
UNORDERED_AUTO_TEST(use_fwd_declared_trait) {
    hexerboost::unordered_set<int> x;
