...
namespace x
{
    struct D { hexerboost::unordered_map<D, D> x; };
}
...
namespace incomplete_test
{
    ...
    typedef hexerboost::unordered_map<value, value, hash, equals,
        allocator<std::pair<value const, value> > > map;
    typedef hexerboost::unordered_multimap<value, value, hash, equals,
        allocator<std::pair<value const, value> > > multimap;
    typedef hexerboost::unordered_set<value, hash, equals,
        allocator<value> > set;
    typedef hexerboost::unordered_multiset<value, hash, equals,
    ...
    struct struct1 {
        hexerboost::unordered_map<struct1, struct1, hash, equals,
            allocator<std::pair<struct1 const, struct1> > > x;
    };
    struct struct2 {
        hexerboost::unordered_multimap<struct2, struct2, hash, equals,
            allocator<std::pair<struct2 const, struct2> > > x;
    };
    struct struct3 {
        hexerboost::unordered_set<struct3, hash, equals,
            allocator<struct3> > x;
    };
    struct struct4 {
        hexerboost::unordered_multiset<struct4, hash, equals,
            allocator<struct4> > x;
    };
