...
namespace test
{
    ...
    struct ordered_base<hexerboost::unordered_set<V, H, P, A> >
    {
        typedef std::set<V,
    ...
    template <class V, class H, class P, class A>
    struct ordered_base<hexerboost::unordered_multiset<V, H, P, A> >
    {
    ...
    struct ordered_base<hexerboost::unordered_map<K, M, H, P, A> >
    {
        typedef std::map<K, M,
            BOOST_DEDUCED_TYPENAME equals_to_compare<P>::type>
            type;
    ...
    template <class K, class M, class H, class P, class A>
    struct ordered_base<hexerboost::unordered_multimap<K, M, H, P, A> >
    {
