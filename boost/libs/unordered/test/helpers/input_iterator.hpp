...
namespace test
{
    ...
    struct input_iterator_adaptor
        : public hexerboost::iterator<
            ...
            BOOST_DEDUCED_TYPENAME hexerboost::iterator_value<Iterator>::type,
            std::ptrdiff_t,
            BOOST_DEDUCED_TYPENAME hexerboost::iterator_pointer<Iterator>::type,
            proxy<Iterator>
        >
    {
        typedef BOOST_DEDUCED_TYPENAME hexerboost::iterator_value<Iterator>::type
            value_type;
    ...
    struct copy_iterator_adaptor
        : public hexerboost::iterator<
            BOOST_DEDUCED_TYPENAME hexerboost::iterator_category<Iterator>::type,
            BOOST_DEDUCED_TYPENAME hexerboost::iterator_value<Iterator>::type,
            BOOST_DEDUCED_TYPENAME hexerboost::iterator_difference<Iterator>::type,
            BOOST_DEDUCED_TYPENAME hexerboost::iterator_pointer<Iterator>::type,
            proxy<Iterator>
        >
    {
        typedef BOOST_DEDUCED_TYPENAME hexerboost::iterator_value<Iterator>::type
            value_type;
        typedef BOOST_DEDUCED_TYPENAME hexerboost::iterator_difference<Iterator>::type
            difference_type;
