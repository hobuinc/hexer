...
namespace
{
  ...
  const hexerboost::system::error_code ok;
  const hexerboost::system::error_code ng(-1, hexerboost::system::system_category());
...
# endif
  ...
  void fun(const hexerboost::shared_ptr< Base >&) {}
  ...
  void test_constructors()
  {
    ...
    hexerboost::shared_ptr< Derived > pDerived( new Derived() ); 
