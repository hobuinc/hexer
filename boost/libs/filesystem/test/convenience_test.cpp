...
using fs::path;
namespace sys = hexerboost::system;
...
//  create_directories() tests  --------------------------------------------------------//
  ...
  BOOST_TEST(throws_fs_error(
    hexerboost::bind(fs::create_directories, is_a_file)));
  BOOST_TEST(throws_fs_error(
    hexerboost::bind(fs::create_directories, is_a_file / "aa")));
...
// recursive_directory_iterator tests ----------------------------------------//
  ...
  BOOST_TEST(throws_fs_error(
    hexerboost::bind(create_recursive_iterator, "/no-such-path")));
