...
namespace
{
  ...
  void exception_tests()
  {
    ...
    hexerboost::system::error_code ec(12345, hexerboost::system::system_category());
  ...
  void iterator_tests()
  {
    ...
    BOOST_TEST(hexerboost::next(itr_ck.begin()) == itr_ck.end());
    BOOST_TEST(*hexerboost::prior(itr_ck.end()) == std::string("foo"));
    BOOST_TEST(hexerboost::prior(itr_ck.end()) == itr_ck.begin());

    itr_ck = path("/foo");
    BOOST_TEST((itr_ck.begin())->string() == "/");
    BOOST_TEST(*hexerboost::next(itr_ck.begin()) == std::string("foo"));
    BOOST_TEST(hexerboost::next(hexerboost::next(itr_ck.begin())) == itr_ck.end());
    BOOST_TEST(hexerboost::next(itr_ck.begin()) == hexerboost::prior(itr_ck.end()));
    BOOST_TEST(*hexerboost::prior(itr_ck.end()) == std::string("foo"));
    BOOST_TEST(*hexerboost::prior(hexerboost::prior(itr_ck.end())) == std::string("/"));
    BOOST_TEST(hexerboost::prior(hexerboost::prior(itr_ck.end())) == itr_ck.begin());
...
static hexerboost::filesystem::path ticket_6737 = "FilePath";  // #6737 reported this crashed
                                                          // on VC++ debug mode build 
const hexerboost::filesystem::path ticket_6690("test");  // #6690 another V++ static init crash
