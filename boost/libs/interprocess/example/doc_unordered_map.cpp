...
#include <boost/unordered_map.hpp>     //hexerboost::unordered_map
...
int main ()
{
   ...
   typedef hexerboost::unordered_map
      < KeyType               , MappedType
      , hexerboost::hash<KeyType>  ,std::equal_to<KeyType>
      , ShmemAllocator>
   MyHashMap;
   ...
   MyHashMap *myhashmap = segment.construct<MyHashMap>("MyHashMap")  //object name
      ( 3, hexerboost::hash<int>(), std::equal_to<int>()                  //
