...
int main()
{
   ...
   std::size_t *ptr = managed_shm.allocation_command<std::size_t>
      (hexerboost::interprocess::allocate_new, min_size, preferred_size, received_size).first;
   ...
   std::pair<std::size_t *, bool> ret = managed_shm.allocation_command
      (hexerboost::interprocess::expand_fwd, received_size*2, received_size*3, expanded_size, ptr);
   ...
   ret = managed_shm.allocation_command
      (hexerboost::interprocess::shrink_in_place, min_size*2, min_size, shrunk_size, ptr);
