...
bool test_insert_with_expand_bwd()
{
   ...
   typedef typename hexerboost::remove_volatile<value_type>::type non_volatile_value_type;
...
bool test_assign_with_expand_bwd()
{
   ...
   for(int iteration = 0; iteration <Iterations; ++iteration)
   {
      ...
      try {
         ...
         delete [](const_cast<typename hexerboost::remove_volatile<value_type>::type*>(memory));
         throw;
      }
      delete [](const_cast<typename hexerboost::remove_volatile<value_type>::type*>(memory));
   }
