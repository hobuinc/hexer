...
int main ()
{
   ...
   const int size_aligner  = sizeof(::hexerboost::detail::max_align);
   const int memsize       = 65536/size_aligner*size_aligner;
   static ::hexerboost::detail::max_align static_buffer[memsize/size_aligner];

   {
      //Now test move semantics
      managed_heap_memory original(memsize);
      managed_heap_memory move_ctor(hexerboost::move(original));
   ...
   }
   {
      ...
      managed_external_buffer move_ctor(hexerboost::move(original));
   ...
   //Test move semantics
   {
      ...
      wmanaged_external_buffer temp_external(hexerboost::move(user_buffer));
      user_default = hexerboost::move(temp_external);
      user_buffer  = hexerboost::move(user_default);
      wmanaged_heap_memory heap_default;
      wmanaged_heap_memory temp_heap(hexerboost::move(heap_buffer));
      heap_default = hexerboost::move(temp_heap);
      heap_buffer  = hexerboost::move(heap_default);
   }
   ...
   catch(hexerboost::interprocess::bad_alloc &){}
