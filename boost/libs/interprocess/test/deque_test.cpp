...
bool copyable_only(V1 *shmdeque, V2 *stddeque, ipcdetail::true_type)
{
   ...
   if(!test::CheckEqualContainers(shmdeque, stddeque)) return false;
   {
      ...
      shmdeque->insert(shmdeque->begin()+size/2, 50, hexerboost::move(move_me));
      if(!test::CheckEqualContainers(shmdeque, stddeque)) return false;
   }
   {
      IntType move_me(2);
      shmdeque->assign(shmdeque->size()/2, hexerboost::move(move_me));
   ...
   }
   {
      ...
      shmdeque->insert(shmdeque->begin(), 50, hexerboost::move(move_me));
      if(!test::CheckEqualContainers(shmdeque, stddeque)) return false;
      stddeque->insert(stddeque->begin()+20, 50, 1);
      shmdeque->insert(shmdeque->begin()+20, 50, hexerboost::move(move_me));
      if(!test::CheckEqualContainers(shmdeque, stddeque)) return false;
      stddeque->insert(stddeque->begin()+20, 20, 1);
      shmdeque->insert(shmdeque->begin()+20, 20, hexerboost::move(move_me));
      if(!test::CheckEqualContainers(shmdeque, stddeque)) return false;
   }
   {
      IntType move_me(1);
      ...
      shmdeque->clear();
      stddeque->insert(stddeque->end(), 50, 1);
      shmdeque->insert(shmdeque->end(), 50, hexerboost::move(move_me));
      if(!test::CheckEqualContainers(shmdeque, stddeque)) return false;
      stddeque->insert(stddeque->end()-20, 50, 1);
      shmdeque->insert(shmdeque->end()-20, 50, hexerboost::move(move_me));
      if(!test::CheckEqualContainers(shmdeque, stddeque)) return false;
      stddeque->insert(stddeque->end()-20, 20, 1);
      shmdeque->insert(shmdeque->end()-20, 20, hexerboost::move(move_me));
      if(!test::CheckEqualContainers(shmdeque, stddeque)) return false;
   }
   ...
   /*try*/{
      ...
      /*try*/{
         ...
         for(int i = 0; i < max*50; ++i){
            IntType move_me(i);
            shmdeque->insert(shmdeque->end(), hexerboost::move(move_me));
         ...
         for(int i = 0; i < max*50; ++i){
            IntType move_me(i);
            shmdeque->push_back(hexerboost::move(move_me));
         ...
         for(int i = 0; i < max*50; ++i){
            IntType move_me(i);
            shmdeque->push_front(hexerboost::move(move_me));
         ...
         for(int i = 0; i < max; ++i){
            IntType move_me(i);
            shmdeque->insert(shmdeque->begin(), hexerboost::move(move_me));
...
int main ()
{
   ...
   if(!hexerboost::interprocess::test::test_emplace
