...
int map_test ()
{
   ...
   typedef hexerboost::interprocess::pair<IntType, IntType>         IntPairType;
   ...
   try{
      ...
      //Test construction from a range
      {
         ...
         for(int i = 0; i < 50; ++i){
            IntType i1(i/2);
            IntType i2(i/2);
            new(&aux_vect[i])IntPairType(hexerboost::move(i1), hexerboost::move(i2));
         }
         ...
         for(int i = 0; i < 50; ++i){
            IntType i1(i/2);
            IntType i2(i/2);
            new(&aux_vect3[i])IntPairType(hexerboost::move(i1), hexerboost::move(i2));
         }
      ...
      }
      {
         ...
         for(int i = 0; i < max; ++i){
            shmmap->insert(hexerboost::move(aux_vect[i]));
            stdmap->insert(StdPairType(i, i));
            shmmultimap->insert(hexerboost::move(aux_vect3[i]));
      ...
      //Initialize values
      {
         ...
         shmmap->insert(::hexerboost::make_move_iterator(&aux_vect[0]), ::hexerboost::make_move_iterator(aux_vect + 50));
         shmmultimap->insert(::hexerboost::make_move_iterator(&aux_vect3[0]), ::hexerboost::make_move_iterator(aux_vect3 + 50));
      ...
      }
      {
         ...
         for(int i = 0; i < 50; ++i){
            IntType i1(-1);
            IntType i2(-1);
            new(&aux_vect4[i])IntPairType(hexerboost::move(i1), hexerboost::move(i2));
         }
         ...
         for(int i = 0; i < 50; ++i){
            IntType i1(-1);
            IntType i2(-1);
            new(&aux_vect5[i])IntPairType(hexerboost::move(i1), hexerboost::move(i2));
         }

         shmmap->insert(::hexerboost::make_move_iterator(&aux_vect[0]), ::hexerboost::make_move_iterator(aux_vect + 50));
         shmmap->insert(::hexerboost::make_move_iterator(&aux_vect3[0]), ::hexerboost::make_move_iterator(aux_vect3 + 50));
         shmmultimap->insert(::hexerboost::make_move_iterator(&aux_vect4[0]), ::hexerboost::make_move_iterator(aux_vect4 + 50));
         shmmultimap->insert(::hexerboost::make_move_iterator(&aux_vect5[0]), ::hexerboost::make_move_iterator(aux_vect5 + 50));
...

      {
         ...
         for(int i = 0; i < max; ++i){
            IntPairType intpair;
            {
               IntType i1(i);
               IntType i2(i);
               new(&intpair)IntPairType(hexerboost::move(i1), hexerboost::move(i2));
            }
            shmmap->insert(shmmap->begin(), hexerboost::move(intpair));
            ...
            shmmultimap->insert(shmmultimap->begin(), hexerboost::move(intpair));
            ...
            shmmap->insert(shmmap->end(), hexerboost::move(intpair));
            ...
            shmmultimap->insert(shmmultimap->end(), hexerboost::move(intpair));
            ...
            shmmap->insert(shmmap->lower_bound(IntType(i)), hexerboost::move(intpair));
            ...
            {
               IntType i1(i);
               shmmultimap->insert(shmmultimap->lower_bound(hexerboost::move(i1)), hexerboost::move(intpair));
            ...
            {
               IntType i1(i);
               shmmap->insert(shmmap->upper_bound(hexerboost::move(i1)), hexerboost::move(intpair));
            ...
            {
               IntType i1(i);
               shmmultimap->insert(shmmultimap->upper_bound(hexerboost::move(i1)), hexerboost::move(intpair));
         ...
         for(int i = 0; i < 100; ++i){
            ...
            shmmap->insert(hexerboost::move(intpair));
            {
               IntType i1(i), i2(i);
               new(&intpair)IntPairType(hexerboost::move(i1), hexerboost::move(i2));
            }
            shmmultimap->insert(hexerboost::move(intpair));
...
int map_test_copyable ()
{
   ...
   for(i = 0; i < max; ++i){
      {
      IntType i1(i), i2(i);
      IntPairType intpair1(hexerboost::move(i1), hexerboost::move(i2));
      shmmap->insert(hexerboost::move(intpair1));
      stdmap->insert(StdPairType(i, i));
      }
      {
      IntType i1(i), i2(i);
      IntPairType intpair2(hexerboost::move(i1), hexerboost::move(i2));
      shmmultimap->insert(hexerboost::move(intpair2));
      stdmultimap->insert(StdPairType(i, i));
      }
   }
