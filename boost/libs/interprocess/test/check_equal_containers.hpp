...
bool CheckEqual( const T1 &t1, const T2 &t2
               , typename hexerboost::container::container_detail::enable_if_c
                  <!hexerboost::container::container_detail::is_pair<T1>::value && 
                   !hexerboost::container::container_detail::is_pair<T2>::value
                  >::type* = 0)
{  return t1 == t2;  }
...
bool CheckEqual( const Pair1 &pair1, const Pair2 &pair2
               , typename hexerboost::container::container_detail::enable_if_c
                  <hexerboost::container::container_detail::is_pair<Pair1>::value && 
                   hexerboost::container::container_detail::is_pair<Pair2>::value
                  >::type* = 0)
{
