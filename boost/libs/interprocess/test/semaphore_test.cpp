...
class semaphore_test_wrapper
   : public hexerboost::interprocess::interprocess_semaphore
{
   public:
   semaphore_test_wrapper()
      :  hexerboost::interprocess::interprocess_semaphore(SemCount)
   {}
   ...
   bool timed_lock(const hexerboost::posix_time::ptime &pt)
   ...
   semaphore_test_wrapper(int initial_count)
      :  hexerboost::interprocess::interprocess_semaphore(initial_count)
   {}
};
