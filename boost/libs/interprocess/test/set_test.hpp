...
int set_test ()
{
   ...
   try{
      ...
      //Test construction from a range
      {
         ...
         for(int i = 0; i < 50; ++i){
            IntType move_me(i/2);
            aux_vect[i] = hexerboost::move(move_me);
         }
         int aux_vect2[50];
         for(int i = 0; i < 50; ++i){
            aux_vect2[i] = i/2;
         ...
         for(int i = 0; i < 50; ++i){
            IntType move_me(i/2);
            aux_vect3[i] = hexerboost::move(move_me);
         }

         MyShmSet *shmset2 =
            segment.template construct<MyShmSet>("MyShmSet2")
               ( ::hexerboost::make_move_iterator(&aux_vect[0])
               , ::hexerboost::make_move_iterator(aux_vect + 50)
               , std::less<IntType>(), segment.get_segment_manager());
         ...
         MyShmMultiSet *shmmultiset2 =
            segment.template construct<MyShmMultiSet>("MyShmMultiSet2")
               ( ::hexerboost::make_move_iterator(&aux_vect3[0])
               , ::hexerboost::make_move_iterator(aux_vect3 + 50)
               , std::less<IntType>(), segment.get_segment_manager());
      ...
      if(!CheckEqualContainers(shmset, stdset)){
         std::cout << "Error in shmset->insert(hexerboost::move(move_me)" << std::endl;
         return 1;
      }

      for(int i = 0; i < max/2; ++i){
         IntType move_me(i);
         shmset->insert(hexerboost::move(move_me));
         stdset->insert(i);
         IntType move_me2(i);
         shmmultiset->insert(hexerboost::move(move_me2));
      ...
      if(!CheckEqualContainers(shmmultiset, stdmultiset)){
         std::cout << "Error in shmmultiset->insert(hexerboost::move(move_me)" << std::endl;
         return 1;
      }
      ...
      //Initialize values
      {
         ...
         shmset->insert(::hexerboost::make_move_iterator(&aux_vect[0]), ::hexerboost::make_move_iterator(aux_vect + 50));
         stdset->insert(aux_vect2, aux_vect2 + 50);
         shmmultiset->insert(::hexerboost::make_move_iterator(&aux_vect3[0]), ::hexerboost::make_move_iterator(aux_vect3 + 50));
         stdmultiset->insert(aux_vect2, aux_vect2 + 50);
         if(!CheckEqualContainers(shmset, stdset)){
            std::cout << "Error in shmset->insert(::hexerboost::make_move_iterator(&aux_vect[0])..." << std::endl;
            return 1;
         }
         if(!CheckEqualContainers(shmmultiset, stdmultiset)){
            std::cout << "Error in shmmultiset->insert(::hexerboost::make_move_iterator(&aux_vect3[0]), ..." << std::endl;
            return 1;
         }
      ...
      }
      {
         ...
         for(int i = 0; i < 50; ++i){
            IntType move_me(-1);
            aux_vect4[i] = hexerboost::move(move_me);
         }

         IntType aux_vect5[50];
         for(int i = 0; i < 50; ++i){
            IntType move_me(-1);
            aux_vect5[i] = hexerboost::move(move_me);
         }

         shmset->insert(::hexerboost::make_move_iterator(&aux_vect[0]), ::hexerboost::make_move_iterator(aux_vect + 50));
         shmset->insert(::hexerboost::make_move_iterator(&aux_vect3[0]), ::hexerboost::make_move_iterator(aux_vect3 + 50));
         stdset->insert(aux_vect2, aux_vect2 + 50);
         stdset->insert(aux_vect2, aux_vect2 + 50);
         shmmultiset->insert(::hexerboost::make_move_iterator(&aux_vect4[0]), ::hexerboost::make_move_iterator(aux_vect4 + 50));
         shmmultiset->insert(::hexerboost::make_move_iterator(&aux_vect5[0]), ::hexerboost::make_move_iterator(aux_vect5 + 50));
         stdmultiset->insert(aux_vect2, aux_vect2 + 50);
         stdmultiset->insert(aux_vect2, aux_vect2 + 50);
         if(!CheckEqualContainers(shmset, stdset)){
            std::cout << "Error in shmset->insert(::hexerboost::make_move_iterator(&aux_vect3[0])..." << std::endl;
            return 1;
         }
         if(!CheckEqualContainers(shmmultiset, stdmultiset)){
            std::cout << "Error in shmmultiset->insert(::hexerboost::make_move_iterator(&aux_vect5[0])..." << std::endl;
            return 1;
         }
      ...
      for(int i = 0; i < max/2; ++i){
         IntType move_me(i);
         shmset->insert(shmset->begin(), hexerboost::move(move_me));
         stdset->insert(stdset->begin(), i);
         IntType move_me2(i);
         shmmultiset->insert(shmmultiset->begin(), hexerboost::move(move_me2));
      ...
      if(!CheckEqualContainers(shmset, stdset)){
         std::cout << "Error in shmset->insert(hexerboost::move(move_me)) try 2" << std::endl;
         return 1;
      }
      if(!CheckEqualContainers(shmmultiset, stdmultiset)){
         std::cout << "Error in shmmultiset->insert(hexerboost::move(move_me2)) try 2" << std::endl;
         return 1;
      }
      ...
      for(int i = 0; i < max; ++i){
         {
            ...
            if(!CheckEqualContainers(shmset, stdset)){
               std::cout << "Error in shmset->insert(shmset->begin(), hexerboost::move(move_me))" << std::endl;
               return 1;
            }
            if(!CheckEqualContainers(shmmultiset, stdmultiset)){
               std::cout << "Error in shmmultiset->insert(shmmultiset->begin(), hexerboost::move(move_me2))" << std::endl;
               return 1;
            }

            IntType move_me3(i);
            shmset->insert(shmset->end(), hexerboost::move(move_me3));
            stdset->insert(stdset->end(), i);
            IntType move_me4(i);
            shmmultiset->insert(shmmultiset->end(), hexerboost::move(move_me4));
            stdmultiset->insert(stdmultiset->end(), i);
            if(!CheckEqualContainers(shmset, stdset)){
               std::cout << "Error in shmset->insert(shmset->end(), hexerboost::move(move_me3))" << std::endl;
               return 1;
            }
            if(!CheckEqualContainers(shmmultiset, stdmultiset)){
               std::cout << "Error in shmmultiset->insert(shmmultiset->end(), hexerboost::move(move_me4))" << std::endl;
               return 1;
            }
         }
         {
            IntType move_me(i);
            shmset->insert(shmset->upper_bound(move_me), hexerboost::move(move_me));
            stdset->insert(stdset->upper_bound(i), i);
            //PrintContainers(shmset, stdset);
            IntType move_me2(i);
            shmmultiset->insert(shmmultiset->upper_bound(move_me2), hexerboost::move(move_me2));
            stdmultiset->insert(stdmultiset->upper_bound(i), i);
            //PrintContainers(shmmultiset, stdmultiset);
            if(!CheckEqualContainers(shmset, stdset)){
               std::cout << "Error in shmset->insert(shmset->upper_bound(move_me), hexerboost::move(move_me))" << std::endl;
               return 1;
            }
            if(!CheckEqualContainers(shmmultiset, stdmultiset)){
               std::cout << "Error in shmmultiset->insert(shmmultiset->upper_bound(move_me2), hexerboost::move(move_me2))" << std::endl;
               return 1;
            }
         }
         {
            IntType move_me(i);
            IntType move_me2(i);
            shmset->insert(shmset->lower_bound(move_me), hexerboost::move(move_me2));
            stdset->insert(stdset->lower_bound(i), i);
            //PrintContainers(shmset, stdset);
            move_me2 = i;
            shmmultiset->insert(shmmultiset->lower_bound(move_me2), hexerboost::move(move_me2));
            stdmultiset->insert(stdmultiset->lower_bound(i), i);
            //PrintContainers(shmmultiset, stdmultiset);
            if(!CheckEqualContainers(shmset, stdset)){
               std::cout << "Error in shmset->insert(shmset->lower_bound(move_me), hexerboost::move(move_me2))" << std::endl;
               return 1;
            }
            if(!CheckEqualContainers(shmmultiset, stdmultiset)){
               std::cout << "Error in shmmultiset->insert(shmmultiset->lower_bound(move_me2), hexerboost::move(move_me2))" << std::endl;
               return 1;
            }
         }
      }
