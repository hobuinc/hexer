...
#include <boost/functional/hash.hpp> //hexerboost::hash

namespace bip = hexerboost::interprocess;

typedef bip::allocator<int, bip::managed_shared_memory::segment_manager> ShmemAllocator;
typedef hexerboost::unordered_set<int, hexerboost::hash<int>, std::equal_to<int>, ShmemAllocator> MyUnorderedSet;
typedef hexerboost::unordered_multiset<int, hexerboost::hash<int>, std::equal_to<int>, ShmemAllocator> MyUnorderedMultiSet;
