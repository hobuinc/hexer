...
{
    void hexerboosttss_cleanup_implemented() {}
}
...
namespace {
    void NTAPI on_tls_callback(void* , DWORD dwReason, PVOID )
    {
        ...
        {
            hexerboost::hexerbooston_thread_exit();
            break;
        }
        }
    }
...
extern "C" {
    ...
    void (* after_ctors )() __attribute__((section(".ctors")))     = hexerboost::hexerbooston_process_enter;
    void (* before_dtors)() __attribute__((section(".dtors")))     = hexerboost::hexerbooston_thread_exit;
    void (* after_dtors )() __attribute__((section(".dtors.zzz"))) = hexerboost::hexerbooston_process_exit;
...
#pragma warning(pop)
        ...
        {
            //Schedule hexerbooston_thread_exit() to be called for the main
            ...
            atexit(hexerboost::hexerbooston_thread_exit);

            //Call Boost process entry callback here

            hexerboost::hexerbooston_process_enter();
        ...
        {
            hexerboost::hexerbooston_process_exit();
            return INIRETSUCCESS;
        }
...
namespace hexerboost {} namespace boost = hexerboost; namespace hexerboost
{
    void hexerboosttss_cleanup_implemented()
    {
        ...
        hexerboosttss_cleanup_implemented() function to eliminate the linker's
